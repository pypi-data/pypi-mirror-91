...
from azureml.automl.runtime import data_cleaning, frequency_fixer
...
def complete_featurization(raw_data_context: RawDataContext,
    ...
    with tracer.start_as_current_span(
        ...
        x_is_sparse = sparse.issparse(transformed_data_context.X)
        transformer, ts_transformer = None, None
        ...
        if skip_featurization(raw_data_context.featurization, raw_data_context.timeseries) or x_is_sparse:
            _logger.info("Skipping featurization step")
        ...
        transformed_data_context._set_transformer(
            transformer, y_transformer=y_transformer, ts_transformer=ts_transformer
        )
