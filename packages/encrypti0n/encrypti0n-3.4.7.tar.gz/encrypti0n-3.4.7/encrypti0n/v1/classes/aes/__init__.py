...
class AssymetricAES(object):
	...
	def encrypt_file(self, input=None, output=None, remove=False):
		...
		# handler.
		return r3sponse.success_response(f"Successfully encrypted file {intput} to {output}.")
	...
	def decrypt_file(self, input=None, output=None, remove=False):
		...
		# handler.
		return r3sponse.success_response(f"Successfully decrypted file {intput} to {output}.")
