...
class IRenderControlEvents():
	...
	def onAsyncSearchFinished(self,fn):
		...
		if fn:
			wsObj.EventProcessStart(fn,"onAsyncSearchFinished",self.Events["onAsyncSearchFinished"]["args"],{ "propertyType":"onAsyncSearchFinished", "_HashCode": "" },None,JsonData)
	...
	def onBeforePresentationItemActivation(self,fn):
		...
		if fn:
			wsObj.EventProcessStart(fn,"onBeforePresentationItemActivation",self.Events["onBeforePresentationItemActivation"]["args"],{ "propertyType":"onBeforePresentationItemActivation", "_HashCode": "" },None,JsonData)
	...
	def onCameraChanged(self,fn):
		...
		if fn:
			wsObj.EventProcessStart(fn,"onCameraChanged",self.Events["onCameraChanged"]["args"],{ "propertyType":"onCameraChanged", "_HashCode": "" },None,JsonData)
	...
	def onCameraFlyFinished(self,fn):
		...
		if fn:
			wsObj.EventProcessStart(fn,"onCameraFlyFinished",self.Events["onCameraFlyFinished"]["args"],{ "propertyType":"onCameraFlyFinished", "_HashCode": "" },None,JsonData)
	...
	def onCameraTourWaypointChanged(self,fn):
		...
		if fn:
			wsObj.EventProcessStart(fn,"onCameraTourWaypointChanged",self.Events["onCameraTourWaypointChanged"]["args"],{ "propertyType":"onCameraTourWaypointChanged", "_HashCode": "" },None,JsonData)
	...
	def onCameraUndoRedoStatusChanged(self,fn):
		...
		cm.AddRenderEventCB(fn,"onCameraUndoRedoStatusChanged")
	@property
	...
	def onDataSourceDisconnected(self,fn):
		...
		if fn:
			wsObj.EventProcessStart(fn,"onDataSourceDisconnected",self.Events["onDataSourceDisconnected"]["args"],{ "propertyType":"onDataSourceDisconnected", "_HashCode": "" },None,JsonData)
	...
	def onFeaturesMoving(self,fn):
		...
		if fn:
			wsObj.EventProcessStart(fn,"onFeaturesMoving",self.Events["onFeaturesMoving"]["args"],{ "propertyType":"onFeaturesMoving", "_HashCode": "" },None,JsonData)
	...
	def onFrame(self,fn):
		...
		if fn:
			wsObj.EventProcessStart(fn,"onFrame",self.Events["onFrame"]["args"],{ "propertyType":"onFrame", "_HashCode": "" },None,JsonData)
	...
	def onFullScreenChanged(self,fn):
		...
		if fn:
			wsObj.EventProcessStart(fn,"onFullScreenChanged",self.Events["onFullScreenChanged"]["args"],{ "propertyType":"onFullScreenChanged", "_HashCode": "" },None,JsonData)
	...
	def onInteractFocusChanged(self,fn):
		...
		if fn:
			wsObj.EventProcessStart(fn,"onInteractFocusChanged",self.Events["onInteractFocusChanged"]["args"],{ "propertyType":"onInteractFocusChanged", "_HashCode": "" },None,JsonData)
	...
	def onKeyDown(self,fn):
		...
		if fn:
			wsObj.EventProcessStart(fn,"onKeyDown",self.Events["onKeyDown"]["args"],{ "propertyType":"onKeyDown", "_HashCode": "" },None,JsonData)
	...
	def onKeyUp(self,fn):
		...
		if fn:
			wsObj.EventProcessStart(fn,"onKeyUp",self.Events["onKeyUp"]["args"],{ "propertyType":"onKeyUp", "_HashCode": "" },None,JsonData)
	...
	def onLButtonDblClk(self,fn):
		...
		if fn:
			wsObj.EventProcessStart(fn,"onLButtonDblClk",self.Events["onLButtonDblClk"]["args"],{ "propertyType":"onLButtonDblClk", "_HashCode": "" },None,JsonData)
	...
	def onLButtonDown(self,fn):
		...
		if fn:
			wsObj.EventProcessStart(fn,"onLButtonDown",self.Events["onLButtonDown"]["args"],{ "propertyType":"onLButtonDown", "_HashCode": "" },None,JsonData)
	...
	def onLButtonUp(self,fn):
		...
		if fn:
			wsObj.EventProcessStart(fn,"onLButtonUp",self.Events["onLButtonUp"]["args"],{ "propertyType":"onLButtonUp", "_HashCode": "" },None,JsonData)
	...
	def onMButtonDblClk(self,fn):
		...
		if fn:
			wsObj.EventProcessStart(fn,"onMButtonDblClk",self.Events["onMButtonDblClk"]["args"],{ "propertyType":"onMButtonDblClk", "_HashCode": "" },None,JsonData)
	...
	def onMButtonDown(self,fn):
		...
		if fn:
			wsObj.EventProcessStart(fn,"onMButtonDown",self.Events["onMButtonDown"]["args"],{ "propertyType":"onMButtonDown", "_HashCode": "" },None,JsonData)
	...
	def onMButtonUp(self,fn):
		...
		if fn:
			wsObj.EventProcessStart(fn,"onMButtonUp",self.Events["onMButtonUp"]["args"],{ "propertyType":"onMButtonUp", "_HashCode": "" },None,JsonData)
	...
	def onMouseClick(self,fn):
		...
		if fn:
			wsObj.EventProcessStart(fn,"onMouseClick",self.Events["onMouseClick"]["args"],{ "propertyType":"onMouseClick", "_HashCode": "" },None,JsonData)
	...
	def onMouseClickSelect(self,fn):
		...
		# a=wsObj.postEvent(fn,"onMouseClickSelect",self.Events["onMouseClickSelect"]["args"],{ "propertyType":"onMouseClickSelect", "_HashCode": "" },None,JsonData)
		if fn:
			wsObj.EventProcessStart(fn,"onMouseClickSelect",self.Events["onMouseClickSelect"]["args"],{ "propertyType":"onMouseClickSelect", "_HashCode": "" },None,JsonData)
	...
	def onMouseDragSelect(self,fn):
		...
		if fn:
			wsObj.EventProcessStart(fn,"onMouseDragSelect",self.Events["onMouseDragSelect"]["args"],{ "propertyType":"onMouseDragSelect", "_HashCode": "" },None,JsonData)
	...
	def onMouseHover(self,fn):
		...
		if fn:
			wsObj.EventProcessStart(fn,"onMouseHover",self.Events["onMouseHover"]["args"],{ "propertyType":"onMouseHover", "_HashCode": "" },None,JsonData)
	...
	def onMouseMove(self,fn):
		...
		if fn:
			wsObj.EventProcessStart(fn,"onMouseMove",self.Events["onMouseMove"]["args"],{ "propertyType":"onMouseMove", "_HashCode": "" },None,JsonData)
	...
	def onMouseWheel(self,fn):
		...
		if fn:
			wsObj.EventProcessStart(fn,"onMouseWheel",self.Events["onMouseWheel"]["args"],{ "propertyType":"onMouseWheel", "_HashCode": "" },None,JsonData)
	...
	def onObjectEditFinish(self,fn):
		...
		cm.AddRenderEventCB(fn,"onObjectEditFinish")
	@property
	...
	def onObjectEditing(self,fn):
		...
		if fn:
			wsObj.EventProcessStart(fn,"onObjectEditing",self.Events["onObjectEditing"]["args"],{ "propertyType":"onObjectEditing", "_HashCode": "" },None,JsonData)
	...
	def onPictureExportBegin(self,fn):
		...
		if fn:
			wsObj.EventProcessStart(fn,"onPictureExportBegin",self.Events["onPictureExportBegin"]["args"],{ "propertyType":"onPictureExportBegin", "_HashCode": "" },None,JsonData)
	...
	def onPictureExportEnd(self,fn):
		...
		if fn:
			wsObj.EventProcessStart(fn,"onPictureExportEnd",self.Events["onPictureExportEnd"]["args"],{ "propertyType":"onPictureExportEnd", "_HashCode": "" },None,JsonData)
	...
	def onPictureExporting(self,fn):
		...
		if fn:
			wsObj.EventProcessStart(fn,"onPictureExporting",self.Events["onPictureExporting"]["args"],{ "propertyType":"onPictureExporting", "_HashCode": "" },None,JsonData)
	...
	def onPresentationFlyToReachedDestination(self,fn):
		...
		if fn:
			wsObj.EventProcessStart(fn,"onPresentationFlyToReachedDestination",self.Events["onPresentationFlyToReachedDestination"]["args"],{ "propertyType":"onPresentationFlyToReachedDestination", "_HashCode": "" },None,JsonData)
	...
	def onPresentationStatusChanged(self,fn):
		...
		if fn:
			wsObj.EventProcessStart(fn,"onPresentationStatusChanged",self.Events["onPresentationStatusChanged"]["args"],{ "propertyType":"onPresentationStatusChanged", "_HashCode": "" },None,JsonData)
	...
	def onProjectChanged(self,fn):
		...
		cm.AddRenderEventCB(fn,"onProjectChanged")
	@property
	...
	def onRButtonDblClk(self,fn):
		...
		if fn:
			wsObj.EventProcessStart(fn,"onRButtonDblClk",self.Events["onRButtonDblClk"]["args"],{ "propertyType":"onRButtonDblClk", "_HashCode": "" },None,JsonData)
	...
	def onRButtonDown(self,fn):
		...
		if fn:
			wsObj.EventProcessStart(fn,"onRButtonDown",self.Events["onRButtonDown"]["args"],{ "propertyType":"onRButtonDown", "_HashCode": "" },None,JsonData)
	...
	def onRButtonUp(self,fn):
		...
		if fn:
			wsObj.EventProcessStart(fn,"onRButtonUp",self.Events["onRButtonUp"]["args"],{ "propertyType":"onRButtonUp", "_HashCode": "" },None,JsonData)
	...
	def onResPacking(self,fn):
		...
		if fn:
			wsObj.EventProcessStart(fn,"onResPacking",self.Events["onResPacking"]["args"],{ "propertyType":"onResPacking", "_HashCode": "" },None,JsonData)
	...
	def onTransformHelperBegin(self,fn):
		...
		cm.AddRenderEventCB(fn,"onTransformHelperBegin")
	@property
	...
	def onTransformHelperBoxScaling(self,fn):
		...
		if fn:
			wsObj.EventProcessStart(fn,"onTransformHelperBoxScaling",self.Events["onTransformHelperBoxScaling"]["args"],{ "propertyType":"onTransformHelperBoxScaling", "_HashCode": "" },None,JsonData)
	...
	def onTransformHelperEnd(self,fn):
		...
		cm.AddRenderEventCB(fn,"onTransformHelperEnd")
	@property
	...
	def onTransformHelperMoving(self,fn):
		...
		if fn:
			wsObj.EventProcessStart(fn,"onTransformHelperMoving",self.Events["onTransformHelperMoving"]["args"],{ "propertyType":"onTransformHelperMoving", "_HashCode": "" },None,JsonData)
	...
	def onTransformHelperRotating(self,fn):
		...
		if fn:
			wsObj.EventProcessStart(fn,"onTransformHelperRotating",self.Events["onTransformHelperRotating"]["args"],{ "propertyType":"onTransformHelperRotating", "_HashCode": "" },None,JsonData)
	...
	def onTransformHelperScaling(self,fn):
		...
		if fn:
			wsObj.EventProcessStart(fn,"onTransformHelperScaling",self.Events["onTransformHelperScaling"]["args"],{ "propertyType":"onTransformHelperScaling", "_HashCode": "" },None,JsonData)
	...
	def onUIWindowEvent(self,fn):
		...
		if fn:
			wsObj.EventProcessStart(fn,"onUIWindowEvent",self.Events["onUIWindowEvent"]["args"],{ "propertyType":"onUIWindowEvent", "_HashCode": "" },None,JsonData)
	...
	def onVideoExportBegin(self,fn):
		...
		if fn:
			wsObj.EventProcessStart(fn,"onVideoExportBegin",self.Events["onVideoExportBegin"]["args"],{ "propertyType":"onVideoExportBegin", "_HashCode": "" },None,JsonData)
	...
	def onVideoExportEnd(self,fn):
		...
		if fn:
			wsObj.EventProcessStart(fn,"onVideoExportEnd",self.Events["onVideoExportEnd"]["args"],{ "propertyType":"onVideoExportEnd", "_HashCode": "" },None,JsonData)
	...
	def onVideoExporting(self,fn):
		...
		if fn:
			wsObj.EventProcessStart(fn,"onVideoExporting",self.Events["onVideoExporting"]["args"],{ "propertyType":"onVideoExporting", "_HashCode": "" },None,JsonData)
