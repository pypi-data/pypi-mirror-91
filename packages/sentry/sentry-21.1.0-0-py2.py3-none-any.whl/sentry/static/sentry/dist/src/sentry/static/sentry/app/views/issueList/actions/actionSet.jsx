...
function ActionSet(_a) {
    ...
    return (<Wrapper hasInbox={hasInbox}>
      {hasInbox && (<div className="hidden-sm hidden-xs">
          <ReviewAction primary={query === Query.NEEDS_REVIEW || query === Query.NEEDS_REVIEW_OWNER} disabled={!anySelected} onUpdate={onUpdate}/>
        </div>)}
