...
var StacktraceContent = /** @class */ (function (_super) {
    ...
    StacktraceContent.prototype.render = function () {
        var _this = this;
        var _a = this.props, data = _a.data, event = _a.event, newestFirst = _a.newestFirst, expandFirstFrame = _a.expandFirstFrame, platform = _a.platform, includeSystemFrames = _a.includeSystemFrames, isHoverPreviewed = _a.isHoverPreviewed;
