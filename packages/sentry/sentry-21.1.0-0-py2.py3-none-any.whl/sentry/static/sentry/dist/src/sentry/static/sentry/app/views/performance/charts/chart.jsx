...
var Chart = /** @class */ (function (_super) {
    ...
    Chart.prototype.render = function () {
        var _a = this.props, data = _a.data, router = _a.router, statsPeriod = _a.statsPeriod, utc = _a.utc, loading = _a.loading, height = _a.height, grid = _a.grid, disableMultiAxis = _a.disableMultiAxis;
        ...
        return (<ChartZoom router={router} period={statsPeriod} utc={utc} xAxisIndex={disableMultiAxis ? undefined : [0, 1]}>
