...
var ReleaseOverview = /** @class */ (function (_super) {
    ...
    ReleaseOverview.prototype.render = function () {
        ...
        {function (_a) {
            ...
            return (<ReleaseStatsRequest api={api} organization={organization} projectSlug={project.slug} version={version} selection={selection} location={location} yAxis={yAxis} eventType={eventType} vitalType={vitalType} hasHealthData={hasHealthData} hasDiscover={hasDiscover} hasPerformance={hasPerformance}>
              {function (_a) {
