...
import { getTabs, getTabsWithCounts, Query, TAB_MAX_COUNT } from './utils';
var MAX_ITEMS = 25;
...
var IssueListOverview = /** @class */ (function (_super) {
    ...
    function IssueListOverview(props) {
        ...
        _this.fetchCounts = function (currentQueryCount, fetchAllCounts) { return __awaiter(_this, void 0, void 0, function () {
            var organization, _queryCounts, queryCounts, endpointParams, tabQueriesWithCounts, currentTabQuery, requestParams, response, e_2, tab;
            var _a;
        ...
        _this.renderGroupNodes = function (ids, groupStatsPeriod) {
            ...
            return ids.map(function (id) {
                ...
                return (<StreamGroup key={id} id={id} statsPeriod={groupStatsPeriod} query={query} hasGuideAnchor={hasGuideAnchor} memberList={members} displayReprocessingLayout={displayReprocessingLayout} useFilteredStats/>);
            });
        };
    ...
    IssueListOverview.prototype.render = function () {
        ...
        var _f = this.state, renderSidebar = _f.renderSidebar, isSidebarVisible = _f.isSidebarVisible, tagsLoading = _f.tagsLoading, pageLinks = _f.pageLinks, queryCount = _f.queryCount, queryCounts = _f.queryCounts, realtimeActive = _f.realtimeActive, groupIds = _f.groupIds, queryMaxCount = _f.queryMaxCount;
        var _g = this.props, organization = _g.organization, savedSearch = _g.savedSearch, savedSearches = _g.savedSearches, tags = _g.tags, selection = _g.selection, location = _g.location, router = _g.router;
        var query = this.getQuery();
        var queryPageInt = parseInt(location.query.page, 10);
        var page = isNaN(queryPageInt) ? 0 : queryPageInt;
        var pageCount = page * MAX_ITEMS + groupIds.length;
        ...
        var projectIds = (_e = selection === null || selection === void 0 ? void 0 : selection.projects) === null || _e === void 0 ? void 0 : _e.map(function (p) { return p.toString(); });
        ...
        {function (_a) {
            ...
            <StyledPageContent isInbox={hasFeature}>
              <StreamContent showSidebar={isSidebarVisible}>
                ...
                <Panel>
                  <IssueListActions organization={organization} selection={selection} query={query} queryCount={queryCount} queryMaxCount={queryMaxCount} pageCount={pageCount} onSelectStatsPeriod={_this.onSelectStatsPeriod} onRealtimeChange={_this.onRealtimeChange} realtimeActive={realtimeActive} statsPeriod={_this.getGroupStatsPeriod()} groupIds={groupIds} allResultsVisible={_this.allResultsVisible()} hasInbox={hasFeature} displayReprocessingActions={displayReprocessingActions}/>
                  <PanelBody>
              ...
              <SidebarContainer showSidebar={isSidebarVisible}>
                ...
                {renderSidebar && (<IssueListSidebar loading={tagsLoading} tags={tags} query={query} onQueryChange={_this.onIssueListSidebarSearch} orgId={orgSlug} tagValueLoader={_this.tagValueLoader}/>)}
              </SidebarContainer>
            </StyledPageContent>
          </React.Fragment>);
        }}
