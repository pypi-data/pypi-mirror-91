...
var IncidentDetails = /** @class */ (function (_super) {
    ...
    IncidentDetails.prototype.render = function () {
        ...
        {organization.features.includes('alert-details-redesign') ? (<DetailsBodyRedesign {...this.props} incident={incident} stats={stats}/>) : (<DetailsBody {...this.props} incident={incident} stats={stats}/>)}
      </React.Fragment>);
    };
