...
var ContextPickerModal = /** @class */ (function (_super) {
    ...
    ContextPickerModal.prototype.renderProjectSelectOrMessage = function () {
        ...
        })} onChange={this.handleSelectProject} onMenuOpen={this.onProjectMenuOpen} components={{ Option: this.customOptionProject, DropdownIndicator: null }} styles={selectSyles} menuIsOpen/>);
    };
    ContextPickerModal.prototype.render = function () {
        ...
        }} placeholder={t('Select an Organization')} name="organization" options={orgChoices} value={organization} onChange={this.handleSelectOrganization} components={{ DropdownIndicator: null }} styles={selectSyles} menuIsOpen/>)}
