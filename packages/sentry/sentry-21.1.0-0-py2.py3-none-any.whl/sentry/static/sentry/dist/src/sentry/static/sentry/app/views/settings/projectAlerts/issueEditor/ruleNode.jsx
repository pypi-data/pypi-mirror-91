...
var RuleNode = /** @class */ (function (_super) {
    ...
    function RuleNode() {
        ...
        _this.updateParent = function (formData, fetchedFieldOptionsCache) {
            var e_1, _a, e_2, _b;
            var _c = _this.props, data = _c.data, index = _c.index, onPropertyChange = _c.onPropertyChange;
            try {
                for (var _d = __values(Object.entries(formData)), _e = _d.next(); !_e.done; _e = _d.next()) {
            ...
            try {
                ...
                for (var _g = __values(Object.entries(fetchedFieldOptionsCache)), _h = _g.next(); !_h.done; _h = _g.next()) {
                    var _j = __read(_h.value, 2), name_2 = _j[0], choices = _j[1];
                    // If a value was actually selected.
                    if (name_2 in formData) {
                        var dynamicFormFieldsCopy = data.dynamic_form_fields;
                        // Overwrite the choices because the user's pick is in this list.
                        if (dynamicFormFieldsCopy === null || dynamicFormFieldsCopy === void 0 ? void 0 : dynamicFormFieldsCopy.hasOwnProperty(name_2)) {
                            dynamicFormFieldsCopy[name_2].choices = choices;
