...
var StyledSelectorItem = styled(SelectorItem)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  display: flex;\n  cursor: pointer;\n  white-space: nowrap;\n  padding: ", ";\n  align-items: center;\n  flex: 1;\n  background-color: ", ";\n  color: ", ";\n  font-weight: ", ";\n  border-bottom: 1px solid ", ";\n\n  &:hover {\n    color: ", ";\n    background: ", ";\n  }\n"], ["\n  display: flex;\n  cursor: pointer;\n  white-space: nowrap;\n  padding: ", ";\n  align-items: center;\n  flex: 1;\n  background-color: ", ";\n  color: ", ";\n  font-weight: ", ";\n  border-bottom: 1px solid ", ";\n\n  &:hover {\n    color: ", ";\n    background: ", ";\n  }\n"])), space(1), function (p) { return (p.selected ? p.theme.active : 'transparent'); }, function (p) { return (p.selected ? p.theme.white : 'inherit'); }, function (p) { return (p.selected ? 'bold' : 'normal'); }, function (p) { return (p.last ? 'transparent' : p.theme.innerBorder); }, function (p) { return p.theme.black; }, function (p) { return p.theme.focus; });
