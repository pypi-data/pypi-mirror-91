...
var withIssueTags = function (WrappedComponent) {
    return createReactClass({
        ...
        setAssigned: function () {
            ...
            var allOwners = __spread(['me_or_none'], allAssigned);
            this.setState({
                tags: __assign(__assign({}, tags), { assigned: __assign(__assign({}, tags.assigned), { values: allAssigned }), bookmarks: __assign(__assign({}, tags.bookmarks), { values: usernames }), owner: __assign(__assign({}, tags.owner), { values: allOwners }) }),
            });
        },
        render: function () {
