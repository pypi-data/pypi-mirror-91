...
var IntegrationServerlessFunctions = /** @class */ (function (_super) {
    ...
    function IntegrationServerlessFunctions() {
        ...
        _this.handleFunctionUpdate = function (serverlessFunction, index) {
            var serverlessFunctions = cloneDeep(_this.serverlessFunctions);
    ...
    IntegrationServerlessFunctions.prototype.renderBody = function () {
        ...
        <Panel>
          ...
          <StyledPanelBody>
            {this.serverlessFunctions.map(function (serverlessFunction, i) { return (<IntegrationServerlessRow key={serverlessFunction.name} serverlessFunction={serverlessFunction} onUpdateFunction={function (response) {
            return _this.handleFunctionUpdate(response, i);
        }} {..._this.props}/>); })}
          </StyledPanelBody>
        </Panel>
      </React.Fragment>);
...
var RuntimeHeader = styled(HeaderText)(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  grid-area: runtime;\n"], ["\n  grid-area: runtime;\n"])));
var VersionHeader = styled(HeaderText)(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  grid-area: version;\n"], ["\n  grid-area: version;\n"])));
var EnableHeader = styled(HeaderText)(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n  grid-area: enable-switch;\n"], ["\n  grid-area: enable-switch;\n"])));
var UpdateHeader = styled(HeaderText)(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n  grid-area: update-button;\n"], ["\n  grid-area: update-button;\n"])));
