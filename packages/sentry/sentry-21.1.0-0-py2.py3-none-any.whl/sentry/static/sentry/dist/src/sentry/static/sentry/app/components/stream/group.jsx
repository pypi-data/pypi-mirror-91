...
var StreamGroup = /** @class */ (function (_super) {
    ...
    StreamGroup.prototype.render = function () {
        ...
        var _c = this.props, query = _c.query, hasGuideAnchor = _c.hasGuideAnchor, canSelect = _c.canSelect, memberList = _c.memberList, withChart = _c.withChart, statsPeriod = _c.statsPeriod, selection = _c.selection, organization = _c.organization, displayReprocessingLayout = _c.displayReprocessingLayout;
