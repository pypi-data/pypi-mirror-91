...
var ProjectVelocityScoreCard = /** @class */ (function (_super) {
    ...
    ProjectVelocityScoreCard.prototype.onLoadAllEndpointsSuccess = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, currentReleases, previousReleases, _b, organization, selection, hasOlderReleases;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _a = this.state, currentReleases = _a.currentReleases, previousReleases = _a.previousReleases;
                        _b = this.props, organization = _b.organization, selection = _b.selection;
    ...
    Object.defineProperty(ProjectVelocityScoreCard.prototype, "trendStyle", {
        get: function () {
            if (!this.trend) {
                return undefined;
            }
