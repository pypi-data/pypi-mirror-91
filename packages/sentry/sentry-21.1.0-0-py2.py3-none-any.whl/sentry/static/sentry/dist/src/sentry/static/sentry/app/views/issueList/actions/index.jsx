...
var IssueListActions = /** @class */ (function (_super) {
    ...
    IssueListActions.prototype.render = function () {
        var _a = this.props, allResultsVisible = _a.allResultsVisible, queryCount = _a.queryCount, hasInbox = _a.hasInbox, query = _a.query, realtimeActive = _a.realtimeActive, statsPeriod = _a.statsPeriod, pageCount = _a.pageCount, queryMaxCount = _a.queryMaxCount, selection = _a.selection, organization = _a.organization, displayReprocessingActions = _a.displayReprocessingActions;
        ...
        <StyledFlex>
          ...
          {(anySelected || !hasInbox) && !displayReprocessingActions && (<ActionSet orgSlug={organization.slug} queryCount={queryCount} query={query} realtimeActive={realtimeActive} hasInbox={hasInbox} issues={issues} allInQuerySelected={allInQuerySelected} anySelected={anySelected} multiSelected={multiSelected} selectedProjectSlug={selectedProjectSlug} onShouldConfirm={this.shouldConfirm} onDelete={this.handleDelete} onRealtimeChange={this.handleRealtimeChange} onMerge={this.handleMerge} onUpdate={this.handleUpdate}/>)}
          {(!anySelected || !hasInbox) && (<Headers onSelectStatsPeriod={this.handleSelectStatsPeriod} selection={selection} statsPeriod={statsPeriod} pageCount={pageCount} queryCount={queryCount} queryMaxCount={queryMaxCount} hasInbox={hasInbox} isReprocessingQuery={displayReprocessingActions}/>)}
        </StyledFlex>
