...
var ProjectDocs = /** @class */ (function (_super) {
    ...
    ProjectDocs.prototype.render = function () {
        ...
        <TitleContainer>
          <StepHeading step={2}>
            {t('Prepare the %s SDK', (_c = (_b = platforms.find(function (p) { return p.id === currentPlatform; })) === null || _b === void 0 ? void 0 : _b.name) !== null && _c !== void 0 ? _c : '')}
          </StepHeading>
          <motion.div variants={{
        ...
        {project && (<FirstEventIndicator organization={organization} project={project} eventType="error">
            ...
            return (<CTAFooter>
                <Actions gap={2}>
                  {firstEventButton}
                  <Button external onClick={_this.handleFullDocsClick} href={platformDocs === null || platformDocs === void 0 ? void 0 : platformDocs.link}>
        ...
        <CTASecondary>
          {tct('Just want to poke around before getting too cozy with the SDK? [sample:View a sample event for this SDK] and finish setup later.', {
            sample: (<CreateSampleEventButton project={project !== null && project !== void 0 ? project : undefined} source="onboarding" priority="link"/>),
        })}
        </CTASecondary>
      </DocsWrapper>);
...
var CTAFooter = styled('div')(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  display: flex;\n  justify-content: space-between;\n  margin: ", " 0;\n  margin-top: ", ";\n"], ["\n  display: flex;\n  justify-content: space-between;\n  margin: ", " 0;\n  margin-top: ", ";\n"])), space(2), space(4));
var CTASecondary = styled('p')(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  color: ", ";\n  font-size: ", ";\n  margin: 0;\n  max-width: 500px;\n"], ["\n  color: ", ";\n  font-size: ", ";\n  margin: 0;\n  max-width: 500px;\n"])), function (p) { return p.theme.subText; }, function (p) { return p.theme.fontSizeMedium; });
...
//# sourceMappingURL=projectSetup.jsx.map