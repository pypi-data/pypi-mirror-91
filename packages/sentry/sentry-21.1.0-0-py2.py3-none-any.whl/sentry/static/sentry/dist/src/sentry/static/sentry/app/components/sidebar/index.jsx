...
var Sidebar = /** @class */ (function (_super) {
    ...
    Sidebar.prototype.render = function () {
        ...
        {function (_a) {
            ...
            return (<SidebarItem {...sidebarItemProps} onClick={function (_id, evt) { return _this.navigateWithGlobalSelection(alertsPath, evt); }} icon={<IconSiren size="md"/>} label={t('Alerts')} to={alertsPath} id="alerts" isNew/>);
        }}
      </Feature>);
