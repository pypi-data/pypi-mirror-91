...
var AbstractExternalIssueForm = /** @class */ (function (_super) {
    ...
    function AbstractExternalIssueForm() {
        ...
        _this.updateFetchedFieldOptionsCache = function (_field, _result) {
            // Do nothing.
        };
    ...
    AbstractExternalIssueForm.prototype.getDefaultState = function () {
        return __assign(__assign({}, _super.prototype.getDefaultState.call(this)), { action: 'create', dynamicFieldValues: null, integrationDetails: null });
    };
