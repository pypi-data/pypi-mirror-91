...
function Headers(_a) {
    var selection = _a.selection, statsPeriod = _a.statsPeriod, pageCount = _a.pageCount, queryCount = _a.queryCount, queryMaxCount = _a.queryMaxCount, onSelectStatsPeriod = _a.onSelectStatsPeriod, isReprocessingQuery = _a.isReprocessingQuery, hasInbox = _a.hasInbox;
    return (<React.Fragment>
      {hasInbox && (<ActionSetPlaceholder>
      ...
      {isReprocessingQuery ? (<React.Fragment>
          ...
          <GraphHeaderWrapper className="hidden-xs hidden-sm">
            <GraphHeader>
              ...
              <GraphToggle active={statsPeriod === '24h'} onClick={function () { return onSelectStatsPeriod('24h'); }}>
                {t('24h')}
              </GraphToggle>
