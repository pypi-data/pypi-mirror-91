...
var Actions = /** @class */ (function (_super) {
    ...
    Actions.prototype.render = function () {
        ...
        {orgFeatures.has('reprocessing-v2') && (<ActionButton disabled={disabled} icon={<IconRefresh size="xs"/>} title={t('Reprocess this issue')} label={t('Reprocess this issue')} onClick={this.handleClick(disabled, this.onReprocess)}/>)}
      </Wrapper>);
    };
    return Actions;
}(React.Component));
