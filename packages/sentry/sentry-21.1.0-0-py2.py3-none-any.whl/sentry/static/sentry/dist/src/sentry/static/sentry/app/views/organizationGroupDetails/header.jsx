...
var GroupHeader = /** @class */ (function (_super) {
    ...
    GroupHeader.prototype.render = function () {
        var _a;
        var _b = this.props, project = _b.project, group = _b.group, currentTab = _b.currentTab, baseUrl = _b.baseUrl;
        ...
        <div className="row">
          <div className="col-sm-7">
            ...
            <StyledTagAndMessageWrapper>
              ...
              {group.isUnhandled &&
            (hasInbox ? (<UnhandledInboxTag organization={organization}/>) : (<UnhandledTag />))}
