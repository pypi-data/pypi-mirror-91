...
class WorkerConfig(object):
    ...
    def create_new(cls, config_path, *args, **kwargs):
        ...
        config.set('main', 'python_path', str(kwargs.get('python_path', None)))
...
class Worker(WorkerConfig):
    ...
    def process_request(self, message):
        time.sleep(1)
        return f'hello from worker {id}. This is the response to your request: {message}'
