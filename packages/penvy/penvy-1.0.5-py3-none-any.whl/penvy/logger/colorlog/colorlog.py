...
from penvy.logger.colorlog.escape_codes import escape_codes, parse_colors

__all__ = ("escape_codes", "default_log_colors", "ColoredFormatter", "LevelFormatter", "TTYColoredFormatter")
...
class ColoredFormatter(logging.Formatter):
    ...
    def __init__(self, fmt=None, datefmt=None, style="%", log_colors=None, reset=True, secondary_log_colors=None):
        """
    ...
    def __init__(self, fmt=None, datefmt=None, style="%", log_colors=None, reset=True, secondary_log_colors=None):
        ...
        if sys.version_info > (2, 7):
            super(LevelFormatter, self).__init__(
                fmt=fmt, datefmt=datefmt, style=style, log_colors=log_colors, reset=reset, secondary_log_colors=secondary_log_colors
            )
        else:
            ColoredFormatter.__init__(
                self, fmt=fmt, datefmt=datefmt, style=style, log_colors=log_colors, reset=reset, secondary_log_colors=secondary_log_colors
            )
        self.style = style
        self.fmt = fmt
