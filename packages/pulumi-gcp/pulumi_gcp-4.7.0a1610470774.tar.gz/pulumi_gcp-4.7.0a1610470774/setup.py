...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', '4.7.0-alpha.1610470774+e6e37fa5'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp 4.7.0-alpha.1610470774+e6e37fa5`
                """)
            else:
                raise
