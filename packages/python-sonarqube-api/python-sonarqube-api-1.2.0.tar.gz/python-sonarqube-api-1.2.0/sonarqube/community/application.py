...
from sonarqube.utils.config import (
    API_PROJECTS_SEARCH_ENDPOINT, API_APPLICATION_CREATE_ENDPOINT, API_APPLICATION_DELETE_ENDPOINT,
    API_APPLICATION_SHOW_ENDPOINT, API_APPLICATION_UPDATE_ENDPOINT, API_APPLICATION_ADD_PROJECT_ENDPOINT,
    API_APPLICATION_REMOVE_PROJECT_ENDPOINT, API_APPLICATION_CREATE_BRANCH_ENDPOINT,
    API_APPLICATION_DELETE_BRANCH_ENDPOINT, API_APPLICATION_SET_TAGS_ENDPOINT, API_APPLICATION_UPDATE_BRANCH_ENDPOINT)
