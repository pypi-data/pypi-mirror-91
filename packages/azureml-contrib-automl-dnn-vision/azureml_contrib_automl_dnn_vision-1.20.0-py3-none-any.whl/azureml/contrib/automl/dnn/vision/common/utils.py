...
from azureml.automl.core.shared.logging_utilities import _get_pii_free_message, _CustomStackSummary
...
from .constants import ArtifactLiterals, RunPropertyLiterals, SystemSettings, SettingsLiterals, Warnings
...
def _exception_handler(func, fail_run=True):
    """This decorates a function to handle uncaught exceptions and fail the run with
    System Error.
