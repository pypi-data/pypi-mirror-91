...
namespace __pythran_mini_oper_modif_resol
{
  ...
  typename fill_field_fft_3d::type<argument_type0, argument_type1>::result_type fill_field_fft_3d::operator()(argument_type0&& field_fft_in, argument_type1&& field_fft_out) const
  {
    ...
    typedef typename std::tuple_element<1,typename std::remove_reference<__type3>::type>::type __type13;
    typedef typename std::tuple_element<1,typename std::remove_reference<__type6>::type>::type __type14;
    typedef typename pythonic::assignable<decltype(std::declval<__type1>()(std::declval<__type13>(), std::declval<__type14>()))>::type __type15;
    typedef decltype(pythonic::operator_::functor::floordiv()(std::declval<__type15>(), std::declval<__type9>())) __type16;
    typedef decltype(pythonic::operator_::add(std::declval<__type16>(), std::declval<__type9>())) __type17;
    typedef decltype(std::declval<__type0>()(std::declval<__type17>())) __type18;
    typedef typename std::tuple_element<2,typename std::remove_reference<__type3>::type>::type __type19;
    typedef typename std::tuple_element<2,typename std::remove_reference<__type6>::type>::type __type20;
    typedef decltype(std::declval<__type1>()(std::declval<__type19>(), std::declval<__type20>())) __type21;
    typedef typename pythonic::lazy<__type21>::type __type22;
    typedef decltype(std::declval<__type0>()(std::declval<__type22>())) __type23;
    typename pythonic::assignable<typename std::remove_cv<typename std::iterator_traits<typename std::remove_reference<__type12>::type::iterator>::value_type>::type>::type ik0;
    typename pythonic::assignable<typename std::remove_cv<typename std::iterator_traits<typename std::remove_reference<__type18>::type::iterator>::value_type>::type>::type ik1;
    typename pythonic::assignable<typename std::remove_cv<typename std::iterator_traits<typename std::remove_reference<__type23>::type::iterator>::value_type>::type>::type ik2;
    ...
    {
      long  __target140070081482080 = pythonic::operator_::add(pythonic::operator_::functor::floordiv()(nk0_min, 2L), 1L);
      for (long  ik0=0L; ik0 < __target140070081482080; ik0 += 1L)
      {
        {
          long  __target140070081484448 = pythonic::operator_::add(pythonic::operator_::functor::floordiv()(nk1_min, 2L), 1L);
          for (long  ik1=0L; ik1 < __target140070081484448; ik1 += 1L)
          {
            {
              long  __target140070081485552 = nk2_min;
              for (long  ik2=0L; ik2 < __target140070081485552; ik2 += 1L)
              {
...
PYTHRAN_MODULE_INIT(mini_oper_modif_resol)(void) {
    ...
    PyObject * theDoc = Py_BuildValue("(sss)",
                                      "0.9.8.dev",
                                      "2021-01-11 15:34:26.068131",
                                      "0c3116b950bd906bd529bdeb6700e9fe26833bf652165cab63fc45aba753b46d");
    if(! theDoc)
        PYTHRAN_RETURN;
