...
"");
  ...
  typename dealiasing_variable::type<argument_type0, argument_type1>::result_type dealiasing_variable::operator()(argument_type0&& ff_fft, argument_type1&& where_dealiased) const
  {
    ...
    {
      long  __target140070085144736 = n0;
      for (long  i0=0L; i0 < __target140070085144736; i0 += 1L)
      {
        {
          long  __target140070085210560 = n1;
          for (long  i1=0L; i1 < __target140070085210560; i1 += 1L)
          {
            {
              long  __target140070085211280 = n2;
              for (long  i2=0L; i2 < __target140070085211280; i2 += 1L)
              {
  ...
  typename dealiasing_setofvar::type<argument_type0, argument_type1>::result_type dealiasing_setofvar::operator()(argument_type0&& sov, argument_type1&& where_dealiased) const
  {
    ...
    typedef typename std::remove_cv<typename std::remove_reference<argument_type0>::type>::type __type1;
    typedef decltype(pythonic::builtins::getattr(pythonic::types::attr::SHAPE{}, std::declval<__type1>())) __type2;
    typedef typename std::tuple_element<3,typename std::remove_reference<__type2>::type>::type __type3;
    typedef typename pythonic::lazy<__type3>::type __type4;
    typedef decltype(std::declval<__type0>()(std::declval<__type4>())) __type5;
    ...
    typedef typename pythonic::lazy<__type9>::type __type10;
    typedef decltype(std::declval<__type0>()(std::declval<__type10>())) __type11;
    typedef typename std::tuple_element<0,typename std::remove_reference<__type2>::type>::type __type12;
    typedef typename pythonic::lazy<__type12>::type __type13;
    typedef decltype(std::declval<__type0>()(std::declval<__type13>())) __type14;
    typename pythonic::assignable<typename std::remove_cv<typename std::iterator_traits<typename std::remove_reference<__type5>::type::iterator>::value_type>::type>::type i2;
    typename pythonic::assignable<typename std::remove_cv<typename std::iterator_traits<typename std::remove_reference<__type8>::type::iterator>::value_type>::type>::type i1;
    typename pythonic::assignable<typename std::remove_cv<typename std::iterator_traits<typename std::remove_reference<__type11>::type::iterator>::value_type>::type>::type i0;
    typename pythonic::assignable<typename std::remove_cv<typename std::iterator_traits<typename std::remove_reference<__type14>::type::iterator>::value_type>::type>::type ik;
    ...
    {
      long  __target140070085203280 = n0;
      for (long  i0=0L; i0 < __target140070085203280; i0 += 1L)
      {
        {
          long  __target140070085204912 = n1;
          for (long  i1=0L; i1 < __target140070085204912; i1 += 1L)
          {
            {
              long  __target140070085205632 = n2;
              for (long  i2=0L; i2 < __target140070085205632; i2 += 1L)
              {
                if (where_dealiased.fast(pythonic::types::make_tuple(i0, i1, i2)))
                {
                  {
                    long  __target140070085145696 = nk;
                    for (long  ik=0L; ik < __target140070085145696; ik += 1L)
                    {
    ...
    {NULL, NULL, 0, NULL}
            ...
            PYTHRAN_MODULE_INIT(operators3d)(void) {
                ...
                PyObject * theDoc = Py_BuildValue("(sss)",
                                                  "0.9.8.dev",
                                                  "2021-01-11 15:34:25.156195",
                                                  "5f7b918caf0453906e1ee4387d95bf5471b73cf15e367c041eda62b290a10e18");
                if(! theDoc)
                    PYTHRAN_RETURN;
