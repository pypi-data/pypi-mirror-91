...
class Dminimum:
	...
	def get_df_2_s(self) -> Df2SStruct:
		...
		Snippet: value: Df2SStruct = driver.configure.multiEval.limit.lowEnergy.dminimum.get_df_2_s() \n
		...
		"""
		return self._core.io.query_struct('CONFigure:BLUetooth:MEASurement<Instance>:MEValuation:LIMit:LENergy:DMINimum:DF2S?', self.__class__.Df2SStruct())

	def set_df_2_s(self, value: Df2SStruct) -> None:
		"""SCPI: CONFigure:BLUetooth:MEASurement<Instance>:MEValuation:LIMit:LENergy:DMINimum:DF2S \n
		Snippet: driver.configure.multiEval.limit.lowEnergy.dminimum.set_df_2_s(value = Df2SStruct()) \n
		Defines the lower and upper Δf2 frequency deviation limits for uncoded LE 1M PHY. The mnemonics DAVerage, DMINimum,
		DMAXimum distinguish average, minimum and maximum frequency deviations. \n
			:param value: see the help for Df2SStruct structure arguments.
		"""
		self._core.io.write_struct('CONFigure:BLUetooth:MEASurement<Instance>:MEValuation:LIMit:LENergy:DMINimum:DF2S', value)
	...
	def get_value(self) -> ValueStruct:
		...
		Snippet: value: ValueStruct = driver.configure.multiEval.limit.lowEnergy.dminimum.get_value() \n
		...
		"""
		return self._core.io.query_struct('CONFigure:BLUetooth:MEASurement<Instance>:MEValuation:LIMit:LENergy:DMINimum?', self.__class__.ValueStruct())

	def set_value(self, value: ValueStruct) -> None:
		"""SCPI: CONFigure:BLUetooth:MEASurement<Instance>:MEValuation:LIMit:LENergy:DMINimum \n
		Snippet: driver.configure.multiEval.limit.lowEnergy.dminimum.set_value(value = ValueStruct()) \n
		Defines the lower and upper Δf1 frequency deviation limits for LE 1M PHY. The mnemonics DAVerage, DMINimum, DMAXimum
		distinguish average, minimum and maximum frequency deviations. \n
			:param value: see the help for ValueStruct structure arguments.
		"""
		self._core.io.write_struct('CONFigure:BLUetooth:MEASurement<Instance>:MEValuation:LIMit:LENergy:DMINimum', value)
