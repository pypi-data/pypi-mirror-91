...
class Le2M:
	...
	def get_freq_offset(self) -> FreqOffsetStruct:
		...
		Snippet: value: FreqOffsetStruct = driver.configure.multiEval.limit.lowEnergy.le2M.get_freq_offset() \n
		...
		"""
		return self._core.io.query_struct('CONFigure:BLUetooth:MEASurement<Instance>:MEValuation:LIMit:LENergy:LE2M:FOFFset?', self.__class__.FreqOffsetStruct())

	def set_freq_offset(self, value: FreqOffsetStruct) -> None:
		"""SCPI: CONFigure:BLUetooth:MEASurement<Instance>:MEValuation:LIMit:LENergy:LE2M:FOFFset \n
		Snippet: driver.configure.multiEval.limit.lowEnergy.le2M.set_freq_offset(value = FreqOffsetStruct()) \n
		Sets/gets the frequency offset limit. Commands for uncoded LE 1M PHY (..:LE1M..) , LE 2M PHY (..:LE2M..) , and LE coded
		PHY (..:LRANge..) are available. \n
