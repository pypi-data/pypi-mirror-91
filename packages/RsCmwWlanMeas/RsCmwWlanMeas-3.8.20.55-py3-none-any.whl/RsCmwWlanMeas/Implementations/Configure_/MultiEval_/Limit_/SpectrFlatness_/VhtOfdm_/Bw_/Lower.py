...
class Lower:
	...
	def set(self, structure: LowerStruct, bandwidthE=repcap.BandwidthE.Default) -> None:
		"""SCPI: CONFigure:WLAN:MEASurement<Instance>:MEValuation:LIMit:SFLatness:VHTofdm:BW<bandwidth>:LOWer \n
		Snippet: driver.configure.multiEval.limit.spectrFlatness.vhtOfdm.bw.lower.set(value = [PROPERTY_STRUCT_NAME](), bandwidthE = repcap.BandwidthE.Default) \n
		...
		self._core.io.write_struct(f'CONFigure:WLAN:MEASurement<Instance>:MEValuation:LIMit:SFLatness:VHTofdm:BW{bandwidthE_cmd_val}:LOWer', structure)
