...
class Bw:
	...
	class BwStruct(StructBase):
		"""Structure for setting input parameters. Contains optional setting parameters. Fields: \n
			...
			- Offset_Value_Abs: float or bool: Optional setting parameter. numeric | ON | OFF Absolute limit, only for BW=8080 Range: -100 dBm to 0 dBm, Unit: dBm Additional parameters: OFF | ON (disables | enables the limit check)"""
		__meta_args_list = [
	...
	def set(self, structure: BwStruct, bandwidthE=repcap.BandwidthE.Default) -> None:
		...
		Snippet: driver.configure.multiEval.limit.modulation.vhtOfdm.iqOffset.bw.set(value = [PROPERTY_STRUCT_NAME](), bandwidthE = repcap.BandwidthE.Default) \n
		...
		self._core.io.write_struct(f'CONFigure:WLAN:MEASurement<Instance>:MEValuation:LIMit:MODulation:VHTofdm:IQOFfset:BW{bandwidthE_cmd_val}', structure)
