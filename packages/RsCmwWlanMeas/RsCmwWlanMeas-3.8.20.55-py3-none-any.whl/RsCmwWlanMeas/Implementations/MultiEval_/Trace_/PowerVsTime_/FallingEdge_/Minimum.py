...
class Minimum:
	...
	def read(self, start: float = None, count: float = None, decimation: float = None) -> List[float]:
		...
		Use RsCmwWlanMeas.reliability.last_value to read the updated reliability indicator. \n
			...
			:return: power_min: float Comma-separated list of power values For DSSS signals, the values are returned in percent relative to the configured reference power. For OFDM signals, the values are in dBm. Range: 0 % to 200 % (DSSS) / -100 dBm to 30 dBm (OFDM) , Unit: % or dBm"""
