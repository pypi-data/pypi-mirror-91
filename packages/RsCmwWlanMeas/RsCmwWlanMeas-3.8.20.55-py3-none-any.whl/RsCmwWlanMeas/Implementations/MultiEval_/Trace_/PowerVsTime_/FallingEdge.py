...
class FallingEdge:
	"""FallingEdge commands group definition. 40 total commands, 7 Sub-groups, 0 group commands"""
	...
	def mimo(self):
		...
		if not hasattr(self, '_mimo'):
			from .FallingEdge_.Mimo import Mimo
	...
	def current(self):
		...
		if not hasattr(self, '_current'):
			from .FallingEdge_.Current import Current
	...
	def average(self):
		...
		if not hasattr(self, '_average'):
			from .FallingEdge_.Average import Average
	...
	def maximum(self):
		...
		if not hasattr(self, '_maximum'):
			from .FallingEdge_.Maximum import Maximum
	...
	def minimum(self):
		...
		if not hasattr(self, '_minimum'):
			from .FallingEdge_.Minimum import Minimum
	...
	def time(self):
		...
		if not hasattr(self, '_time'):
			from .FallingEdge_.Time import Time
	...
	def segment(self):
		...
		if not hasattr(self, '_segment'):
			from .FallingEdge_.Segment import Segment
