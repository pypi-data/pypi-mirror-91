...
class Terror:
	"""Terror commands group definition. 2 total commands, 0 Sub-groups, 2 group commands"""
	...
	def read(self, start: float = None, count: float = None, decimation: float = None) -> List[float]:
		...
		MultiEval.Scount.powerVsTime. For the optional query parameters <start>, <count> and <decimation>, see 'Trace Sub-Arrays'. \n
