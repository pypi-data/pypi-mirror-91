...
class Carrier:
	"""Carrier commands group definition. 32 total commands, 6 Sub-groups, 0 group commands"""
	...
	def current(self):
		...
		if not hasattr(self, '_current'):
			from .Carrier_.Current import Current
	...
	def average(self):
		...
		if not hasattr(self, '_average'):
			from .Carrier_.Average import Average
	...
	def maximum(self):
		...
		if not hasattr(self, '_maximum'):
			from .Carrier_.Maximum import Maximum
	...
	def minimum(self):
		...
		if not hasattr(self, '_minimum'):
			from .Carrier_.Minimum import Minimum
	...
	def segment(self):
		...
		if not hasattr(self, '_segment'):
			from .Carrier_.Segment import Segment
	...
	def mimo(self):
		...
		if not hasattr(self, '_mimo'):
			from .Carrier_.Mimo import Mimo
