...
class Smimo:
	"""Smimo commands group definition. 12 total commands, 4 Sub-groups, 0 group commands"""
	...
	def current(self):
		...
		if not hasattr(self, '_current'):
			from .Smimo_.Current import Current
	...
	def average(self):
		...
		if not hasattr(self, '_average'):
			from .Smimo_.Average import Average
	...
	def maximum(self):
		...
		if not hasattr(self, '_maximum'):
			from .Smimo_.Maximum import Maximum
	...
	def standardDev(self):
		...
		if not hasattr(self, '_standardDev'):
			from .Smimo_.StandardDev import StandardDev
