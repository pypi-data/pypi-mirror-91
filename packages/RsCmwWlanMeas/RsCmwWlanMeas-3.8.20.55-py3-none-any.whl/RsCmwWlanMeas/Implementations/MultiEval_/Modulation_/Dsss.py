...
class Dsss:
	"""Dsss commands group definition. 15 total commands, 5 Sub-groups, 0 group commands"""
	...
	def current(self):
		...
		if not hasattr(self, '_current'):
			from .Dsss_.Current import Current
	...
	def average(self):
		...
		if not hasattr(self, '_average'):
			from .Dsss_.Average import Average
	...
	def maximum(self):
		...
		if not hasattr(self, '_maximum'):
			from .Dsss_.Maximum import Maximum
	...
	def standardDev(self):
		...
		if not hasattr(self, '_standardDev'):
			from .Dsss_.StandardDev import StandardDev
	...
	def minimum(self):
		...
		if not hasattr(self, '_minimum'):
			from .Dsss_.Minimum import Minimum
