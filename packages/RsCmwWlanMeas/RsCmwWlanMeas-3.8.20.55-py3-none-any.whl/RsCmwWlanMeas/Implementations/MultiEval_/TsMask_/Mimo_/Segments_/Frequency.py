...
class Frequency:
	"""Frequency commands group definition. 12 total commands, 4 Sub-groups, 0 group commands"""
	...
	def average(self):
		...
		if not hasattr(self, '_average'):
			from .Frequency_.Average import Average
	...
	def maximum(self):
		...
		if not hasattr(self, '_maximum'):
			from .Frequency_.Maximum import Maximum
	...
	def minimum(self):
		...
		if not hasattr(self, '_minimum'):
			from .Frequency_.Minimum import Minimum
