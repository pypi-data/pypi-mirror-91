...
class Cfactor:
	"""Cfactor commands group definition. 5 total commands, 5 Sub-groups, 0 group commands"""
	...
	def current(self):
		...
		if not hasattr(self, '_current'):
			from .Cfactor_.Current import Current
	...
	def average(self):
		...
		if not hasattr(self, '_average'):
			from .Cfactor_.Average import Average
	...
	def maximum(self):
		...
		if not hasattr(self, '_maximum'):
			from .Cfactor_.Maximum import Maximum
	...
	def standardDev(self):
		...
		if not hasattr(self, '_standardDev'):
			from .Cfactor_.StandardDev import StandardDev
	...
	def minimum(self):
		...
		if not hasattr(self, '_minimum'):
			from .Cfactor_.Minimum import Minimum
	...
	def clone(self) -> 'Cfactor':
		...
		new_group = Cfactor(self._core, self._base.parent)
