...
class Bpower:
	"""Bpower commands group definition. 5 total commands, 5 Sub-groups, 0 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._base = CommandsGroup("bpower", core, parent)

	@property
	def current(self):
		"""current commands group. 0 Sub-classes, 1 commands."""
		if not hasattr(self, '_current'):
			from .Bpower_.Current import Current
	...
	def average(self):
		...
		if not hasattr(self, '_average'):
			from .Bpower_.Average import Average
	...
	def maximum(self):
		...
		if not hasattr(self, '_maximum'):
			from .Bpower_.Maximum import Maximum
	...
	def standardDev(self):
		...
		if not hasattr(self, '_standardDev'):
			from .Bpower_.StandardDev import StandardDev
	...
	def minimum(self):
		...
		if not hasattr(self, '_minimum'):
			from .Bpower_.Minimum import Minimum
	...
	def clone(self) -> 'Bpower':
		...
		new_group = Bpower(self._core, self._base.parent)
