...
class IqOffset:
	"""IqOffset commands group definition. 5 total commands, 5 Sub-groups, 0 group commands"""
	...
	def maximum(self):
		...
		if not hasattr(self, '_maximum'):
			from .IqOffset_.Maximum import Maximum
	...
	def minimum(self):
		...
		if not hasattr(self, '_minimum'):
			from .IqOffset_.Minimum import Minimum
