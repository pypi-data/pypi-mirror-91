...
class Lower:
	...
	def set(self, structure: LowerStruct, bandwidthB=repcap.BandwidthB.Default) -> None:
		"""SCPI: CONFigure:WLAN:MEASurement<Instance>:MEValuation:LIMit:SFLatness:POFDm:BW<bandwidth>:LOWer \n
		Snippet: driver.configure.multiEval.limit.spectrFlatness.pofdm.bw.lower.set(value = [PROPERTY_STRUCT_NAME](), bandwidthB = repcap.BandwidthB.Default) \n
		...
		self._core.io.write_struct(f'CONFigure:WLAN:MEASurement<Instance>:MEValuation:LIMit:SFLatness:POFDm:BW{bandwidthB_cmd_val}:LOWer', structure)
