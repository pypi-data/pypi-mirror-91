...
class Bw:
	...
	def __init__(self, core: Core, parent):
		...
		self._base.rep_cap = RepeatedCapability(self._base.group_name, 'repcap_bandwidthD_get', 'repcap_bandwidthD_set', repcap.BandwidthD.Bw20)

	def repcap_bandwidthD_set(self, enum_value: repcap.BandwidthD) -> None:
