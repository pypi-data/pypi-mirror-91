...
class Bw:
	...
	def __init__(self, core: Core, parent):
		...
		self._base.rep_cap = RepeatedCapability(self._base.group_name, 'repcap_bandwidthB_get', 'repcap_bandwidthB_set', repcap.BandwidthB.Bw5)

	def repcap_bandwidthB_set(self, enum_value: repcap.BandwidthB) -> None:
