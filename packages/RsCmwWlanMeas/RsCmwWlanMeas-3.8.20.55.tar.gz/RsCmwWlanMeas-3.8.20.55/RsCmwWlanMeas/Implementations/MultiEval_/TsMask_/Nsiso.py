...
class Nsiso:
	"""Nsiso commands group definition. 9 total commands, 3 Sub-groups, 0 group commands"""
	...
	def current(self):
		...
		if not hasattr(self, '_current'):
			from .Nsiso_.Current import Current
	...
	def average(self):
		...
		if not hasattr(self, '_average'):
			from .Nsiso_.Average import Average
	...
	def maximum(self):
		...
		if not hasattr(self, '_maximum'):
			from .Nsiso_.Maximum import Maximum
