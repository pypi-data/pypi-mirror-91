...
class CfError:
	"""CfError commands group definition. 5 total commands, 5 Sub-groups, 0 group commands"""
	...
	def current(self):
		...
		if not hasattr(self, '_current'):
			from .CfError_.Current import Current
	...
	def average(self):
		...
		if not hasattr(self, '_average'):
			from .CfError_.Average import Average
	...
	def maximum(self):
		...
		if not hasattr(self, '_maximum'):
			from .CfError_.Maximum import Maximum
	...
	def standardDev(self):
		...
		if not hasattr(self, '_standardDev'):
			from .CfError_.StandardDev import StandardDev
	...
	def minimum(self):
		...
		if not hasattr(self, '_minimum'):
			from .CfError_.Minimum import Minimum
	...
	def clone(self) -> 'CfError':
		...
		new_group = CfError(self._core, self._base.parent)
