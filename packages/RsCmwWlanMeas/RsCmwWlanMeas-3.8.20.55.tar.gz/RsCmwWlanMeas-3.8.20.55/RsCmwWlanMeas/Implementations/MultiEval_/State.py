...
class State:
	...
	def fetch(self) -> enums.ResourceState:
		...
		INITiate..., STOP..., ABORt... to change the measurement state. \n
			:return: multi_eval_state: OFF | RUN | RDY OFF: measurement off, no resources allocated, no results RUN: measurement running, synchronization pending or adjusted, resources active or queued RDY: measurement terminated, valid results can be available"""
