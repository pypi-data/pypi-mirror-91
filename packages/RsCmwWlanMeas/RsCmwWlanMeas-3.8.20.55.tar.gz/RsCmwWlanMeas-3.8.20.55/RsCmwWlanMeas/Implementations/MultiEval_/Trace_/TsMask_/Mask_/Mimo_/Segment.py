...
class Segment:
	...
	def read(self, start: float = None, count: float = None, decimation: float = None, mimo=repcap.Mimo.Default, segment=repcap.Segment.Default) -> List[float]:
		...
		Return the power values (Y-values) of the transmit spectrum mask limit line trace for segment <seg> and antenna/stream
		number <n>, for MIMO measurements and bandwidths with two segments. \n
