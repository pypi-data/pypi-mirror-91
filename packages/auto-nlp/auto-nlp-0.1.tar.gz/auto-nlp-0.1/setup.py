...
setup(
  name = 'auto-nlp',         # How you named your package folder (MyLib)
  packages = ['auto-nlp'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/aryxns/auto-nlp/archive/v_01.tar.gz',    # I explain this later on
