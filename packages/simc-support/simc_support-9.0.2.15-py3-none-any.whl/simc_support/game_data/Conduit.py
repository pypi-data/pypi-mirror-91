...
def get_conduits_for_spec(wow_spec: WowSpec) -> typing.Tuple[Conduit, ...]:
    ...
    # spell_id lists
    SPECIAL_CASES = {
        get_wow_spec("death_knight", "blood"): [
            338566,  # Lingering Plague, 125
        ]
    }
    ...
    conduits = [
        ...
        if wow_spec in conduit.wow_specs
        and conduit.is_potency
        or wow_spec in SPECIAL_CASES
        and conduit.spell_id in SPECIAL_CASES[wow_spec]
    ]
