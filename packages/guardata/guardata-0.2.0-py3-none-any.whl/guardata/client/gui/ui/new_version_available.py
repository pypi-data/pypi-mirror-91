...
# Form implementation generated from reading ui file 'guardata/client/gui/forms/new_version_available.ui'
#
...
class Ui_NewVersionAvailable(object):
    ...
    def retranslateUi(self, NewVersionAvailable):
        ...
        self.button_download.setText(_translate("NewVersionAvailable", "ACTION_GUARDATA_DOWNLOAD_NEW_VERSION"))
        self.button_ignore.setText(_translate("NewVersionAvailable", "ACTION_GUARDATA_IGNORE_NEW_VERSION"))
