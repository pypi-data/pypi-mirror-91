...
class CfnUser(
    ...
    def __init__(
        ...
        *,
        ...
        passwords: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnUser.PasswordListProperty"]] = None,
    ) -> None:
    ...
    def passwords(
        self,
    ) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnUser.PasswordListProperty"]]:
    ...
    def passwords(
        self,
        value: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnUser.PasswordListProperty"]],
    ) -> None:
        jsii.set(self, "passwords", value)

    @jsii.data_type(
        jsii_type="@aws-cdk/aws-elasticache.CfnUser.AuthenticationProperty",
        jsii_struct_bases=[],
    ...
    @jsii.data_type(
        jsii_type="@aws-cdk/aws-elasticache.CfnUser.PasswordListProperty",
        jsii_struct_bases=[],
        name_mapping={"password_list": "passwordList"},
    )
    class PasswordListProperty:
        def __init__(
            self,
            *,
            password_list: typing.Optional[typing.List[builtins.str]] = None,
        ) -> None:
            """
            :param password_list: ``CfnUser.PasswordListProperty.PasswordList``.
            ...
            if password_list is not None:
                self._values["password_list"] = password_list

        @builtins.property
        def password_list(self) -> typing.Optional[typing.List[builtins.str]]:
            """``CfnUser.PasswordListProperty.PasswordList``.
            ...
            """
            result = self._values.get("password_list")
            return result
        ...
        def __repr__(self) -> str:
            return "PasswordListProperty(%s)" % ", ".join(
                k + "=" + repr(v) for k, v in self._values.items()
            )

    @jsii.data_type(
        jsii_type="@aws-cdk/aws-elasticache.CfnUser.UserGroupIdListProperty",
        jsii_struct_bases=[],
        name_mapping={"user_group_id_list": "userGroupIdList"},
    )
    class UserGroupIdListProperty:
        def __init__(
            self,
            *,
            user_group_id_list: typing.Optional[typing.List[builtins.str]] = None,
        ) -> None:
            """
            :param user_group_id_list: ``CfnUser.UserGroupIdListProperty.UserGroupIdList``.
            ...
            if user_group_id_list is not None:
                self._values["user_group_id_list"] = user_group_id_list

        @builtins.property
        def user_group_id_list(self) -> typing.Optional[typing.List[builtins.str]]:
            """``CfnUser.UserGroupIdListProperty.UserGroupIdList``.
            ...
            """
            result = self._values.get("user_group_id_list")
            return result
        ...
        def __repr__(self) -> str:
            return "UserGroupIdListProperty(%s)" % ", ".join(
                k + "=" + repr(v) for k, v in self._values.items()
            )
...
class CfnUserGroup(
    ...
    def __init__(
        ...
        *,
        ...
        user_ids: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnUserGroup.UserIdListProperty"]] = None,
    ) -> None:
    ...
    def user_ids(
        self,
    ) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnUserGroup.UserIdListProperty"]]:
    ...
    def user_ids(
        self,
        value: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnUserGroup.UserIdListProperty"]],
    ) -> None:
        jsii.set(self, "userIds", value)

    @jsii.data_type(
        jsii_type="@aws-cdk/aws-elasticache.CfnUserGroup.ReplicationGroupIdListProperty",
        jsii_struct_bases=[],
        name_mapping={"replication_group_id_list": "replicationGroupIdList"},
    )
    class ReplicationGroupIdListProperty:
        def __init__(
            self,
            *,
            replication_group_id_list: typing.Optional[typing.List[builtins.str]] = None,
        ) -> None:
            """
            :param replication_group_id_list: ``CfnUserGroup.ReplicationGroupIdListProperty.ReplicationGroupIdList``.
            ...
            if replication_group_id_list is not None:
                self._values["replication_group_id_list"] = replication_group_id_list

        @builtins.property
        def replication_group_id_list(
            self,
        ) -> typing.Optional[typing.List[builtins.str]]:
            """``CfnUserGroup.ReplicationGroupIdListProperty.ReplicationGroupIdList``.
            ...
            """
            result = self._values.get("replication_group_id_list")
            return result
        ...
        def __repr__(self) -> str:
            return "ReplicationGroupIdListProperty(%s)" % ", ".join(
                k + "=" + repr(v) for k, v in self._values.items()
            )

    @jsii.data_type(
        jsii_type="@aws-cdk/aws-elasticache.CfnUserGroup.UserGroupPendingChangesProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    @jsii.data_type(
        jsii_type="@aws-cdk/aws-elasticache.CfnUserGroup.UserIdListProperty",
        jsii_struct_bases=[],
        name_mapping={"user_id_list": "userIdList"},
    )
    class UserIdListProperty:
        def __init__(
            self,
            *,
            user_id_list: typing.Optional[typing.List[builtins.str]] = None,
        ) -> None:
            """
            :param user_id_list: ``CfnUserGroup.UserIdListProperty.UserIdList``.
            ...
            if user_id_list is not None:
                self._values["user_id_list"] = user_id_list

        @builtins.property
        def user_id_list(self) -> typing.Optional[typing.List[builtins.str]]:
            """``CfnUserGroup.UserIdListProperty.UserIdList``.
            ...
            """
            result = self._values.get("user_id_list")
            return result
        ...
        def __repr__(self) -> str:
            return "UserIdListProperty(%s)" % ", ".join(
                k + "=" + repr(v) for k, v in self._values.items()
            )
