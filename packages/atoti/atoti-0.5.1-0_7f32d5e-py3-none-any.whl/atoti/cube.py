...
from ._repr_utils import ReprJson, convert_repr_json_to_html, repr_json_cube
...
class CubeContext(MutableMapping[str, str]):
    ...
    def __setitem__(self, key: str, value: Any):
        self._java_api.set_shared_context_value(self._cube._name, key, str(value))
        self._java_api.refresh_pivot()
    ...
    def __str__(self) -> str:
        return "\n".join(
            [f"{key}: {value}" for key, value in self._get_values().items()]
        )
