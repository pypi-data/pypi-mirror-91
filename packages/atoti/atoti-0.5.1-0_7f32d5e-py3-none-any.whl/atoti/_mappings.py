...
class ImmutableMapping(Generic[_Key, _Value], Mapping[_Key, _Value]):  # type: ignore
    """Immutable mapping."""
...
@dataclass(frozen=True)
class DelegateMutableMapping(Generic[_Key, _Value], MutableMapping[_Key, _Value]):  # type: ignore
