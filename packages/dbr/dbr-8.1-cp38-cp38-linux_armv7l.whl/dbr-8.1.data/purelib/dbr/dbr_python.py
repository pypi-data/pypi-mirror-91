...
class LocalizationResult:
    ...
    def _convert_to_innner(self):
        ...
        localization_result["BarcodeFormatString"] = self.barcode_format_string
        localization_result["BarcodeFormat_2"] = self.barcode_format_2
        localization_result["BarcodeFormatString_2"] = self.barcode_format_string_2
        ...
        localization_result["RegionName"] = self.region_name
        localization_result["DocumentName"] = self.document_name
        localization_result["ResultCoordinateType"] = self.result_coordinate_type
        # localization_result["AccompanyingTextBytes"] = self.accompanying_text_bytes
