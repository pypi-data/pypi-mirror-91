...
class BarcodeSvmDetectorSettings (Assist.BaseJavaClass):
    ...
    def getScanWindowSizes(self):
        return self.getJavaClass().getScanWindowSizes()
...
class CustomerInformationInterpretingType(Enum):
        ...
        # generator = BarcodeGenerator(EncodeTypes.AustraliaPost, "5912345678ABCde")
        ...
        #  generator = BarcodeGenerator(EncodeTypes.AustraliaPost, "59123456781234567")
