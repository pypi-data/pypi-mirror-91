...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'docker', '2.7.0-alpha.1610565467+18dd1120'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource docker 2.7.0-alpha.1610565467+18dd1120`
                """)
            else:
                raise
