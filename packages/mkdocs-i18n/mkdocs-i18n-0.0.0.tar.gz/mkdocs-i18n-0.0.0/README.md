...
It also hides links of navigation menus of pages writed in other languages, if there is a page writed in the language of current page.
...
Configure the plugin via [mkdocs.yml](https://gitlab.com/mkdocs-i18n/mkdocs-i18n/-/blob/master/mkdocs.yml)
