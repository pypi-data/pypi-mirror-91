...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'aiven', '3.4.0-alpha.1610470784+1b044c9f'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource aiven 3.4.0-alpha.1610470784+1b044c9f`
                """)
            else:
                raise
