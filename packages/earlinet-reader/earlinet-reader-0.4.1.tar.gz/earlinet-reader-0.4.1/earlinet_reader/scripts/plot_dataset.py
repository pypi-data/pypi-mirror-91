...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Command line tool to plot datasets of lidar optical property files.")
    ...
    parser.add_argument('-m', '--mean', help="Calculate the mean of optical properties")
