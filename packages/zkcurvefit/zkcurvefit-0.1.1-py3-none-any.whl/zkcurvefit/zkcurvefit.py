def curvefit(ftoread,ftowrite,ts=1000,density_coeff=5,plot="off",sigma=1,extend=10):
    """
    takes 5 parameters file to read, file to write to, max timestep,density 
...
if __name__ == '__main__':
    curvefit("12kT-USI.csv",".csv",plot="off")
