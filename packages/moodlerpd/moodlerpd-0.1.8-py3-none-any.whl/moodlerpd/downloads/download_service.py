...
class DownloadService:
    ...
    def __init__(
            self, courses: [Course], config_service: ConfigService,
            client_service: ClientService, storage_path: str, skip_cert_verify: bool = False
    ):
        """
        ...
        self.token = config_service.get_token()
        ...
        self.options = config_service.get_download_options()
    ...
    def gen_path(storage_path: str, course: Course, file: File):
        ...
        if not course.create_directory_structure:
            return PathTools.flat_path_of_file(category_path, course_name, file.content_filepath)
