...
class File:
    ...
    INSERT = """INSERT INTO files
            (course_id, course_fullname, course_category_id, module_id, section_name,
            ...
            hash, old_file_id)
            VALUES (:course_id, :course_fullname, :course_category_id, :module_id,
