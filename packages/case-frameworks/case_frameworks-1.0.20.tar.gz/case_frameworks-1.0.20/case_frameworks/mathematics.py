...
class mathematics:
    ...
    def long_multiplication(self, questions, answers, num_array):
        ...
        Args:
            ...
            num_array: Array of numbers for decimals places to be rounded in questions.
        ...
        for key in questions[key]:
            ...
            num_1 = round(rd.random() * 1000), round(rd.random() * 3)
            num_2 = round(rd.random() * 1000), round(rd.random() * 3)
