...
class _IterationRecords(object):
    ...
    >>> doctest_print(iteration_records.get_start_values())
              y_0     y_1    y_2     y_3  y_4
    0.9200 8.1000  9.6500 9.3901 11.2904  NaN
    0.9600 8.2761  9.8250 9.5951 11.5000  NaN
    0.9990 8.4478  9.9956 9.7951     NaN  NaN
    1.0000 8.4522 10.0000 9.7990     NaN  NaN
    1.0240 8.5578     NaN 9.8940     NaN  NaN
    >>> doctest_print(iteration_records.get_extrapolation_result())
              y_0     y_1    y_2     y_3     y_4
    0.9200 8.1000  9.6500 9.3901 11.2904 11.5998
    0.9600 8.2761  9.8250 9.5951 11.5000 11.7917
    0.9990 8.4478  9.9956 9.7951 11.6502 11.9646
    1.0000 8.4522 10.0000 9.7990 11.6543 11.9688
    1.0240 8.5578 10.1465 9.8940 11.7695 12.0840
    ...
    def record_iterations(
        ...
        .. doctest::
            ...
            >>> doctest_print(recorded_iterations)
                                   y_0    y_1    y_2     y_3     y_4
            sections
            start        0.9200 8.1000 9.6500 9.3901 11.2904     NaN
            extrapolated 0.9200    NaN    NaN    NaN     NaN 11.5998
            iteration    1.1000 8.1000 9.6500 9.3901 11.2904 11.5000
                         1.2000 8.1000 9.6500 9.3901 11.2904 11.5805
                         1.3000 8.1000 9.6500 9.3901 11.2904 11.5966
                         1.4000 8.1000 9.6500 9.3901 11.2904 11.5998
                                   y_0    y_1    y_2     y_3     y_4
            sections
            start        0.9600 8.2761 9.8250 9.5951 11.5000     NaN
            extrapolated 0.9600    NaN    NaN    NaN     NaN 11.7917
            iteration    2.1000 8.2761 9.8250 9.5951 11.5000 11.5998
                         2.2000 8.2761 9.8250 9.5951 11.5000 11.7536
                         2.3000 8.2761 9.8250 9.5951 11.5000 11.7844
                         2.4000 8.2761 9.8250 9.5951 11.5000 11.7905
                         2.5000 8.2761 9.8250 9.5951 11.5000 11.7917
                                   y_0    y_1    y_2     y_3     y_4
            sections
            start        0.9990 8.4478 9.9956 9.7951     NaN     NaN
            extrapolated 0.9990    NaN    NaN    NaN 11.6502 11.9646
            iteration    3.1000 8.4478 9.9956 9.7951 11.4773 11.7917
                         3.2000 8.4478 9.9956 9.7951 11.5814 11.8959
                         3.3000 8.4478 9.9956 9.7951 11.6231 11.9376
                         3.4000 8.4478 9.9956 9.7951 11.6398 11.9542
                         3.5000 8.4478 9.9956 9.7951 11.6464 11.9609
                         3.6000 8.4478 9.9956 9.7951 11.6491 11.9636
                         3.7000 8.4478 9.9956 9.7951 11.6502 11.9646
                                   y_0     y_1    y_2     y_3     y_4
            sections
            start        1.0000 8.4522 10.0000 9.7990     NaN     NaN
            extrapolated 1.0000    NaN     NaN    NaN 11.6543 11.9688
            iteration    4.1000 8.4522 10.0000 9.7990 11.6502 11.9646
                         4.2000 8.4522 10.0000 9.7990 11.6531 11.9676
                         4.3000 8.4522 10.0000 9.7990 11.6543 11.9688
                                   y_0     y_1    y_2     y_3     y_4
            sections
            start        1.0240 8.5578     NaN 9.8940     NaN     NaN
            extrapolated 1.0240    NaN 10.1465    NaN 11.7695 12.0840
            iteration    5.1000 8.5578 10.0313 9.8940 11.6543 11.9688
                         5.2000 8.5578 10.0781 9.8940 11.7012 12.0156
                         5.3000 8.5578 10.1063 9.8940 11.7293 12.0438
                         5.4000 8.5578 10.1231 9.8940 11.7462 12.0606
                         5.5000 8.5578 10.1332 9.8940 11.7563 12.0707
                         5.6000 8.5578 10.1393 9.8940 11.7624 12.0768
                         5.7000 8.5578 10.1430 9.8940 11.7660 12.0805
                         5.8000 8.5578 10.1452 9.8940 11.7682 12.0827
                         5.9000 8.5578 10.1465 9.8940 11.7695 12.0840
            >>> pandas.options.display.float_format = None
