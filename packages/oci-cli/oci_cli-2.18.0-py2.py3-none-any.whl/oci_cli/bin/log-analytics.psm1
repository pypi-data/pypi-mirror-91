...
function GetOciSubcommands_log_analytics() {
    $ociSubcommands = @{
        'log-analytics' = 'assoc char-encoding-collection config-work-request content-export content-import entity entity-type field label log-group lookup namespace object-collection-rule parser query query-work-request scheduled-task source storage timezone-collection upload work-request work-request-error work-request-log'
        ...
        'log-analytics storage' = 'disable-archiving enable-archiving estimate-purge-data-size get get-storage-usage get-storage-work-request list-storage-work-request-errors list-storage-work-requests purge-storage-data recall-archived-data release-recalled-data update'
