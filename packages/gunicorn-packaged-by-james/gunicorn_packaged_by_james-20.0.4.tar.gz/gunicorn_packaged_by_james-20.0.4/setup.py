...
setup(
    name='gunicorn_packaged_by_james',
    version=__version__,

    description='WSGI HTTP Server for UNIX',
    long_description=long_description,
    author='yehjames',
    author_email='yehjames23@gmail.com',
    license='MIT',
    url='https://gunicorn.org',
    project_urls={
        'Documentation': 'https://docs.gunicorn.org',
        'Homepage': 'https://gunicorn.org',
        'Issue tracker': 'https://github.com/jamesyeh/gunicorn/issues',
        'Source code': 'https://github.com/jamesyeh/gunicorn',
    },
