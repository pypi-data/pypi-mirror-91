...
class Register:
    ...
    def value(self, value):
        if value is None:
            ...
            raise err.RegisterValueError("value has invalid type {} expected int".format(type(value)))
    ...
    def fvalue(self, fvalue):
        if fvalue is None:
            ...
            raise err.RegisterValueError("value has invalid type {} expected float".format(type(fvalue)))
...
class RegisterService:
    ...
    def __read_write_exp(self, data):
        ...
        if result.payload is None:
            raise err.RegisterError(result.err_code, result.err_msg)
        else:
