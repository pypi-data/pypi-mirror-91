...
id = "b02f7d754655116513ef21bc85a71d9d07b49511"
date = "2021-01-12 14:47:27 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "b02f7d754655116513ef21bc85a71d9d07b49511":
        return
    msg = "Program id (b02f7d754655116513ef21bc85a71d9d07b49511) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
