...
id = "d609446f102050369de9c65561ea33c03480af27"
date = "2021-01-9 09:56:34 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "d609446f102050369de9c65561ea33c03480af27":
        return
    msg = "Program id (d609446f102050369de9c65561ea33c03480af27) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
