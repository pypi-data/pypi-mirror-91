...
id = "016352a436e67279354979af745c36917e9ba1fa"
date = "2021-01-11 17:29:44 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "016352a436e67279354979af745c36917e9ba1fa":
        return
    msg = "Program id (016352a436e67279354979af745c36917e9ba1fa) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
