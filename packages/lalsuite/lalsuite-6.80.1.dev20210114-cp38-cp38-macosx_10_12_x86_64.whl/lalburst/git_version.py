...
id = "508cce2ed07012d4c46865e0167dade8cbf57bea"
date = "2021-01-13 17:10:39 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "508cce2ed07012d4c46865e0167dade8cbf57bea":
        return
    msg = "Program id (508cce2ed07012d4c46865e0167dade8cbf57bea) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
