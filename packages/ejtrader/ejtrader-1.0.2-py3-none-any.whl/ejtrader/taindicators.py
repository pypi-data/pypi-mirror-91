...
class indicators:
    ...
    def BBANDS(
        ...
        """
         ...
         Pass desired moving average as <MA> argument. For example BBANDS(MA=indicator.KAMA(20)).
         """
    ...
    def MOBO(
        ...
        BB = indicator.BBANDS(ohlc, period=10, std_multiplier=0.8, column=column)
        return BB
    ...
    def BBWIDTH(
        ...
        BB = indicator.BBANDS(ohlc, period, MA, column)
...
if __name__ == "__main__":
    print([k for k in indicator.__dict__.keys() if k[0] not in "_"])
