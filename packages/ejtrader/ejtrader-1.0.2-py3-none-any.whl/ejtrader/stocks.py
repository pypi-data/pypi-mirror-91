...
def get_stock_company_profile(stock, country='brazil', language='br'):
    """
    ...
    elif selected_source == 'Investingbr':
        tag = stocks.loc[(stocks['symbol'].str.lower() == stock).idxmax(), 'tag']
        

        url = "https://br.investing.com/equities/" + tag + "-company-profile"
...
def get_stock_dividends(stock, country,language='br'):
    """
    ...
    if selected_source == 'Investingbr':
        url = 'https://br.investing.com/equities/' + str(tag_) + '-dividends'
