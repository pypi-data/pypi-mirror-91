...
def technical_indicators(name, country, product_type, interval='daily'):
    ...
    Examples:
        >>> data = ejtrader.technical_indicators(name='bbva', country='spain', product_type='stock', interval='daily')
        >>> data.head()
            technical_indicator    value           signal
...
def moving_averages(name, country, product_type, interval='daily'):
    ...
    Examples:
        >>> data = ejtrader.moving_averages(name='bbva', country='spain', product_type='stock', interval='daily')
        >>> data.head()
          period  sma_value sma_signal  ema_value ema_signal
...
def pivot_points(name, country, product_type, interval='daily'):
    ...
    Examples:
        >>> data = ejtrader.pivot_points(name='bbva', country='spain', product_type='stock', interval='daily')
        >>> data.head()
                name     s3     s2     s1  pivot_points     r1     r2     r3
