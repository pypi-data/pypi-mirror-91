        ...
        try:
            ...
            if route.collection or route.database:
                with Database(database=route.database, collection=route.collection) as collection:
                    return Response(dumps(logic(request, payload, collection)), 200, mimetype='application/json')
            
            return Response(dumps(logic(request, payload)), 200, mimetype='application/json')
