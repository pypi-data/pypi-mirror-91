...
class LootBotApi:
    ...
    def __reset_inventory_name(self,inventory,original_names):
        for name in original_names:
            inventory[name] = inventory[name.lower()]
    ...
    def get_crafting_steps(self,item,num_elements=1,inventory=dict()):
        ...
        original_names = deepcopy(inventory)
        self.__lower_dict_keys(inventory)
        ...
        self.__reset_inventory_name(inventory,original_names)
