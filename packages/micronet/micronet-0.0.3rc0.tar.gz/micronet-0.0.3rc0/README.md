...
from micronet.compression.quantization.wbwtab.quantize import QuantConv2d as quant_wbwtab
from micronet.compression.quantization.wqaq.dorefa.quantize import QuantConv2d, QuantLinear as quant_dorefa_conv, quant_dorefa_linear
from micronet.compression.quantization.wqaq.iao.quantize import QuantConv2d, QuantLinear as quant_iao_conv, quant_iao_linear
...
class QuantLeNetWbWtAb(nn.Module):
    def __init__(self):
        ...
        self.conv1 = quant_wbwtab(1, 10, kernel_size=5)
        self.conv2 = quant_wbwtab(10, 20, kernel_size=5)
        self.fc1 = nn.Linear(320, 50)
        self.fc2 = nn.Linear(50, 10)
...
class c(nn.Module):
    def __init__(self):
        super(QuantLeNet, self).__init__()
        self.conv1 = quant_dorefa_conv(1, 10, kernel_size=5)
        self.conv2 = quant_dorefa_conv(10, 20, kernel_size=5)
        self.fc1 = quant_dorefa_linear(320, 50)
        self.fc2 = quant_dorefa_linear(50, 10)
...
class QuantLeNetIAO(nn.Module):
    def __init__(self):
        super(QuantLeNet, self).__init__()
        self.conv1 = quant_iao_conv(1, 10, kernel_size=5)
        self.conv2 = quant_iao_conv(10, 20, kernel_size=5)
        self.fc1 = quant_iao_linear(320, 50)
        self.fc2 = quant_iao_linear(50, 10)
...
quant_lenet_dorefa = QuantLeNetWbWtAb
