...
class IoCUploadResponse(object):
    ...
    def __init__(self, api_version=None, success=None, code=None, message=None, data=None):  # noqa: E501
        """IoCUploadResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def api_version(self):
        """Gets the api_version of this IoCUploadResponse.  # noqa: E501

        The current api version.  # noqa: E501

        :return: The api_version of this IoCUploadResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def api_version(self, api_version):
        """Sets the api_version of this IoCUploadResponse.

        The current api version.  # noqa: E501

        :param api_version: The api_version of this IoCUploadResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def success(self):
        """Gets the success of this IoCUploadResponse.  # noqa: E501

        MUST equal true.  # noqa: E501

        :return: The success of this IoCUploadResponse.  # noqa: E501
        :rtype: bool
        """
    ...
    def success(self, success):
        """Sets the success of this IoCUploadResponse.

        MUST equal true.  # noqa: E501

        :param success: The success of this IoCUploadResponse.  # noqa: E501
        :type: bool
        """
        if success is None:
    ...
    @property
    def code(self):
        """Gets the code of this IoCUploadResponse.  # noqa: E501


        :return: The code of this IoCUploadResponse.  # noqa: E501
        :rtype: int
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this IoCUploadResponse.


        :param code: The code of this IoCUploadResponse.  # noqa: E501
        :type: int
        """
        if code is None:
    ...
    @property
    def message(self):
        """Gets the message of this IoCUploadResponse.  # noqa: E501


        :return: The message of this IoCUploadResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def message(self, message):
        """Sets the message of this IoCUploadResponse.


        :param message: The message of this IoCUploadResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def data(self):
        """Gets the data of this IoCUploadResponse.  # noqa: E501

        The data returned by the operation.   # noqa: E501

        :return: The data of this IoCUploadResponse.  # noqa: E501
        :rtype: object
        """
        return self._data
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this IoCUploadResponse.

        The data returned by the operation.   # noqa: E501

        :param data: The data of this IoCUploadResponse.  # noqa: E501
        :type: object
        """
        if data is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IoCUploadResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IoCUploadResponse):
            return False
