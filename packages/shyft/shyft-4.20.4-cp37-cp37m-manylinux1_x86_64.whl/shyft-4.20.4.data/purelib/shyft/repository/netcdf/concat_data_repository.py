...
class ConcatDataRepository(interfaces.GeoTsRepository):
    ...
    def __init__(self, epsg: str, filename: str, nb_lead_intervals_to_drop: int = 0,
        ...
        self.shyft_var_units: Dict[str, List[str]] = {"relative_humidity": ['1'],
                                                      "temperature": ['C'],
                                                      "precipitation": ['mm/h'],
                                                      "x_wind_10m": ['m/s'],
                                                      "y_wind_10m": ['m/s'],
        ...
        with Dataset(self._filename) as dataset:
            ...
            self.available_variables = [self._shyft_map[var] for var in dataset.variables if
                                        var in self._shyft_map]
