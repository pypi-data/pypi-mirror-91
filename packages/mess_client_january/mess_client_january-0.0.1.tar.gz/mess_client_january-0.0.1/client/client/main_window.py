...
class ClientMainWindow(QMainWindow):
    ...
    def set_active_user(self):
        ...
        try:
            self.current_chat_key = self.transport.key_request(
                self.current_chat)
            CLIENT_LOGGER.debug(f'Загружен открытый ключ для '
                                f'{self.current_chat}')
            ...
            self.current_chat_key = None
            self.encryptor = None
            CLIENT_LOGGER.debug(f'Не удалось получить ключ для '
                                f'{self.current_chat}')
    ...
    def clients_list_update(self):
        ...
        contacts_list = self.database.contacts_get()
    ...
    def add_contact(self, new_contact):
        ...
        try:
            ...
            self.database.contact_add(new_contact)
    ...
    def delete_contact(self, item):
        ...
        try:
            ...
            self.database.contact_del(selected)
            self.clients_list_update()
    ...
    def send_message(self):
        ...
        try:
            ...
            self.database.message_save(self.current_chat, 'out', message_text)
            CLIENT_LOGGER.debug(
    ...
    def message(self, message):
        ...
        if sender == self.current_chat:
            ...
            if self.database.contact_check(sender):
    ...
    def sig_205(self):
        ...
        '''
        if self.current_chat and not self.database.user_check(
                self.current_chat):
            self.messages.warning(
                self,
                'Сочувствую',
