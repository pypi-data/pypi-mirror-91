...
class ReplicatedDatablock(object):
    ...
    __slots__ = [
        ...
        'data_cache']       # Data cache to avoid dump redundency (dict)
    ...
    def commit(self):
        ...
        if self.state in [MODIFIED, ADDED, UP]:
            if self.state == MODIFIED and self.data_cache:
    ...
    def diff(self):
        ...
        # Cache the new version if it changed
        if diff:
            self.data_cache = new_version
