...
class Session(object):
    ...
    def lock_operations(self):
        logging.debug("Locking database operations")
        self._lock_operations.set()

    def unlock_operations(self):
        logging.debug("Unlocking database operations")
        self._lock_operations.clear()

    def are_operations_locked(self):
        return self._lock_operations.is_set()
