...
class auth:
    ...
    def __init__(self, institution, projeto, token):

        for i in [institution, projeto, token]: 
    ...
    def publish(self):
        self.database.child(self.group).child(self.institution).child(self.projeto).child(self.token).push(self.data)

    def cancel_task(self,id):
        self.database.child(self.group).child(self.institution).child(self.projeto).child(self.token).child(id).update({"status":False})

    def update(self,id):
        self.database.child(self.group).child(self.institution).child(self.projeto).child(self.token).child(id).update(self.data)

    def remove(self,id):
        self.database.child(self.group).child(self.institution).child(self.projeto).child(self.token).child(id).remove()
