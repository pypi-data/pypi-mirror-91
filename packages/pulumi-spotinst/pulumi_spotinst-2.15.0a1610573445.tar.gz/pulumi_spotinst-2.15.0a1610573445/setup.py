...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'spotinst', '2.15.0-alpha.1610573445+8b644bd9'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource spotinst 2.15.0-alpha.1610573445+8b644bd9`
                """)
            else:
                raise
