...
from .fund_derived_factors import FundAlive, TradeYear, FeeRate, AlphaBetaDaily3yI, AlphaDaily3yI, BetaDaily3yI, TrackerrDaily3yI, InfoRatioDaily3yI, \
...
fund_derived_factor = [FundAlive, TradeYear, FeeRate, AlphaBetaDaily3yI, AlphaDaily3yI, BetaDaily3yI, TrackerrDaily3yI, InfoRatioDaily3yI,
                       MddDaily3y, TreynorDaily3yI, DownriskDaily3y, RetOverPeriodDaily3y, AnnualRetDaily3y, AnnualVolDaily3y,
                       SharpeDaily3y, AlphaBetaDaily1yI, AlphaDaily1yI, BetaDaily1yI, TrackerrDaily1yI, InfoRatioDaily1yI,
                       MddDaily1y, TreynorDaily1yI, DownriskDaily1y, RetOverPeriodDaily1y, AnnualRetDaily1y, AnnualVolDaily1y,
                       SharpeDaily1y, AnnualRetDailyHistory, AnnualVolDailyHistory, AnnualRetMonthlyHalfY, AnnualVolMonthlyHalfY,
...
fund_derived_score = [FundMngScoreV1,MngScoreV1,FundMngScoreV1, RetAbilityFundScore, RiskAbilityFundScore, StableAbility, SelectTimeAbility, SelectStockAbility ]
