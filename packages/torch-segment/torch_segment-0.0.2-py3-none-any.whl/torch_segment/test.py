...
from .config import set_classes_to_train
from .models.fcn_resnet50 import prepare_model
...
segmented_image = draw_test_segmentation_map(outputs, set_classes_to_train())
# image overlay
