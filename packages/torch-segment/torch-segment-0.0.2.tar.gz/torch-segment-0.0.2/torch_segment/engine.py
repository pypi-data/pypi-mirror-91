...
from .utils.helpers import save_model_dict, draw_seg_maps
from .utils.helpers import draw_translucent_seg_maps
...
class Trainer:
    def __init__(self, model, train_data_loader, train_dataset, 
                 ...
                 epochs, device, lr, val_seg_dir, checkpoints_dir,
                 resume_training=None, model_path=None):
            ...
            for i, data in enumerate(prog_bar):
                ...
                if i == num_batches - 1:
                    draw_translucent_seg_maps(
                        data, outputs, epoch, i, 
                        self.classes_to_train, self.val_seg_dir
                    )
    ...
    def save_model(self, epochs):
        save_model_dict(self.model, epochs, self.checkpoints_dir,
