...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, pulp_href=None, base_path=None, repository_version=None, pulp_created=None, content_guard=None, name=None, repository=None, registry_path=None, namespace=None, local_vars_configuration=None):  # noqa: E501
