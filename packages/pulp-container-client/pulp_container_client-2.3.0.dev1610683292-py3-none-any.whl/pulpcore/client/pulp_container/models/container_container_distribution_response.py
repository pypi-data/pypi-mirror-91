...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, repository=None, base_path=None, content_guard=None, name=None, pulp_href=None, repository_version=None, pulp_created=None, registry_path=None, namespace=None, local_vars_configuration=None):  # noqa: E501
