...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, pulp_href=None, repository=None, pulp_created=None, content_guard=None, repository_version=None, name=None, base_path=None, registry_path=None, namespace=None, local_vars_configuration=None):  # noqa: E501
