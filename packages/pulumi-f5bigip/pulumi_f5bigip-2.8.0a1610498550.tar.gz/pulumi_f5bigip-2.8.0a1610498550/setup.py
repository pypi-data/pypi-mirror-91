...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'f5bigip', '2.8.0-alpha.1610498550+d94dbe0c'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource f5bigip 2.8.0-alpha.1610498550+d94dbe0c`
                """)
            else:
                raise
