...
"""
    ...
    def _PrintAllCommands(self):
        put_string('usage: thead COMMAND [ARGS]')
        put_string('The complete list of recognized thead commands are:')
        ...
        put_string("See 'thead help <command>' for more information on a "
                   'specific command.')
    ...
    def Execute(self, opt, args):
        if len(args) == 0:
            ...
            try:
                ...
                put_string("thead: '%s' is not a thead command." %
