...
class app:
    ...
    def equal(self):
        if str(self.buffer) == "()":
            tkm.showinfo(title="Easteregg", message="Ops, ho trovato in questo buco un uovo di cioccolato!")
            tkm.askyesno("Easteregg", "Lo vuoi?")
            tkm.showinfo("Easteregg", "Lo mangio io a prescindere.")
            return
