...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'consul', '2.7.0-alpha.1610565457+2a94c465'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource consul 2.7.0-alpha.1610565457+2a94c465`
                """)
            else:
                raise
