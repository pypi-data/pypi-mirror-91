...
class BinaryTree:
    """Standard Binary Tree with adding, depth-first and breadth-first traversals
    """
    ...
    def pre_order(self, action=lambda x:None):
        """Pre Order traversal of tree. Applies optional action function to each node's value
    ...
    def in_order(self, action=lambda x:None):
        """In Order traversal of tree. Applies optional action function to each node's value
    ...
    def post_order(self, action=lambda x:None):
        """Post Order traversal of tree. Applies optional action function to each node's value
    ...
    def breadth_first(self, action=lambda x:None):
        """Breadth First / Level Order traversal of tree. Applies optional action function to each node's value
