...
from mastapy.gears.rating.cylindrical.iso6336 import _300, _310
...
class ISO63362006GearSingleFlankRating(_310.ISO6336AbstractMetalGearSingleFlankRating):
    '''ISO63362006GearSingleFlankRating
    ...
    @property
    def tooth_fatigue_fracture_results(self) -> '_300.CylindricalGearToothFatigueFractureResults':
        ...
        return constructor.new(_300.CylindricalGearToothFatigueFractureResults)(self.wrapped.ToothFatigueFractureResults) if self.wrapped.ToothFatigueFractureResults else None
