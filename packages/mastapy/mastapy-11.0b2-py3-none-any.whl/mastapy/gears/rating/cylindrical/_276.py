...
from mastapy.gears.rating.cylindrical import _277
...
class ScuffingResultsRow(_0.APIBase):
    ...
    @property
    def pinion(self) -> '_277.ScuffingResultsRowGear':
        ...
        return constructor.new(_277.ScuffingResultsRowGear)(self.wrapped.Pinion) if self.wrapped.Pinion else None
