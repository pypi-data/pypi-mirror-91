...
from mastapy.gears.rating import _159, _158
...
class CylindricalGearDutyCycleRating(_158.GearDutyCycleRating):
    '''CylindricalGearDutyCycleRating
    ...
    @property
    def gear_set_design_duty_cycle(self) -> '_261.CylindricalGearSetDutyCycleRating':
        ...
        return constructor.new(_261.CylindricalGearSetDutyCycleRating)(self.wrapped.GearSetDesignDutyCycle) if self.wrapped.GearSetDesignDutyCycle else None

    @property
    def cylindrical_gear_set_design_duty_cycle(self) -> '_261.CylindricalGearSetDutyCycleRating':
        ...
        return constructor.new(_261.CylindricalGearSetDutyCycleRating)(self.wrapped.CylindricalGearSetDesignDutyCycle) if self.wrapped.CylindricalGearSetDesignDutyCycle else None
    ...
    @property
    def cylindrical_gear_mesh_ratings(self) -> 'List[_271.MeshRatingForReports]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearMeshRatings, constructor.new(_271.MeshRatingForReports))
        return value
