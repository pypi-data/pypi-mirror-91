...
class MeshRatingForReports(_0.APIBase):
    ...
    @property
    def cylindrical_gear_mesh_rating(self) -> '_255.CylindricalGearMeshRating':
        ...
        return constructor.new(_255.CylindricalGearMeshRating)(self.wrapped.CylindricalGearMeshRating) if self.wrapped.CylindricalGearMeshRating else None
