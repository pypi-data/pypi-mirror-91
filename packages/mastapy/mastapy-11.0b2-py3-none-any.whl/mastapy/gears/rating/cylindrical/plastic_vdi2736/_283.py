...
from mastapy.materials import _88, _89
...
class PlasticGearVDI2736AbstractGearSingleFlankRating(_308.ISO6336AbstractGearSingleFlankRating):
    '''PlasticGearVDI2736AbstractGearSingleFlankRating
    ...
    @property
    def is_gear_driving_or_driven(self) -> '_157.FlankLoadingState':
        ...
        return constructor.new(_157.FlankLoadingState)(value) if value else None
    ...
    @property
    def standard_plastic_sn_curve_for_the_specified_operating_conditions(self) -> '_287.PlasticSNCurveForTheSpecifiedOperatingConditions':
        ...
        return constructor.new(_287.PlasticSNCurveForTheSpecifiedOperatingConditions)(self.wrapped.StandardPlasticSNCurveForTheSpecifiedOperatingConditions) if self.wrapped.StandardPlasticSNCurveForTheSpecifiedOperatingConditions else None
