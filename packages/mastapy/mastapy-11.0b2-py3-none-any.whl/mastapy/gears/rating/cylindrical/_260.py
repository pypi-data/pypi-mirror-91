...
class CylindricalGearScuffingResults(_0.APIBase):
    ...
    @property
    def scuffing_results_row(self) -> 'List[_276.ScuffingResultsRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ScuffingResultsRow, constructor.new(_276.ScuffingResultsRow))
        return value
