...
class CylindricalMeshDutyCycleRating(_165.MeshDutyCycleRating):
    '''CylindricalMeshDutyCycleRating
    ...
    @property
    def highest_torque_load_case(self) -> '_255.CylindricalGearMeshRating':
        ...
        return constructor.new(_255.CylindricalGearMeshRating)(self.wrapped.HighestTorqueLoadCase) if self.wrapped.HighestTorqueLoadCase else None
