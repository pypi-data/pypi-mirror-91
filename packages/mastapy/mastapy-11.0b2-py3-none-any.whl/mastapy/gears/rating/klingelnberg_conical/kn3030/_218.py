...
from mastapy.gears.rating.klingelnberg_conical.kn3030 import _217, _214
...
class KlingelnbergCycloPalloidHypoidMeshSingleFlankRating(_214.KlingelnbergConicalMeshSingleFlankRating):
    '''KlingelnbergCycloPalloidHypoidMeshSingleFlankRating
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_217.KlingelnbergCycloPalloidHypoidGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSingleFlankRatings, constructor.new(_217.KlingelnbergCycloPalloidHypoidGearSingleFlankRating))
        return value

    @property
    def kn3030_klingelnberg_gear_single_flank_ratings(self) -> 'List[_217.KlingelnbergCycloPalloidHypoidGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KN3030KlingelnbergGearSingleFlankRatings, constructor.new(_217.KlingelnbergCycloPalloidHypoidGearSingleFlankRating))
        return value
