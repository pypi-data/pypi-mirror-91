...
class CylindricalGearTIFFAnalysis(_952.GearDesignAnalysis):
    ...
    @property
    def analysis(self) -> '_669.CylindricalGearTwoDimensionalFEAnalysis':
        ...
        return constructor.new(_669.CylindricalGearTwoDimensionalFEAnalysis)(self.wrapped.Analysis) if self.wrapped.Analysis else None
