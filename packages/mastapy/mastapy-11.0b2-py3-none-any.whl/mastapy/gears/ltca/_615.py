...
class GearMeshLoadDistributionAnalysis(_957.GearMeshImplementationAnalysis):
    ...
    @property
    def transmission_error_fourier_series(self) -> '_1086.FourierSeries':
        ...
        return constructor.new(_1086.FourierSeries)(self.wrapped.TransmissionErrorFourierSeries) if self.wrapped.TransmissionErrorFourierSeries else None
    ...
    def maximum_root_stress_with_flanks(self, gear: '_614.GearLoadDistributionAnalysis', flank: '_126.GearFlanks', stress_type: '_1408.StressResultsType') -> 'float':
    ...
    def maximum_root_stress(self, gear: '_614.GearLoadDistributionAnalysis', stress_type: '_1408.StressResultsType') -> 'float':
        ''' 'MaximumRootStress' is the original name of this method.
