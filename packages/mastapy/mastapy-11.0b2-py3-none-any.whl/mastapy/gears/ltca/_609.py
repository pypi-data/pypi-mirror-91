...
class CylindricalMeshedGearLoadDistributionAnalysis(_0.APIBase):
    ...
    def contact_patch_detailed(self, result_type: '_608.ContactResultType', number_of_face_width_steps: 'int', number_of_roll_distance_steps: 'int') -> '_1088.GriddedSurface':
    ...
    def contact_patch(self, result_type: '_608.ContactResultType', include_tip_contact: 'bool') -> '_1088.GriddedSurface':
        ''' 'ContactPatch' is the original name of this method.
