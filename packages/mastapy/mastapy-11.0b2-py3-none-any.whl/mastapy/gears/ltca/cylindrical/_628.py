...
class CylindricalGearLoadDistributionAnalysis(_614.GearLoadDistributionAnalysis):
    ...
    @property
    def tiff_analysis(self) -> '_668.CylindricalGearTIFFAnalysis':
        ...
        return constructor.new(_668.CylindricalGearTIFFAnalysis)(self.wrapped.TIFFAnalysis) if self.wrapped.TIFFAnalysis else None
