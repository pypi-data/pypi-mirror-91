...
class ConicalMeshLoadDistributionAnalysis(_615.GearMeshLoadDistributionAnalysis):
    '''ConicalMeshLoadDistributionAnalysis
    ...
    @property
    def conical_mesh_manufacturing_analysis(self) -> '_567.ConicalMeshManufacturingAnalysis':
        ...
        return constructor.new(_567.ConicalMeshManufacturingAnalysis)(self.wrapped.ConicalMeshManufacturingAnalysis) if self.wrapped.ConicalMeshManufacturingAnalysis else None

    @property
    def meshed_gears(self) -> 'List[_641.ConicalMeshedGearLoadDistributionAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshedGears, constructor.new(_641.ConicalMeshedGearLoadDistributionAnalysis))
        return value
