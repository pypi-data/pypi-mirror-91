...
from mastapy.math_utility.optimisation import _1121, _1112, _1118
...
class DesignSpaceSearchBase(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    @property
    def selected_design_space_search_strategy(self) -> '_1121.ParetoOptimisationStrategy':
        ...
        return constructor.new(_1121.ParetoOptimisationStrategy)(self.wrapped.SelectedDesignSpaceSearchStrategy) if self.wrapped.SelectedDesignSpaceSearchStrategy else None
    ...
    @property
    def input_setters(self) -> 'List[_1112.InputSetter[TAnalysis]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InputSetters, constructor.new(_1112.InputSetter)[TAnalysis])
        return value
    ...
    @property
    def filters(self) -> 'List[_1118.ParetoOptimisationFilter]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Filters, constructor.new(_1118.ParetoOptimisationFilter))
        return value
