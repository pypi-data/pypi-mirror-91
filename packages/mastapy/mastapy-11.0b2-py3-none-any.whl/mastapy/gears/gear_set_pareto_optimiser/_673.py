...
class ChartInfoBase(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    @property
    def select_chart_type(self) -> '_1123.ParetoOptimisationStrategyChartInformation.ScatterOrBarChart':
        ...
        return constructor.new(_1123.ParetoOptimisationStrategyChartInformation.ScatterOrBarChart)(value) if value else None

    @select_chart_type.setter
    def select_chart_type(self, value: '_1123.ParetoOptimisationStrategyChartInformation.ScatterOrBarChart'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.SelectChartType = value

    @property
    def chart_type(self) -> '_1286.CustomChartType':
        ...
        return constructor.new(_1286.CustomChartType)(value) if value else None
    ...
    @property
    def result_chart_scatter(self) -> '_6555.SMTBitmap':
        ...
        return constructor.new(_6555.SMTBitmap)(self.wrapped.ResultChartScatter) if self.wrapped.ResultChartScatter else None

    @property
    def result_chart_bar_and_line(self) -> '_6555.SMTBitmap':
        ...
        return constructor.new(_6555.SMTBitmap)(self.wrapped.ResultChartBarAndLine) if self.wrapped.ResultChartBarAndLine else None
