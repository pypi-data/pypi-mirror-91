...
class CylindricalGearFormedWheelGrinderTangible(_524.CutterShapeDefinition):
    '''CylindricalGearFormedWheelGrinderTangible
    ...
    @property
    def design(self) -> '_508.CylindricalGearFormGrindingWheel':
        ...
        return constructor.new(_508.CylindricalGearFormGrindingWheel)(self.wrapped.Design) if self.wrapped.Design else None
