...
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _529, _531, _526
...
class CylindricalGearGrindingWorm(_513.CylindricalGearRackDesign):
    '''CylindricalGearGrindingWorm
    ...
    @property
    def nominal_worm_grinder_shape(self) -> '_529.CylindricalGearWormGrinderShape':
        ...
        return constructor.new(_529.CylindricalGearWormGrinderShape)(self.wrapped.NominalWormGrinderShape) if self.wrapped.NominalWormGrinderShape else None
