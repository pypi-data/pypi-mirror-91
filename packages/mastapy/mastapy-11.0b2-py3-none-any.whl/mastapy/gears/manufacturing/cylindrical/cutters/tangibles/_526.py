...
class CylindricalGearHobShape(_531.RackShape):
    '''CylindricalGearHobShape
    ...
    @property
    def design(self) -> '_510.CylindricalGearHobDesign':
        ...
        return constructor.new(_510.CylindricalGearHobDesign)(self.wrapped.Design) if self.wrapped.Design else None
