...
class CutterShapeDefinition(_0.APIBase):
    ...
    @property
    def design(self) -> '_514.CylindricalGearRealCutterDesign':
        ...
        if _514.CylindricalGearRealCutterDesign.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def design_of_type_cylindrical_gear_form_grinding_wheel(self) -> '_508.CylindricalGearFormGrindingWheel':
        ...
        if _508.CylindricalGearFormGrindingWheel.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def design_of_type_cylindrical_gear_plunge_shaver(self) -> '_511.CylindricalGearPlungeShaver':
        ...
        if _511.CylindricalGearPlungeShaver.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def design_of_type_cylindrical_gear_rack_design(self) -> '_513.CylindricalGearRackDesign':
    ...
    @property
    def design_of_type_cylindrical_gear_shaper(self) -> '_515.CylindricalGearShaper':
        ...
        if _515.CylindricalGearShaper.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def design_of_type_cylindrical_gear_shaver(self) -> '_516.CylindricalGearShaver':
    ...
    @property
    def design_of_type_involute_cutter_design(self) -> '_519.InvoluteCutterDesign':
        ...
        if _519.InvoluteCutterDesign.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def fillet_points(self) -> 'List[_530.NamedPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FilletPoints, constructor.new(_530.NamedPoint))
        return value

    @property
    def main_blade_points(self) -> 'List[_530.NamedPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MainBladePoints, constructor.new(_530.NamedPoint))
        return value
