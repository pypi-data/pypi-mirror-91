...
class CustomisableEdgeProfile(_0.APIBase):
    ...
    @property
    def customised_cutting_edge_profile(self) -> 'List[_520.MutatableCommon]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CustomisedCuttingEdgeProfile, constructor.new(_520.MutatableCommon))
        return value
