...
class CylindricalGearShaperTangible(_524.CutterShapeDefinition):
    '''CylindricalGearShaperTangible
    ...
    @property
    def design(self) -> '_515.CylindricalGearShaper':
        ...
        return constructor.new(_515.CylindricalGearShaper)(self.wrapped.Design) if self.wrapped.Design else None
