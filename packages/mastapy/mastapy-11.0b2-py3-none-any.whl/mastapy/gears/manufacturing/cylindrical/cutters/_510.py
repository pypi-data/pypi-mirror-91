...
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _526, _531, _529
...
class CylindricalGearHobDesign(_513.CylindricalGearRackDesign):
    '''CylindricalGearHobDesign
    ...
    @property
    def nominal_hob_shape(self) -> '_526.CylindricalGearHobShape':
        ...
        return constructor.new(_526.CylindricalGearHobShape)(self.wrapped.NominalHobShape) if self.wrapped.NominalHobShape else None

    @property
    def nominal_rack_shape(self) -> '_531.RackShape':
        ...
        if _531.RackShape.TYPE not in self.wrapped.NominalRackShape.__class__.__mro__:
    ...
    @property
    def nominal_rack_shape_of_type_cylindrical_gear_hob_shape(self) -> '_526.CylindricalGearHobShape':
        ...
        if _526.CylindricalGearHobShape.TYPE not in self.wrapped.NominalRackShape.__class__.__mro__:
    ...
    @property
    def nominal_rack_shape_of_type_cylindrical_gear_worm_grinder_shape(self) -> '_529.CylindricalGearWormGrinderShape':
        ...
        if _529.CylindricalGearWormGrinderShape.TYPE not in self.wrapped.NominalRackShape.__class__.__mro__:
    ...
    @property
    def maximum_hob_material_shape(self) -> '_526.CylindricalGearHobShape':
        ...
        return constructor.new(_526.CylindricalGearHobShape)(self.wrapped.MaximumHobMaterialShape) if self.wrapped.MaximumHobMaterialShape else None

    @property
    def minimum_hob_material_shape(self) -> '_526.CylindricalGearHobShape':
        ...
        return constructor.new(_526.CylindricalGearHobShape)(self.wrapped.MinimumHobMaterialShape) if self.wrapped.MinimumHobMaterialShape else None
