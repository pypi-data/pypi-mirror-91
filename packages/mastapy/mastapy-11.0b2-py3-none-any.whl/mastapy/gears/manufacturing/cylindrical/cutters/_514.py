...
class CylindricalGearRealCutterDesign(_507.CylindricalGearAbstractCutterDesign):
    ...
    @property
    def nominal_cutter_drawing(self) -> '_6555.SMTBitmap':
        ...
        return constructor.new(_6555.SMTBitmap)(self.wrapped.NominalCutterDrawing) if self.wrapped.NominalCutterDrawing else None
