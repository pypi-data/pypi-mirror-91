...
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _502
...
class CylindricalManufacturedVirtualGearInMesh(_0.APIBase):
    ...
    @property
    def virtual_gear(self) -> '_502.VirtualSimulationCalculator':
        ...
        return constructor.new(_502.VirtualSimulationCalculator)(self.wrapped.VirtualGear) if self.wrapped.VirtualGear else None
