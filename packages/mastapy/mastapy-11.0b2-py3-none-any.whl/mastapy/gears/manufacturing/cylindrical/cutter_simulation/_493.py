...
class FormWheelGrindingSimulationCalculator(_486.CutterSimulationCalc):
    ...
    @property
    def profiled_grinding_wheel(self) -> '_525.CylindricalGearFormedWheelGrinderTangible':
        ...
        return constructor.new(_525.CylindricalGearFormedWheelGrinderTangible)(self.wrapped.ProfiledGrindingWheel) if self.wrapped.ProfiledGrindingWheel else None
