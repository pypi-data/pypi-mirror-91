...
class CutterSimulationCalc(_0.APIBase):
    ...
    @property
    def gear_fillet_points(self) -> 'List[_530.NamedPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearFilletPoints, constructor.new(_530.NamedPoint))
        return value
