...
class ShaperSimulationCalculator(_486.CutterSimulationCalc):
    ...
    @property
    def shaper(self) -> '_527.CylindricalGearShaperTangible':
        ...
        return constructor.new(_527.CylindricalGearShaperTangible)(self.wrapped.Shaper) if self.wrapped.Shaper else None
