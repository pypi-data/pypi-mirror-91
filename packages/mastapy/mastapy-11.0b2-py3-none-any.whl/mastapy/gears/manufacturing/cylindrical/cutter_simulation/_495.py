...
class HobSimulationCalculator(_498.RackSimulationCalculator):
    '''HobSimulationCalculator
    ...
    @property
    def hob(self) -> '_526.CylindricalGearHobShape':
        ...
        return constructor.new(_526.CylindricalGearHobShape)(self.wrapped.Hob) if self.wrapped.Hob else None
