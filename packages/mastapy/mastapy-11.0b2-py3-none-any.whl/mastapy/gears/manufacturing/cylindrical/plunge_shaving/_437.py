...
class RealPlungeShaverOutputs(_434.PlungeShaverOutputs):
    ...
    @property
    def shaver(self) -> '_511.CylindricalGearPlungeShaver':
        ...
        return constructor.new(_511.CylindricalGearPlungeShaver)(self.wrapped.Shaver) if self.wrapped.Shaver else None
