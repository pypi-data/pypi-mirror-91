...
from mastapy.gears.manufacturing.bevel.cutters import _596, _597
...
class ConicalPinionManufacturingConfig(_559.ConicalGearManufacturingConfig):
    '''ConicalPinionManufacturingConfig
    ...
    @property
    def mesh_config(self) -> '_568.ConicalMeshManufacturingConfig':
        ...
        return constructor.new(_568.ConicalMeshManufacturingConfig)(self.wrapped.MeshConfig) if self.wrapped.MeshConfig else None

    @property
    def pinion_concave_ob_configuration(self) -> '_564.ConicalMeshFlankManufacturingConfig':
        ...
        return constructor.new(_564.ConicalMeshFlankManufacturingConfig)(self.wrapped.PinionConcaveOBConfiguration) if self.wrapped.PinionConcaveOBConfiguration else None

    @property
    def pinion_convex_ib_configuration(self) -> '_564.ConicalMeshFlankManufacturingConfig':
        ...
        return constructor.new(_564.ConicalMeshFlankManufacturingConfig)(self.wrapped.PinionConvexIBConfiguration) if self.wrapped.PinionConvexIBConfiguration else None

    @property
    def pinion_finish_cutter(self) -> '_596.PinionFinishCutter':
        ...
        return constructor.new(_596.PinionFinishCutter)(self.wrapped.PinionFinishCutter) if self.wrapped.PinionFinishCutter else None

    @property
    def pinion_rough_cutter(self) -> '_597.PinionRoughCutter':
        ...
        return constructor.new(_597.PinionRoughCutter)(self.wrapped.PinionRoughCutter) if self.wrapped.PinionRoughCutter else None

    @property
    def pinion_cutter_parameters_concave(self) -> '_589.PinionFinishMachineSettings':
        ...
        if _589.PinionFinishMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConcave.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_concave_of_type_pinion_bevel_generating_modified_roll_machine_settings(self) -> '_584.PinionBevelGeneratingModifiedRollMachineSettings':
        ...
        if _584.PinionBevelGeneratingModifiedRollMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConcave.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_concave_of_type_pinion_bevel_generating_tilt_machine_settings(self) -> '_585.PinionBevelGeneratingTiltMachineSettings':
        ...
        if _585.PinionBevelGeneratingTiltMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConcave.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_concave_of_type_pinion_conical_machine_settings_specified(self) -> '_587.PinionConicalMachineSettingsSpecified':
        ...
        if _587.PinionConicalMachineSettingsSpecified.TYPE not in self.wrapped.PinionCutterParametersConcave.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_concave_of_type_pinion_hypoid_formate_tilt_machine_settings(self) -> '_590.PinionHypoidFormateTiltMachineSettings':
        ...
        if _590.PinionHypoidFormateTiltMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConcave.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_concave_of_type_pinion_hypoid_generating_tilt_machine_settings(self) -> '_591.PinionHypoidGeneratingTiltMachineSettings':
        ...
        if _591.PinionHypoidGeneratingTiltMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConcave.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_concave_of_type_pinion_machine_settings_smt(self) -> '_592.PinionMachineSettingsSMT':
        ...
        if _592.PinionMachineSettingsSMT.TYPE not in self.wrapped.PinionCutterParametersConcave.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_convex(self) -> '_589.PinionFinishMachineSettings':
        ...
        if _589.PinionFinishMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConvex.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_convex_of_type_pinion_bevel_generating_modified_roll_machine_settings(self) -> '_584.PinionBevelGeneratingModifiedRollMachineSettings':
        ...
        if _584.PinionBevelGeneratingModifiedRollMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConvex.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_convex_of_type_pinion_bevel_generating_tilt_machine_settings(self) -> '_585.PinionBevelGeneratingTiltMachineSettings':
        ...
        if _585.PinionBevelGeneratingTiltMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConvex.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_convex_of_type_pinion_conical_machine_settings_specified(self) -> '_587.PinionConicalMachineSettingsSpecified':
        ...
        if _587.PinionConicalMachineSettingsSpecified.TYPE not in self.wrapped.PinionCutterParametersConvex.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_convex_of_type_pinion_hypoid_formate_tilt_machine_settings(self) -> '_590.PinionHypoidFormateTiltMachineSettings':
        ...
        if _590.PinionHypoidFormateTiltMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConvex.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_convex_of_type_pinion_hypoid_generating_tilt_machine_settings(self) -> '_591.PinionHypoidGeneratingTiltMachineSettings':
        ...
        if _591.PinionHypoidGeneratingTiltMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConvex.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_convex_of_type_pinion_machine_settings_smt(self) -> '_592.PinionMachineSettingsSMT':
        ...
        if _592.PinionMachineSettingsSMT.TYPE not in self.wrapped.PinionCutterParametersConvex.__class__.__mro__:
    ...
    @property
    def pinion_rough_machine_setting(self) -> '_593.PinionRoughMachineSetting':
        ...
        return constructor.new(_593.PinionRoughMachineSetting)(self.wrapped.PinionRoughMachineSetting) if self.wrapped.PinionRoughMachineSetting else None
