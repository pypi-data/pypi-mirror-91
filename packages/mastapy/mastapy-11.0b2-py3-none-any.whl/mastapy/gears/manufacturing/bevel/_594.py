...
from mastapy.gears.manufacturing.bevel.cutters import _598
from mastapy._internal import constructor
from mastapy.gears.manufacturing.bevel.basic_machine_settings import _604, _605, _606
...
class Wheel(_0.APIBase):
    ...
    @property
    def basic_conical_gear_machine_settings(self) -> '_604.BasicConicalGearMachineSettings':
        ...
        if _604.BasicConicalGearMachineSettings.TYPE not in self.wrapped.BasicConicalGearMachineSettings.__class__.__mro__:
    ...
    @property
    def basic_conical_gear_machine_settings_of_type_basic_conical_gear_machine_settings_formate(self) -> '_605.BasicConicalGearMachineSettingsFormate':
        ...
        if _605.BasicConicalGearMachineSettingsFormate.TYPE not in self.wrapped.BasicConicalGearMachineSettings.__class__.__mro__:
    ...
    @property
    def basic_conical_gear_machine_settings_of_type_basic_conical_gear_machine_settings_generated(self) -> '_606.BasicConicalGearMachineSettingsGenerated':
        ...
        if _606.BasicConicalGearMachineSettingsGenerated.TYPE not in self.wrapped.BasicConicalGearMachineSettings.__class__.__mro__:
