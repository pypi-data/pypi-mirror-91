...
class PinionConcave(_0.APIBase):
    ...
    @property
    def pinion_concave_ob_configuration(self) -> '_606.BasicConicalGearMachineSettingsGenerated':
        ...
        return constructor.new(_606.BasicConicalGearMachineSettingsGenerated)(self.wrapped.PinionConcaveOBConfiguration) if self.wrapped.PinionConcaveOBConfiguration else None
