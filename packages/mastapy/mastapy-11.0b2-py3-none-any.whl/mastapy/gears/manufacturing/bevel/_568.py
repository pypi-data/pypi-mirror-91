...
from mastapy.gears.manufacturing.bevel import _577, _570
...
class ConicalMeshManufacturingConfig(_570.ConicalMeshMicroGeometryConfigBase):
    '''ConicalMeshManufacturingConfig
    ...
    @property
    def wheel_config(self) -> '_577.ConicalWheelManufacturingConfig':
        ...
        return constructor.new(_577.ConicalWheelManufacturingConfig)(self.wrapped.WheelConfig) if self.wrapped.WheelConfig else None
