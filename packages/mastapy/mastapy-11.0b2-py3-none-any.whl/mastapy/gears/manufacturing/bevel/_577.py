...
from mastapy.gears.manufacturing.bevel.cutters import _599, _598
...
class ConicalWheelManufacturingConfig(_559.ConicalGearManufacturingConfig):
    '''ConicalWheelManufacturingConfig
    ...
    @property
    def wheel_rough_cutter(self) -> '_599.WheelRoughCutter':
        ...
        return constructor.new(_599.WheelRoughCutter)(self.wrapped.WheelRoughCutter) if self.wrapped.WheelRoughCutter else None

    @property
    def wheel_finish_cutter(self) -> '_598.WheelFinishCutter':
        ...
        return constructor.new(_598.WheelFinishCutter)(self.wrapped.WheelFinishCutter) if self.wrapped.WheelFinishCutter else None
    ...
    @property
    def specified_machine_settings(self) -> '_604.BasicConicalGearMachineSettings':
        ...
        if _604.BasicConicalGearMachineSettings.TYPE not in self.wrapped.SpecifiedMachineSettings.__class__.__mro__:
    ...
    @property
    def specified_machine_settings_of_type_basic_conical_gear_machine_settings_formate(self) -> '_605.BasicConicalGearMachineSettingsFormate':
        ...
        if _605.BasicConicalGearMachineSettingsFormate.TYPE not in self.wrapped.SpecifiedMachineSettings.__class__.__mro__:
    ...
    @property
    def specified_machine_settings_of_type_basic_conical_gear_machine_settings_generated(self) -> '_606.BasicConicalGearMachineSettingsGenerated':
        ...
        if _606.BasicConicalGearMachineSettingsGenerated.TYPE not in self.wrapped.SpecifiedMachineSettings.__class__.__mro__:
