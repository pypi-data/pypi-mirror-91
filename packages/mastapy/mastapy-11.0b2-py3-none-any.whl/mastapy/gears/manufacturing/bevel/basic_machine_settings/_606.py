...
from mastapy.gears.manufacturing.bevel.basic_machine_settings import _604
...
class BasicConicalGearMachineSettingsGenerated(_604.BasicConicalGearMachineSettings):
    '''BasicConicalGearMachineSettingsGenerated
