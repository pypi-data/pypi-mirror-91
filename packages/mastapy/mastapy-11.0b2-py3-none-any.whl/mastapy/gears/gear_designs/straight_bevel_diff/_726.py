...
from mastapy.gears.gear_designs.straight_bevel_diff import _727, _725, _728
...
class StraightBevelDiffGearMeshDesign(_916.BevelGearMeshDesign):
    '''StraightBevelDiffGearMeshDesign
    ...
    @property
    def straight_bevel_diff_meshed_gears(self) -> 'List[_728.StraightBevelDiffMeshedGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshedGears, constructor.new(_728.StraightBevelDiffMeshedGearDesign))
        return value
