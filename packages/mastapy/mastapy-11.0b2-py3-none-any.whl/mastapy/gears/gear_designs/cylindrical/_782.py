...
class CylindricalGearMeshDesign(_715.GearMeshDesign):
    ...
    @property
    def valid_normal_module_range(self) -> '_1137.ShortLengthRange':
        ...
        return constructor.new(_1137.ShortLengthRange)(self.wrapped.ValidNormalModuleRange) if self.wrapped.ValidNormalModuleRange else None
