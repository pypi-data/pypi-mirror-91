...
class CylindricalGearDesignSettings(_1156.PerMachineSettings):
    '''CylindricalGearDesignSettings
    ...
    @property
    def tolerance_rounding_system(self) -> '_1169.MeasurementSystem':
        ...
        return constructor.new(_1169.MeasurementSystem)(value) if value else None

    @tolerance_rounding_system.setter
    def tolerance_rounding_system(self, value: '_1169.MeasurementSystem'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
