...
class FinishStockSpecification(_822.RelativeValuesSpecification['FinishStockSpecification']):
    ...
    def normal(self) -> '_835.TolerancedValueSpecification[FinishStockSpecification]':
        ...
        if _835.TolerancedValueSpecification[FinishStockSpecification].TYPE not in self.wrapped.Normal.__class__.__mro__:
    ...
    def tangent_to_reference_circle(self) -> '_835.TolerancedValueSpecification[FinishStockSpecification]':
        ...
        if _835.TolerancedValueSpecification[FinishStockSpecification].TYPE not in self.wrapped.TangentToReferenceCircle.__class__.__mro__:
