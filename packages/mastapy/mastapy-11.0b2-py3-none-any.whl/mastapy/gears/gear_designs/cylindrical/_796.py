...
class CylindricalPlanetaryGearSetDesign(_787.CylindricalGearSetDesign):
    ...
    @property
    def planetary_sideband_fourier_series_for_rotating_planet_carrier(self) -> '_1086.FourierSeries':
        ...
        return constructor.new(_1086.FourierSeries)(self.wrapped.PlanetarySidebandFourierSeriesForRotatingPlanetCarrier) if self.wrapped.PlanetarySidebandFourierSeriesForRotatingPlanetCarrier else None
