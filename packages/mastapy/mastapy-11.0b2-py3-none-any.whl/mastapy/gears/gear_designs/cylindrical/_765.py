...
class BacklashSpecification(_822.RelativeValuesSpecification['BacklashSpecification']):
    ...
    def normal_backlash(self) -> '_795.CylindricalMeshLinearBacklashSpecification':
        ...
        if _795.CylindricalMeshLinearBacklashSpecification.TYPE not in self.wrapped.NormalBacklash.__class__.__mro__:
    ...
    def circumferential_backlash_pitch_circle(self) -> '_795.CylindricalMeshLinearBacklashSpecification':
        ...
        if _795.CylindricalMeshLinearBacklashSpecification.TYPE not in self.wrapped.CircumferentialBacklashPitchCircle.__class__.__mro__:
    ...
    def circumferential_backlash_reference_circle(self) -> '_795.CylindricalMeshLinearBacklashSpecification':
        ...
        if _795.CylindricalMeshLinearBacklashSpecification.TYPE not in self.wrapped.CircumferentialBacklashReferenceCircle.__class__.__mro__:
    ...
    def radial_backlash(self) -> '_795.CylindricalMeshLinearBacklashSpecification':
        ...
        if _795.CylindricalMeshLinearBacklashSpecification.TYPE not in self.wrapped.RadialBacklash.__class__.__mro__:
