...
from mastapy.gears.gear_designs.cylindrical.accuracy_and_tolerances import _872, _876, _880
...
class AGMAGleasonConicalGearDesign(_889.ConicalGearDesign):
    '''AGMAGleasonConicalGearDesign
    ...
    @property
    def front_end_type(self) -> '_899.FrontEndTypes':
        '''FrontEndTypes: 'FrontEndType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.FrontEndType)
        return constructor.new(_899.FrontEndTypes)(value) if value else None

    @front_end_type.setter
    def front_end_type(self, value: '_899.FrontEndTypes'):
    ...
    @property
    def cutter(self) -> '_888.ConicalGearCutter':
        ...
        if _888.ConicalGearCutter.TYPE not in self.wrapped.Cutter.__class__.__mro__:
    ...
    @property
    def cutter_of_type_dummy_conical_gear_cutter(self) -> '_898.DummyConicalGearCutter':
        ...
        if _898.DummyConicalGearCutter.TYPE not in self.wrapped.Cutter.__class__.__mro__:
    ...
    @property
    def accuracy_grades_of_type_cylindrical_accuracy_grades(self) -> '_876.CylindricalAccuracyGrades':
    ...
    @property
    def accuracy_grades_of_type_agma_gleason_conical_accuracy_grades(self) -> '_927.AGMAGleasonConicalAccuracyGrades':
        ...
        if _927.AGMAGleasonConicalAccuracyGrades.TYPE not in self.wrapped.AccuracyGrades.__class__.__mro__:
