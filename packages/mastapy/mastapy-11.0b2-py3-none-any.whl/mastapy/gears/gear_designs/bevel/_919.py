...
class BevelGearSetDesign(_932.AGMAGleasonConicalGearSetDesign):
    ...
    @property
    def backlash_used_for_tooth_thickness_calculation(self) -> '_1092.MaxMinMean':
        ...
        return constructor.new(_1092.MaxMinMean)(value) if value else None

    @backlash_used_for_tooth_thickness_calculation.setter
    def backlash_used_for_tooth_thickness_calculation(self, value: '_1092.MaxMinMean'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
