...
from mastapy.gears.gear_designs.bevel import _921
...
class BevelGearDesign(_928.AGMAGleasonConicalGearDesign):
    '''BevelGearDesign
    ...
    @property
    def finishing_method(self) -> '_921.FinishingMethods':
        ...
        return constructor.new(_921.FinishingMethods)(value) if value else None

    @finishing_method.setter
    def finishing_method(self, value: '_921.FinishingMethods'):
