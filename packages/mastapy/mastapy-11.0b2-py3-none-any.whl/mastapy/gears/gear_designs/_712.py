...
from mastapy.utility.property import _1365
...
class DesignConstraintsCollection(_1360.NamedDatabaseItem):
    '''DesignConstraintsCollection
    ...
    @property
    def design_constraints(self) -> 'List[_1365.DeletableCollectionMember[_710.DesignConstraint]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignConstraints, constructor.new(_1365.DeletableCollectionMember)[_710.DesignConstraint])
        return value
