...
class GearDesign(_714.GearDesignComponent):
    ...
    @property
    def tifffe_model(self) -> '_934.GearFEModel':
        ...
        if _934.GearFEModel.TYPE not in self.wrapped.TIFFFEModel.__class__.__mro__:
    ...
    @property
    def tifffe_model_of_type_cylindrical_gear_fe_model(self) -> '_938.CylindricalGearFEModel':
        ...
        if _938.CylindricalGearFEModel.TYPE not in self.wrapped.TIFFFEModel.__class__.__mro__:
    ...
    @property
    def tifffe_model_of_type_conical_gear_fe_model(self) -> '_941.ConicalGearFEModel':
        ...
        if _941.ConicalGearFEModel.TYPE not in self.wrapped.TIFFFEModel.__class__.__mro__:
