...
from mastapy.materials import _84, _74
...
class GearMaterial(_74.Material):
    '''GearMaterial
    ...
    @property
    def sn_curve_contact(self) -> '_84.SNCurve':
        ...
        return constructor.new(_84.SNCurve)(self.wrapped.SNCurveContact) if self.wrapped.SNCurveContact else None

    @property
    def sn_curve_bending(self) -> '_84.SNCurve':
        ...
        return constructor.new(_84.SNCurve)(self.wrapped.SNCurveBending) if self.wrapped.SNCurveBending else None
