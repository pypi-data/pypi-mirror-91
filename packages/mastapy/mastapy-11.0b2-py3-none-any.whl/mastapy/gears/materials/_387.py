...
from mastapy.materials import _91, _88, _89
...
class PlasticSNCurve(_0.APIBase):
    ...
    @property
    def lubricant(self) -> '_91.VDI2736LubricantType':
        ...
        return constructor.new(_91.VDI2736LubricantType)(value) if value else None

    @lubricant.setter
    def lubricant(self, value: '_91.VDI2736LubricantType'):
    ...
    @property
    def bending_stress_cycle_data(self) -> 'List[_88.StressCyclesDataForTheBendingSNCurveOfAPlasticMaterial]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BendingStressCycleData, constructor.new(_88.StressCyclesDataForTheBendingSNCurveOfAPlasticMaterial))
        return value

    @property
    def contact_stress_cycle_data(self) -> 'List[_89.StressCyclesDataForTheContactSNCurveOfAPlasticMaterial]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ContactStressCycleData, constructor.new(_89.StressCyclesDataForTheContactSNCurveOfAPlasticMaterial))
        return value

    @property
    def bending_stress_cycle_data_for_damage_tables(self) -> 'List[_88.StressCyclesDataForTheBendingSNCurveOfAPlasticMaterial]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BendingStressCycleDataForDamageTables, constructor.new(_88.StressCyclesDataForTheBendingSNCurveOfAPlasticMaterial))
        return value

    @property
    def contact_stress_cycle_data_for_damage_tables(self) -> 'List[_89.StressCyclesDataForTheContactSNCurveOfAPlasticMaterial]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ContactStressCycleDataForDamageTables, constructor.new(_89.StressCyclesDataForTheContactSNCurveOfAPlasticMaterial))
        return value
