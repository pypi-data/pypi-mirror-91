...
class BearingSettings(_1156.PerMachineSettings):
    '''BearingSettings
    ...
    @property
    def failure_probability_for_rating_life(self) -> '_1553.RatingLife':
        ...
        return constructor.new(_1553.RatingLife)(value) if value else None

    @failure_probability_for_rating_life.setter
    def failure_probability_for_rating_life(self, value: '_1553.RatingLife'):
    ...
    @property
    def include_exponent_and_reduction_factors_in_isots162812008(self) -> '_1546.ExponentAndReductionFactorsInISO16281Calculation':
        ...
        return constructor.new(_1546.ExponentAndReductionFactorsInISO16281Calculation)(value) if value else None

    @include_exponent_and_reduction_factors_in_isots162812008.setter
    def include_exponent_and_reduction_factors_in_isots162812008(self, value: '_1546.ExponentAndReductionFactorsInISO16281Calculation'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def skf_credentials(self) -> '_1741.SKFCredentials':
        ...
        return constructor.new(_1741.SKFCredentials)(self.wrapped.SKFCredentials) if self.wrapped.SKFCredentials else None
