...
from mastapy.bearings.tolerances import _1565, _1562
...
class InterferenceTolerance(_1562.BearingConnectionComponent):
    '''InterferenceTolerance
    ...
    @property
    def definition_option(self) -> '_1565.BearingToleranceDefinitionOptions':
    ...
    def definition_option(self, value: '_1565.BearingToleranceDefinitionOptions'):
    ...
    @property
    def mounting_point_surface_finish(self) -> '_1551.MountingPointSurfaceFinishes':
        ...
        return constructor.new(_1551.MountingPointSurfaceFinishes)(value) if value else None

    @mounting_point_surface_finish.setter
    def mounting_point_surface_finish(self, value: '_1551.MountingPointSurfaceFinishes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
