...
from mastapy.bearings.bearing_results.rolling.skf_module import _1736, _1740
...
class BearingRatingLife(_1740.SKFCalculationResult):
    '''BearingRatingLife
    ...
    @property
    def life_model(self) -> '_1736.LifeModel':
        ...
        return constructor.new(_1736.LifeModel)(self.wrapped.LifeModel) if self.wrapped.LifeModel else None
