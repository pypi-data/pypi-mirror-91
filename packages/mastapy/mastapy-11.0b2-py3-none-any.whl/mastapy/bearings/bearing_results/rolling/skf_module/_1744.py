...
from mastapy.bearings.bearing_results.rolling.skf_module import _1738, _1740
...
class Viscosities(_1740.SKFCalculationResult):
    '''Viscosities
    ...
    @property
    def operating_viscosity(self) -> '_1738.OperatingViscosity':
        ...
        return constructor.new(_1738.OperatingViscosity)(self.wrapped.OperatingViscosity) if self.wrapped.OperatingViscosity else None
