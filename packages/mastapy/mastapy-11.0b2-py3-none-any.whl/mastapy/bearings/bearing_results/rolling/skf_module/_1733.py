...
class GreaseLifeAndRelubricationInterval(_1740.SKFCalculationResult):
    '''GreaseLifeAndRelubricationInterval
    ...
    def grease(self) -> '_1732.Grease':
        ...
        return constructor.new(_1732.Grease)(self.wrapped.Grease) if self.wrapped.Grease else None

    @property
    def initial_fill(self) -> '_1735.InitialFill':
        ...
        return constructor.new(_1735.InitialFill)(self.wrapped.InitialFill) if self.wrapped.InitialFill else None

    @property
    def grease_quantity(self) -> '_1734.GreaseQuantity':
        ...
        return constructor.new(_1734.GreaseQuantity)(self.wrapped.GreaseQuantity) if self.wrapped.GreaseQuantity else None
