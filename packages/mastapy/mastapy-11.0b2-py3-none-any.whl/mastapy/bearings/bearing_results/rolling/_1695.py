...
from mastapy.bearings.bearing_results.rolling import _1694, _1719
...
class LoadedCrossedRollerBearingRow(_1719.LoadedRollerBearingRow):
    '''LoadedCrossedRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1694.LoadedCrossedRollerBearingResults':
        ...
        return constructor.new(_1694.LoadedCrossedRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
