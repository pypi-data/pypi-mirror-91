...
from mastapy.bearings.bearing_results.rolling import _1722, _1681
...
class LoadedBallBearingResults(_1681.LoadedRollingBearingResults):
    '''LoadedBallBearingResults
    ...
    @property
    def track_truncation(self) -> '_1722.TrackTruncationSafetyFactorResults':
        ...
        return constructor.new(_1722.TrackTruncationSafetyFactorResults)(self.wrapped.TrackTruncation) if self.wrapped.TrackTruncation else None
