...
from mastapy.bearings.bearing_results.rolling import _1637, _1678
...
class LoadedAsymmetricSphericalRollerBearingRow(_1678.LoadedRollerBearingRow):
    '''LoadedAsymmetricSphericalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1637.LoadedAsymmetricSphericalRollerBearingResults':
        ...
        return constructor.new(_1637.LoadedAsymmetricSphericalRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
