...
from mastapy.bearings.bearing_results.rolling import _1675, _1673
...
class LoadedAngularContactThrustBallBearingRow(_1673.LoadedAngularContactBallBearingRow):
    '''LoadedAngularContactThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1675.LoadedAngularContactThrustBallBearingResults':
        ...
        return constructor.new(_1675.LoadedAngularContactThrustBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
