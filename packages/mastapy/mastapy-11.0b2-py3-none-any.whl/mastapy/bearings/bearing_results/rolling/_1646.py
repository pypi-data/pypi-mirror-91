...
from mastapy.bearings.bearing_results.rolling import _1645, _1643
...
class LoadedAxialThrustNeedleRollerBearingRow(_1643.LoadedAxialThrustCylindricalRollerBearingRow):
    '''LoadedAxialThrustNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1645.LoadedAxialThrustNeedleRollerBearingResults':
        ...
        return constructor.new(_1645.LoadedAxialThrustNeedleRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
