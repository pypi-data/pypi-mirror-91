...
from mastapy.bearings.bearing_results.rolling import _1686, _1684
...
class LoadedAxialThrustNeedleRollerBearingRow(_1684.LoadedAxialThrustCylindricalRollerBearingRow):
    '''LoadedAxialThrustNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1686.LoadedAxialThrustNeedleRollerBearingResults':
        ...
        return constructor.new(_1686.LoadedAxialThrustNeedleRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
