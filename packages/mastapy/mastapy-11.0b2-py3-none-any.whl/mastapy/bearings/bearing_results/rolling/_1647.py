...
class LoadedBallBearingDutyCycle(_1614.LoadedRollingBearingDutyCycle):
    '''LoadedBallBearingDutyCycle
    ...
    @property
    def track_truncation_inner_summary(self) -> '_1368.DutyCyclePropertySummaryPercentage[_1650.LoadedBallBearingResults]':
        ...
        return constructor.new(_1368.DutyCyclePropertySummaryPercentage)[_1650.LoadedBallBearingResults](self.wrapped.TrackTruncationInnerSummary) if self.wrapped.TrackTruncationInnerSummary else None

    @property
    def track_truncation_outer_summary(self) -> '_1368.DutyCyclePropertySummaryPercentage[_1650.LoadedBallBearingResults]':
        ...
        return constructor.new(_1368.DutyCyclePropertySummaryPercentage)[_1650.LoadedBallBearingResults](self.wrapped.TrackTruncationOuterSummary) if self.wrapped.TrackTruncationOuterSummary else None
