...
from mastapy.bearings.bearing_results.rolling import _1672, _1675, _1692
...
class LoadedAngularContactBallBearingRow(_1692.LoadedBallBearingRow):
    '''LoadedAngularContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1672.LoadedAngularContactBallBearingResults':
