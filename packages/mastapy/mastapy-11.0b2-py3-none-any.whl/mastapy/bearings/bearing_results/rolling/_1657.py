...
from mastapy.bearings.bearing_results.rolling import _1719, _1672
...
class LoadedCylindricalRollerBearingResults(_1672.LoadedNonBarrelRollerBearingResults):
    '''LoadedCylindricalRollerBearingResults
    ...
    @property
    def skf_maximal_constantly_acting_axial_load(self) -> '_1719.SKFMaximalConstantlyActingAxialLoadResults':
        ...
        return constructor.new(_1719.SKFMaximalConstantlyActingAxialLoadResults)(self.wrapped.SKFMaximalConstantlyActingAxialLoad) if self.wrapped.SKFMaximalConstantlyActingAxialLoad else None
