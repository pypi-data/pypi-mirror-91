...
from mastapy.bearings.bearing_results.rolling import _1756, _1703
...
class LoadedRollerBearingElement(_1703.LoadedElement):
    '''LoadedRollerBearingElement
    ...
    @property
    def results_at_roller_offsets(self) -> 'List[_1756.ResultsAtRollerOffset]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ResultsAtRollerOffsets, constructor.new(_1756.ResultsAtRollerOffset))
        return value
