...
from mastapy.bearings.bearing_results.rolling import _1710, _1699
...
class LoadedNeedleRollerBearingRow(_1699.LoadedCylindricalRollerBearingRow):
    '''LoadedNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1710.LoadedNeedleRollerBearingResults':
        ...
        return constructor.new(_1710.LoadedNeedleRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
