...
from mastapy.bearings.bearing_results.rolling import (
    _1650, _1631, _1634, _1660,
    _1665, _1684, _1700, _1703,
    _1649, _1682
)
...
class LoadedBallBearingRow(_1682.LoadedRollingBearingRow):
    '''LoadedBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1650.LoadedBallBearingResults':
    ...
    @property
    def race_results(self) -> 'List[_1649.LoadedBallBearingRaceResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RaceResults, constructor.new(_1649.LoadedBallBearingRaceResults))
        return value
