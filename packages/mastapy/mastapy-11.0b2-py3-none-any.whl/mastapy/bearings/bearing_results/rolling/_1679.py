...
from mastapy.bearings.bearing_results.rolling import _1678, _1719
...
class LoadedAsymmetricSphericalRollerBearingRow(_1719.LoadedRollerBearingRow):
    '''LoadedAsymmetricSphericalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1678.LoadedAsymmetricSphericalRollerBearingResults':
        ...
        return constructor.new(_1678.LoadedAsymmetricSphericalRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
