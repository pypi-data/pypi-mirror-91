...
from mastapy.bearings.bearing_results.rolling import _1760, _1713
...
class LoadedCylindricalRollerBearingResults(_1713.LoadedNonBarrelRollerBearingResults):
    '''LoadedCylindricalRollerBearingResults
    ...
    @property
    def skf_maximal_constantly_acting_axial_load(self) -> '_1760.SKFMaximalConstantlyActingAxialLoadResults':
        ...
        return constructor.new(_1760.SKFMaximalConstantlyActingAxialLoadResults)(self.wrapped.SKFMaximalConstantlyActingAxialLoad) if self.wrapped.SKFMaximalConstantlyActingAxialLoad else None
