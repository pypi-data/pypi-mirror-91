...
from mastapy.bearings.bearing_results.rolling import _1634, _1632
...
class LoadedAngularContactThrustBallBearingRow(_1632.LoadedAngularContactBallBearingRow):
    '''LoadedAngularContactThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1634.LoadedAngularContactThrustBallBearingResults':
        ...
        return constructor.new(_1634.LoadedAngularContactThrustBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
