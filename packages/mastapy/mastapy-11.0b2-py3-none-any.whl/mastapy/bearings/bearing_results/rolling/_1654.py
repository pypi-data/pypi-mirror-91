...
from mastapy.bearings.bearing_results.rolling import _1653, _1678
...
class LoadedCrossedRollerBearingRow(_1678.LoadedRollerBearingRow):
    '''LoadedCrossedRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1653.LoadedCrossedRollerBearingResults':
        ...
        return constructor.new(_1653.LoadedCrossedRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
