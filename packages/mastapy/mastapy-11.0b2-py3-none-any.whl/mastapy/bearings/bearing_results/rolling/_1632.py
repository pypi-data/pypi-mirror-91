...
from mastapy.bearings.bearing_results.rolling import _1631, _1634, _1651
...
class LoadedAngularContactBallBearingRow(_1651.LoadedBallBearingRow):
    '''LoadedAngularContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1631.LoadedAngularContactBallBearingResults':
