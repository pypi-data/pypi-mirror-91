...
class LoadedPlainJournalBearingRow(_0.APIBase):
    ...
    def row(self) -> '_1543.BearingRow':
        ...
        return constructor.new(_1543.BearingRow)(value) if value else None
    ...
    @property
    def journal_bearing_loading_chart(self) -> '_6555.SMTBitmap':
        ...
        return constructor.new(_6555.SMTBitmap)(self.wrapped.JournalBearingLoadingChart) if self.wrapped.JournalBearingLoadingChart else None
