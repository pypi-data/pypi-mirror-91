...
from mastapy.bearings.bearing_designs.rolling import _1797, _1794
...
class TaperRollerBearing(_1794.NonBarrelRollerBearing):
    '''TaperRollerBearing
    ...
    @property
    def bearing_measurement_type(self) -> '_1541.BearingMeasurementType':
        ...
        return constructor.new(_1541.BearingMeasurementType)(value) if value else None

    @bearing_measurement_type.setter
    def bearing_measurement_type(self, value: '_1541.BearingMeasurementType'):
    ...
    @property
    def major_rib_detail(self) -> '_1797.RollerRibDetail':
        ...
        return constructor.new(_1797.RollerRibDetail)(self.wrapped.MajorRibDetail) if self.wrapped.MajorRibDetail else None
