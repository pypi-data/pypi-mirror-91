...
from mastapy.bearings.bearing_designs.rolling import _1780, _1798
...
class BallBearing(_1798.RollingBearing):
    '''BallBearing
    ...
    @property
    def shoulders(self) -> 'List[_1780.BallBearingShoulderDefinition]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Shoulders, constructor.new(_1780.BallBearingShoulderDefinition))
        return value
