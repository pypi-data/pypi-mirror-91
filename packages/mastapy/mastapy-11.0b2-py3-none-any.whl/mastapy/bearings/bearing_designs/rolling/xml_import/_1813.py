...
from mastapy.bearings.bearing_designs.rolling.xml_import import _1811, _1810
...
class XmlBearingTypeMapping(_0.APIBase):
    ...
    @property
    def files(self) -> 'List[_1811.BearingImportFile]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Files, constructor.new(_1811.BearingImportFile))
        return value

    @property
    def variables(self) -> 'List[_1810.AbstractXmlVariableAssignment]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Variables, constructor.new(_1810.AbstractXmlVariableAssignment))
        return value
