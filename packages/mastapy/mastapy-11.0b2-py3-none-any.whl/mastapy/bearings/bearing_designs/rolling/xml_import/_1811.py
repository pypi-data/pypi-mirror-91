...
from mastapy.bearings.bearing_designs.rolling.xml_import import _1809, _1808
...
class XmlBearingTypeMapping(_0.APIBase):
    ...
    @property
    def files(self) -> 'List[_1809.BearingImportFile]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Files, constructor.new(_1809.BearingImportFile))
        return value

    @property
    def variables(self) -> 'List[_1808.AbstractXmlVariableAssignment]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Variables, constructor.new(_1808.AbstractXmlVariableAssignment))
        return value
