...
from mastapy.bearings.bearing_designs.rolling import _1796, _1797, _1795
...
class NonBarrelRollerBearing(_1795.RollerBearing):
    '''NonBarrelRollerBearing
    ...
    @property
    def roller_end_shape(self) -> '_1796.RollerEndShape':
        ...
        return constructor.new(_1796.RollerEndShape)(value) if value else None

    @roller_end_shape.setter
    def roller_end_shape(self, value: '_1796.RollerEndShape'):
    ...
    @property
    def ribs(self) -> 'List[_1797.RollerRibDetail]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Ribs, constructor.new(_1797.RollerRibDetail))
        return value
