...
class ThrustBallBearing(_1779.BallBearing):
    '''ThrustBallBearing
    ...
    @property
    def outer_ring_mounting(self) -> '_1552.OuterRingMounting':
        ...
        return constructor.new(_1552.OuterRingMounting)(value) if value else None

    @outer_ring_mounting.setter
    def outer_ring_mounting(self, value: '_1552.OuterRingMounting'):
