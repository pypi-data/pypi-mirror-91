...
from mastapy.bearings import (
    _1555, _1558, _1534, _1535,
    _1536, _1537
)
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.bearings.bearing_designs.rolling import (
    _1807, _1791, _1789, _1785,
    _1800, _1782
)
...
class RollingBearing(_1770.DetailedBearing):
    '''RollingBearing
    ...
    @property
    def catalogue(self) -> '_1534.BearingCatalog':
        ...
        return constructor.new(_1534.BearingCatalog)(value) if value else None
    ...
    @property
    def type_information(self) -> '_1785.BearingTypeExtraInformation':
        ...
        return constructor.new(_1785.BearingTypeExtraInformation)(value) if value else None
    ...
    @property
    def cage_material(self) -> '_1537.BearingCageMaterial':
        ...
        return constructor.new(_1537.BearingCageMaterial)(value) if value else None

    @cage_material.setter
    def cage_material(self, value: '_1537.BearingCageMaterial'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.CageMaterial = value

    @property
    def sleeve_type(self) -> '_1800.SleeveType':
        ...
        return constructor.new(_1800.SleeveType)(value) if value else None
    ...
    @property
    def history(self) -> '_1148.FileHistory':
        ...
        return constructor.new(_1148.FileHistory)(self.wrapped.History) if self.wrapped.History else None

    @property
    def protection(self) -> '_1782.BearingProtection':
        ...
        return constructor.new(_1782.BearingProtection)(self.wrapped.Protection) if self.wrapped.Protection else None
