...
class PlainGreaseFilledJournalBearing(_1823.PlainJournalBearing):
    '''PlainGreaseFilledJournalBearing
    ...
    @property
    def housing_type(self) -> '_1822.PlainGreaseFilledJournalBearingHousingType':
        ...
        return constructor.new(_1822.PlainGreaseFilledJournalBearingHousingType)(value) if value else None

    @housing_type.setter
    def housing_type(self, value: '_1822.PlainGreaseFilledJournalBearingHousingType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.HousingType = value

    @property
    def housing_detail(self) -> '_1824.PlainJournalHousing':
        ...
        if _1824.PlainJournalHousing.TYPE not in self.wrapped.HousingDetail.__class__.__mro__:
    ...
    @property
    def housing_detail_of_type_cylindrical_housing_journal_bearing(self) -> '_1817.CylindricalHousingJournalBearing':
        ...
        if _1817.CylindricalHousingJournalBearing.TYPE not in self.wrapped.HousingDetail.__class__.__mro__:
    ...
    @property
    def housing_detail_of_type_machinery_encased_journal_bearing(self) -> '_1818.MachineryEncasedJournalBearing':
        ...
        if _1818.MachineryEncasedJournalBearing.TYPE not in self.wrapped.HousingDetail.__class__.__mro__:
    ...
    @property
    def housing_detail_of_type_pedestal_journal_bearing(self) -> '_1820.PedestalJournalBearing':
        ...
        if _1820.PedestalJournalBearing.TYPE not in self.wrapped.HousingDetail.__class__.__mro__:
