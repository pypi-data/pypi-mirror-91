...
from mastapy.bearings.bearing_designs.fluid_film import _1819
...
class TiltingPadThrustBearing(_1819.PadFluidFilmBearing):
    '''TiltingPadThrustBearing
    ...
    @property
    def tilting_pad_type(self) -> '_1561.TiltingPadTypes':
        ...
        return constructor.new(_1561.TiltingPadTypes)(value) if value else None

    @tilting_pad_type.setter
    def tilting_pad_type(self, value: '_1561.TiltingPadTypes'):
