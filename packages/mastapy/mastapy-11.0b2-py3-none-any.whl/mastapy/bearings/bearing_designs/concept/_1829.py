...
from mastapy.bearings.bearing_designs.concept import _1828, _1830
...
class ConceptAxialClearanceBearing(_1830.ConceptClearanceBearing):
    '''ConceptAxialClearanceBearing
    ...
    @property
    def node_position(self) -> '_1828.BearingNodePosition':
        ...
        return constructor.new(_1828.BearingNodePosition)(value) if value else None

    @node_position.setter
    def node_position(self, value: '_1828.BearingNodePosition'):
