...
class LinearBearing(_1769.BearingDesign):
    '''LinearBearing
    ...
    @property
    def stiffness_options(self) -> '_1545.BearingStiffnessMatrixOption':
        ...
        return constructor.new(_1545.BearingStiffnessMatrixOption)(value) if value else None

    @stiffness_options.setter
    def stiffness_options(self, value: '_1545.BearingStiffnessMatrixOption'):
