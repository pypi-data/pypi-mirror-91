...
from mastapy.bearings import _1547
...
class LinearBearing(_1771.BearingDesign):
    '''LinearBearing
    ...
    @property
    def stiffness_options(self) -> '_1547.BearingStiffnessMatrixOption':
        ...
        return constructor.new(_1547.BearingStiffnessMatrixOption)(value) if value else None

    @stiffness_options.setter
    def stiffness_options(self, value: '_1547.BearingStiffnessMatrixOption'):
