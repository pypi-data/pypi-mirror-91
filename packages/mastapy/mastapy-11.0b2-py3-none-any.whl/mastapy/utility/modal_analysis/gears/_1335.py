...
from mastapy.utility.modal_analysis.gears import _1336, _1339, _1341
...
class GearOrderForTE(_1341.OrderWithRadius):
    '''GearOrderForTE
    ...
    @property
    def position(self) -> '_1336.GearPositions':
        ...
        return constructor.new(_1336.GearPositions)(value) if value else None

    @property
    def additional_orders_and_harmonics(self) -> 'List[_1339.OrderForTE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AdditionalOrdersAndHarmonics, constructor.new(_1339.OrderForTE))
        return value
