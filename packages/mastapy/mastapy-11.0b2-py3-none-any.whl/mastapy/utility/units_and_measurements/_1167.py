...
from mastapy.utility import _1160
...
class MeasurementBase(_0.APIBase):
    ...
    @property
    def rounding_method(self) -> '_1160.RoundingMethods':
        ...
        return constructor.new(_1160.RoundingMethods)(value) if value else None

    @rounding_method.setter
    def rounding_method(self, value: '_1160.RoundingMethods'):
    ...
    @property
    def current_unit(self) -> '_1172.Unit':
        ...
        if _1172.Unit.TYPE not in self.wrapped.CurrentUnit.__class__.__mro__:
