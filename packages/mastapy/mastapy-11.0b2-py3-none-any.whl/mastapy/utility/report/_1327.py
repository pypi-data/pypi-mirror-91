...
from mastapy.utility.report import _1326, _1319
...
class UserTextRow(_1319.CustomRow):
    '''UserTextRow
    ...
    @property
    def heading_size(self) -> '_1326.HeadingSize':
        '''HeadingSize: 'HeadingSize' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.HeadingSize)
        return constructor.new(_1326.HeadingSize)(value) if value else None

    @heading_size.setter
    def heading_size(self, value: '_1326.HeadingSize'):
