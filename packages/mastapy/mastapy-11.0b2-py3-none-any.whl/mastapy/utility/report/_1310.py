...
from mastapy.utility.report import _1311, _1314
...
TItem = TypeVar('TItem', bound='_1314.CustomReportPropertyItem')


class CustomReportMultiPropertyItem(_1311.CustomReportMultiPropertyItemBase, Generic[TItem]):
    '''CustomReportMultiPropertyItem
