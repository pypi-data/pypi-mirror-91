...
from mastapy.utility.units_and_measurements.measurements import _1177
...
class DutyCyclePropertySummarySmallAngle(_1366.DutyCyclePropertySummary['_1177.AngleSmall', 'T'], Generic[T]):
    '''DutyCyclePropertySummarySmallAngle
