...
from mastapy.utility.units_and_measurements.measurements import _1198
...
class DutyCyclePropertySummaryForce(_1366.DutyCyclePropertySummary['_1198.Force', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryForce
