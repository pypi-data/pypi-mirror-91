...
from mastapy.utility.units_and_measurements.measurements import _1260
...
class DutyCyclePropertySummaryStress(_1366.DutyCyclePropertySummary['_1260.Stress', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryStress
