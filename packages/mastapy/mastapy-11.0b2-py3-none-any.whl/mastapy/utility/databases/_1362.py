...
from mastapy.utility.databases import _1360, _1357, _1356
...
class SQLDatabase(_1356.Database['TKey', 'TValue'], Generic[TKey, TValue]):
    '''SQLDatabase
    ...
    def save(self, item: '_1360.NamedDatabaseItem'):
    ...
    def delete(self, key: '_1357.DatabaseKey'):
