...
from mastapy.utility.databases import _1360, _1362, _1361
...
TValue = TypeVar('TValue', bound='_1360.NamedDatabaseItem')


class NamedDatabase(_1362.SQLDatabase['_1361.NamedKey', 'TValue'], Generic[TValue]):
    '''NamedDatabase
    ...
    def rename(self, item: '_1360.NamedDatabaseItem', new_name: 'str') -> 'bool':
