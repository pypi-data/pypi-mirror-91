...
from mastapy.math_utility.measured_vectors import _1136, _1131
...
class ForceAndDisplacementResults(_1131.AbstractForceAndDisplacementResults):
    '''ForceAndDisplacementResults
    ...
    @property
    def displacement(self) -> '_1136.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1136.VectorWithLinearAndAngularComponents)(self.wrapped.Displacement) if self.wrapped.Displacement else None
