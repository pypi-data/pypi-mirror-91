...
from mastapy.math_utility.optimisation import _1127, _1125
...
class ParetoOptimistaionVariable(_1125.ParetoOptimisationVariableBase):
    '''ParetoOptimistaionVariable
    ...
    @property
    def property_target_for_dominant_candidate_search(self) -> '_1127.PropertyTargetForDominantCandidateSearch':
        ...
        return constructor.new(_1127.PropertyTargetForDominantCandidateSearch)(value) if value else None

    @property_target_for_dominant_candidate_search.setter
    def property_target_for_dominant_candidate_search(self, value: '_1127.PropertyTargetForDominantCandidateSearch'):
