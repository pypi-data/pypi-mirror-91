...
from mastapy.math_utility.optimisation import _1119
...
class InputSetter(_0.APIBase, Generic[T]):
    ...
    @property
    def optimiser_input(self) -> '_1119.ParetoOptimisationInput':
        ...
        return constructor.new(_1119.ParetoOptimisationInput)(self.wrapped.OptimiserInput) if self.wrapped.OptimiserInput else None
