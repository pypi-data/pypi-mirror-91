...
class ImportedFEComponent(_2023.AbstractShaftOrHousing):
    '''ImportedFEComponent
    ...
    @property
    def default_active_imported_fe(self) -> '_1976.ImportedFE':
        ...
        return constructor.new(_1976.ImportedFE)(self.wrapped.DefaultActiveImportedFE) if self.wrapped.DefaultActiveImportedFE else None
    ...
    def add_imported_fe(self) -> '_1976.ImportedFE':
    ...
    def add_imported_fe_with_name(self, name: 'str') -> '_1976.ImportedFE':
        ''' 'AddImportedFE' is the original name of this method.
    ...
    def select_imported_fe(self, imported_fe: '_1976.ImportedFE'):
    ...
    def remove_imported_fe(self, imported_fe: '_1976.ImportedFE') -> 'bool':
