...
class SpringDamper(_2161.Coupling):
    '''SpringDamper
    ...
    @property
    def connection(self) -> '_1942.SpringDamperConnection':
        ...
        return constructor.new(_1942.SpringDamperConnection)(self.wrapped.Connection) if self.wrapped.Connection else None
