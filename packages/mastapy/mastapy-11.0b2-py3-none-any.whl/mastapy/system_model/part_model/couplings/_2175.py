...
class ShaftHubConnection(_2033.Connector):
    '''ShaftHubConnection
    ...
    @property
    def tilt_stiffness_type(self) -> '_2169.RigidConnectorTiltStiffnessTypes':
        ...
        return constructor.new(_2169.RigidConnectorTiltStiffnessTypes)(value) if value else None

    @tilt_stiffness_type.setter
    def tilt_stiffness_type(self, value: '_2169.RigidConnectorTiltStiffnessTypes'):
    ...
    @property
    def twod_spline_drawing(self) -> '_6555.SMTBitmap':
        ...
        return constructor.new(_6555.SMTBitmap)(self.wrapped.TwoDSplineDrawing) if self.wrapped.TwoDSplineDrawing else None
    ...
    @property
    def nonlinear_stiffness(self) -> '_1384.DiagonalNonlinearStiffness':
        ...
        return constructor.new(_1384.DiagonalNonlinearStiffness)(self.wrapped.NonlinearStiffness) if self.wrapped.NonlinearStiffness else None

    @property
    def tooth_locations_external_spline_half(self) -> 'List[_2170.RigidConnectorToothLocation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ToothLocationsExternalSplineHalf, constructor.new(_2170.RigidConnectorToothLocation))
        return value
