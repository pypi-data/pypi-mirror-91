...
from mastapy.system_model.part_model.couplings import _2184, _2186, _2161
...
class TorqueConverter(_2161.Coupling):
    '''TorqueConverter
    ...
    @property
    def pump(self) -> '_2184.TorqueConverterPump':
        ...
        return constructor.new(_2184.TorqueConverterPump)(self.wrapped.Pump) if self.wrapped.Pump else None

    @property
    def turbine(self) -> '_2186.TorqueConverterTurbine':
        ...
        return constructor.new(_2186.TorqueConverterTurbine)(self.wrapped.Turbine) if self.wrapped.Turbine else None
