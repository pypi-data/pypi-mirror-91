...
from mastapy.system_model.part_model.couplings import _2179, _2181
...
class SynchroniserHalf(_2181.SynchroniserPart):
    '''SynchroniserHalf
    ...
    @property
    def cones(self) -> 'List[_2179.SynchroniserCone]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_2179.SynchroniserCone))
        return value
