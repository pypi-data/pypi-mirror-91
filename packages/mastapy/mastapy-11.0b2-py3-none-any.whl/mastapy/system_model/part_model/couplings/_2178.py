...
from mastapy.system_model.part_model.couplings import _2182, _2180
...
class Synchroniser(_2060.SpecialisedAssembly):
    '''Synchroniser
    ...
    @property
    def hub_and_sleeve(self) -> '_2182.SynchroniserSleeve':
        ...
        return constructor.new(_2182.SynchroniserSleeve)(self.wrapped.HubAndSleeve) if self.wrapped.HubAndSleeve else None

    @property
    def left_cone(self) -> '_2180.SynchroniserHalf':
        ...
        return constructor.new(_2180.SynchroniserHalf)(self.wrapped.LeftCone) if self.wrapped.LeftCone else None

    @property
    def right_cone(self) -> '_2180.SynchroniserHalf':
        ...
        return constructor.new(_2180.SynchroniserHalf)(self.wrapped.RightCone) if self.wrapped.RightCone else None

    @property
    def clutch_connection_left(self) -> '_1934.ClutchConnection':
        ...
        return constructor.new(_1934.ClutchConnection)(self.wrapped.ClutchConnectionLeft) if self.wrapped.ClutchConnectionLeft else None

    @property
    def clutch_connection_right(self) -> '_1934.ClutchConnection':
        ...
        return constructor.new(_1934.ClutchConnection)(self.wrapped.ClutchConnectionRight) if self.wrapped.ClutchConnectionRight else None
