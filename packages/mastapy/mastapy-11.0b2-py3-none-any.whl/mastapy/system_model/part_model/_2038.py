...
class FlexiblePinAssembly(_2060.SpecialisedAssembly):
    '''FlexiblePinAssembly
    ...
    @property
    def planet_gear(self) -> '_2107.CylindricalGear':
        ...
        if _2107.CylindricalGear.TYPE not in self.wrapped.PlanetGear.__class__.__mro__:
