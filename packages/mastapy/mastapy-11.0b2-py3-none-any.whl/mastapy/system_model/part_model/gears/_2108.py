...
from mastapy.system_model.part_model.gears import _2107, _2114
...
class CylindricalGearSet(_2114.GearSet):
    '''CylindricalGearSet
    ...
    @property
    def supercharger_rotor_set(self) -> '_2145.SuperchargerRotorSet':
        ...
        return constructor.new(_2145.SuperchargerRotorSet)(self.wrapped.SuperchargerRotorSet) if self.wrapped.SuperchargerRotorSet else None
