...
from mastapy.nodal_analysis.dev_tools_analyses import _1484, _1475
...
class ImportedFEWithSelectionModalAnalysis(_1990.ImportedFEWithSelection):
    '''ImportedFEWithSelectionModalAnalysis
    ...
    @property
    def modal_draw_style(self) -> '_1484.FEModelModalAnalysisDrawStyle':
        ...
        return constructor.new(_1484.FEModelModalAnalysisDrawStyle)(self.wrapped.ModalDrawStyle) if self.wrapped.ModalDrawStyle else None

    @property
    def eigenvalue_options(self) -> '_1475.EigenvalueOptions':
        ...
        return constructor.new(_1475.EigenvalueOptions)(self.wrapped.EigenvalueOptions) if self.wrapped.EigenvalueOptions else None

    @property
    def fe_modal_frequencies(self) -> 'List[_1388.FEModalFrequencyComparison]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FEModalFrequencies, constructor.new(_1388.FEModalFrequencyComparison))
        return value
