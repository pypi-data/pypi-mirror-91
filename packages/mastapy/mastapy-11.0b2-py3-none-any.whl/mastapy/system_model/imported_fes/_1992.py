...
class ImportedFEWithSelectionForHarmonicAnalysis(_1990.ImportedFEWithSelection):
    '''ImportedFEWithSelectionForHarmonicAnalysis
    ...
    @property
    def harmonic_draw_style(self) -> '_1482.FEModelHarmonicAnalysisDrawStyle':
        ...
        return constructor.new(_1482.FEModelHarmonicAnalysisDrawStyle)(self.wrapped.HarmonicDrawStyle) if self.wrapped.HarmonicDrawStyle else None
