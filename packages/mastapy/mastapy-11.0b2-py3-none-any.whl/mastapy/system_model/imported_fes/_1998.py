...
class MaterialPropertiesWithSelection(_0.APIBase):
    ...
    @property
    def material_properties(self) -> '_1511.MaterialPropertiesReporting':
        ...
        return constructor.new(_1511.MaterialPropertiesReporting)(self.wrapped.MaterialProperties) if self.wrapped.MaterialProperties else None
