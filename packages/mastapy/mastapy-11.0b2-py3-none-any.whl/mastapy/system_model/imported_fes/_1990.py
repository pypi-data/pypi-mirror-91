...
class ImportedFEWithSelection(_1953.BaseFEWithSelection):
    '''ImportedFEWithSelection
    ...
    @property
    def imported_fe(self) -> '_1976.ImportedFE':
        ...
        return constructor.new(_1976.ImportedFE)(self.wrapped.ImportedFE) if self.wrapped.ImportedFE else None

    @property
    def element_face_groups(self) -> 'List[_1967.ElementFaceGroupWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElementFaceGroups, constructor.new(_1967.ElementFaceGroupWithSelection))
        return value

    @property
    def node_groups(self) -> 'List[_2001.NodeGroupWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodeGroups, constructor.new(_2001.NodeGroupWithSelection))
        return value
