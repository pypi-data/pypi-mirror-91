...
class IndependentMastaCreatedCondensationNode(_0.APIBase):
    ...
    @property
    def rigid_coupling_type(self) -> '_1496.RigidCouplingType':
        ...
        return constructor.new(_1496.RigidCouplingType)(value) if value else None

    @rigid_coupling_type.setter
    def rigid_coupling_type(self, value: '_1496.RigidCouplingType'):
    ...
    @property
    def imported_fe_node(self) -> '_1988.ImportedFEStiffnessNode':
        ...
        return constructor.new(_1988.ImportedFEStiffnessNode)(self.wrapped.ImportedFENode) if self.wrapped.ImportedFENode else None
