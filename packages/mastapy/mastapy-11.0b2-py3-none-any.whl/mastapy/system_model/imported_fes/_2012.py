...
from mastapy.system_model.imported_fes import _2005, _2004
...
class SystemDeflectionFEExportOptions(_0.APIBase):
    ...
    @property
    def nodes(self) -> 'List[_2005.PerNodeExportOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Nodes, constructor.new(_2005.PerNodeExportOptions))
        return value

    @property
    def links(self) -> 'List[_2004.PerLinkExportOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_2004.PerLinkExportOptions))
        return value
