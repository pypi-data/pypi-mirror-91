...
from mastapy.system_model.imported_fes import _1950, _1956
...
class RaceBearingFE(_0.APIBase):
    ...
    @property
    def alignment_method(self) -> '_1950.AlignmentMethodForRaceBearing':
        ...
        return constructor.new(_1950.AlignmentMethodForRaceBearing)(value) if value else None

    @alignment_method.setter
    def alignment_method(self, value: '_1950.AlignmentMethodForRaceBearing'):
    ...
    @property
    def links(self) -> 'List[_1956.BearingRaceNodeLink]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_1956.BearingRaceNodeLink))
        return value
