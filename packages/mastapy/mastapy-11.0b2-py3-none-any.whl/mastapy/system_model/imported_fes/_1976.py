...
from mastapy.system_model.imported_fes import (
    _1955, _1989, _2013, _1949,
    _1951, _2014, _2009, _1988,
    _1947, _1972, _1975, _1995,
    _1994, _1991, _1992, _1993
)
from mastapy._internal.python_net import python_net_import
from mastapy.system_model.part_model import _2034, _2030, _2042
from mastapy.nodal_analysis import _1394, _1387, _1390
from mastapy.nodal_analysis.component_mode_synthesis import _1523
from mastapy.system_model import _1848
...
class ImportedFE(_1390.FEStiffness):
    '''ImportedFE
    ...
    @property
    def bearing_node_alignment(self) -> '_1955.BearingNodeAlignmentOption':
        ...
        return constructor.new(_1955.BearingNodeAlignmentOption)(value) if value else None

    @bearing_node_alignment.setter
    def bearing_node_alignment(self, value: '_1955.BearingNodeAlignmentOption'):
    ...
    @property
    def alignment_method(self) -> '_1949.AlignmentMethod':
        ...
        return constructor.new(_1949.AlignmentMethod)(value) if value else None

    @alignment_method.setter
    def alignment_method(self, value: '_1949.AlignmentMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def gravity_force_source(self) -> '_1394.GravityForceSource':
        ...
        return constructor.new(_1394.GravityForceSource)(value) if value else None
    ...
    @property
    def fe_meshing_options(self) -> '_1387.FEMeshingOptions':
        ...
        return constructor.new(_1387.FEMeshingOptions)(self.wrapped.FEMeshingOptions) if self.wrapped.FEMeshingOptions else None

    @property
    def cms_model(self) -> '_1523.FullFEModel':
        ...
        return constructor.new(_1523.FullFEModel)(self.wrapped.CMSModel) if self.wrapped.CMSModel else None

    @property
    def alignment_to_component(self) -> '_1848.RelativeComponentAlignment[_2030.Component]':
        ...
        return constructor.new(_1848.RelativeComponentAlignment)[_2030.Component](self.wrapped.AlignmentToComponent) if self.wrapped.AlignmentToComponent else None

    @property
    def alignment_using_axial_node_positions(self) -> '_1951.AlignmentUsingAxialNodePositions':
        ...
        return constructor.new(_1951.AlignmentUsingAxialNodePositions)(self.wrapped.AlignmentUsingAxialNodePositions) if self.wrapped.AlignmentUsingAxialNodePositions else None

    @property
    def coordinate_system(self) -> '_1073.CoordinateSystem3D':
        ...
        return constructor.new(_1073.CoordinateSystem3D)(self.wrapped.CoordinateSystem) if self.wrapped.CoordinateSystem else None

    @property
    def export(self) -> '_2014.UsedForExportingAnImportedFEsSetupOrSubstructuringStepToAnFEFile':
        ...
        return constructor.new(_2014.UsedForExportingAnImportedFEsSetupOrSubstructuringStepToAnFEFile)(self.wrapped.Export) if self.wrapped.Export else None
    ...
    @property
    def shafts_that_can_be_replaced(self) -> 'List[_2009.ReplacedShaftSelectionHelper]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftsThatCanBeReplaced, constructor.new(_2009.ReplacedShaftSelectionHelper))
        return value
    ...
    @property
    def replaced_shafts(self) -> 'List[_2065.Shaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ReplacedShafts, constructor.new(_2065.Shaft))
        return value

    @property
    def links(self) -> 'List[_1947.ImportedFELink]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_1947.ImportedFELink))
        return value

    @property
    def thermal_expansion_forces(self) -> 'List[_1136.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThermalExpansionForces, constructor.new(_1136.VectorWithLinearAndAngularComponents))
        return value

    @property
    def thermal_expansion_displacements(self) -> 'List[_1136.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThermalExpansionDisplacements, constructor.new(_1136.VectorWithLinearAndAngularComponents))
        return value

    @property
    def geometries(self) -> 'List[_1972.FEStiffnessGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Geometries, constructor.new(_1972.FEStiffnessGeometry))
        return value

    @property
    def gear_meshing_options(self) -> 'List[_1975.GearMeshingOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshingOptions, constructor.new(_1975.GearMeshingOptions))
        return value

    @property
    def independent_masta_created_condensation_nodes(self) -> 'List[_1995.IndependentMastaCreatedCondensationNode]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.IndependentMastaCreatedCondensationNodes, constructor.new(_1995.IndependentMastaCreatedCondensationNode))
        return value

    @property
    def imported_fe_component(self) -> '_2042.ImportedFEComponent':
        ...
        return constructor.new(_2042.ImportedFEComponent)(self.wrapped.ImportedFEComponent) if self.wrapped.ImportedFEComponent else None
    ...
    def load_existing_masta_fe_file_with_progress(self, file_name: 'str', progress: '_6552.TaskProgress'):
        ''' 'LoadExistingMastaFEFile' is the original name of this method.
    ...
    def create_imported_fe_with_selection_static_analysis(self) -> '_1994.ImportedFEWithSelectionStaticAnalysis':
    ...
    def create_imported_fe_with_selection_components(self) -> '_1991.ImportedFEWithSelectionComponents':
    ...
    def create_imported_fe_with_selection_for_harmonic_analysis(self) -> '_1992.ImportedFEWithSelectionForHarmonicAnalysis':
    ...
    def create_imported_fe_with_selection_modal_analysis(self) -> '_1993.ImportedFEWithSelectionModalAnalysis':
    ...
    def links_for(self, node: '_1988.ImportedFEStiffnessNode') -> 'List[_1947.ImportedFELink]':
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.LinksFor(node.wrapped if node else None), constructor.new(_1947.ImportedFELink))
