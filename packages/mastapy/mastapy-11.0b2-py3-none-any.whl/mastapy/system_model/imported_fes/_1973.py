...
class FEStiffnessTester(_0.APIBase):
    ...
    @property
    def fe_stiffness(self) -> '_1976.ImportedFE':
        ...
        return constructor.new(_1976.ImportedFE)(self.wrapped.FEStiffness) if self.wrapped.FEStiffness else None

    @property
    def force_and_displacement_results(self) -> 'List[_1132.ForceAndDisplacementResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForceAndDisplacementResults, constructor.new(_1132.ForceAndDisplacementResults))
        return value
