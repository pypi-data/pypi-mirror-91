...
class RootAssemblyCompoundParametricStudyTool(_3651.AssemblyCompoundParametricStudyTool):
    '''RootAssemblyCompoundParametricStudyTool
    ...
    @property
    def root_assembly_duty_cycle_results(self) -> '_2446.DutyCycleEfficiencyResults':
        ...
        return constructor.new(_2446.DutyCycleEfficiencyResults)(self.wrapped.RootAssemblyDutyCycleResults) if self.wrapped.RootAssemblyDutyCycleResults else None
