...
from mastapy.system_model.analyses_and_results.static_loads import _6102, _6204
from mastapy.system_model import _1839
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3596, _3597
...
class ParametricStudyToolOptions(_0.APIBase):
    ...
    @property
    def parametric_study_type(self) -> '_6204.ParametricStudyType':
        ...
        return constructor.new(_6204.ParametricStudyType)(value) if value else None

    @parametric_study_type.setter
    def parametric_study_type(self, value: '_6204.ParametricStudyType'):
    ...
    @property
    def external_full_fe_loader(self) -> '_1839.ExternalFullFELoader':
        ...
        return constructor.new(_1839.ExternalFullFELoader)(self.wrapped.ExternalFullFELoader) if self.wrapped.ExternalFullFELoader else None

    @property
    def step_results(self) -> 'List[_3596.ParametricStudyToolStepResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StepResults, constructor.new(_3596.ParametricStudyToolStepResult))
        return value

    @property
    def study_variables(self) -> 'List[_3597.ParametricStudyVariable]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StudyVariables, constructor.new(_3597.ParametricStudyVariable))
        return value
