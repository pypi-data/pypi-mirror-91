...
class ParametricStudyDOEResultVariable(_1125.ParetoOptimisationVariableBase):
    '''ParametricStudyDOEResultVariable
    ...
    @property
    def target(self) -> '_1127.PropertyTargetForDominantCandidateSearch':
    ...
    @target.setter
    def target(self, value: '_1127.PropertyTargetForDominantCandidateSearch'):
