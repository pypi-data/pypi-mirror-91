...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3579, _3578, _3577
...
class KlingelnbergCycloPalloidHypoidGearSetParametricStudyTool(_3577.KlingelnbergCycloPalloidConicalGearSetParametricStudyTool):
    '''KlingelnbergCycloPalloidHypoidGearSetParametricStudyTool
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_parametric_study_tool(self) -> 'List[_3579.KlingelnbergCycloPalloidHypoidGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidGearsParametricStudyTool, constructor.new(_3579.KlingelnbergCycloPalloidHypoidGearParametricStudyTool))
        return value

    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_parametric_study_tool(self) -> 'List[_3578.KlingelnbergCycloPalloidHypoidGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidMeshesParametricStudyTool, constructor.new(_3578.KlingelnbergCycloPalloidHypoidGearMeshParametricStudyTool))
        return value
