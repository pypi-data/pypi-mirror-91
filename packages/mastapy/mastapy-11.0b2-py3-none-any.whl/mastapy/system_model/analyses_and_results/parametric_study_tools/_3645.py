...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3644, _3643, _3524
...
class ZerolBevelGearSetParametricStudyTool(_3524.BevelGearSetParametricStudyTool):
    '''ZerolBevelGearSetParametricStudyTool
    ...
    @property
    def zerol_bevel_gears_parametric_study_tool(self) -> 'List[_3644.ZerolBevelGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsParametricStudyTool, constructor.new(_3644.ZerolBevelGearParametricStudyTool))
        return value

    @property
    def zerol_bevel_meshes_parametric_study_tool(self) -> 'List[_3643.ZerolBevelGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesParametricStudyTool, constructor.new(_3643.ZerolBevelGearMeshParametricStudyTool))
        return value
