...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3589, _3586
from mastapy._internal.implicit import list_with_selected_item
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.system_model.analyses_and_results import _2221
...
class ParametricStudyVariable(_2221.AnalysisCaseVariable):
    '''ParametricStudyVariable
    ...
    @property
    def dimension(self) -> '_3589.ParametricStudyDimension':
        ...
        return constructor.new(_3589.ParametricStudyDimension)(value) if value else None

    @dimension.setter
    def dimension(self, value: '_3589.ParametricStudyDimension'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.Dimension = value

    @property
    def distribution(self) -> '_3586.MonteCarloDistribution':
        ...
        return constructor.new(_3586.MonteCarloDistribution)(value) if value else None

    @distribution.setter
    def distribution(self, value: '_3586.MonteCarloDistribution'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
