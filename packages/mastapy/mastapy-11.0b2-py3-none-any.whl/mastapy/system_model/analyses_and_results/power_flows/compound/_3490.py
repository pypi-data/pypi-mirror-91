...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3484
...
class StraightBevelPlanetGearCompoundPowerFlow(_3484.StraightBevelDiffGearCompoundPowerFlow):
    '''StraightBevelPlanetGearCompoundPowerFlow
