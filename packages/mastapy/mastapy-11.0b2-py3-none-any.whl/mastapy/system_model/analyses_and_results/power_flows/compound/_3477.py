...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3387
...
class SpecialisedAssemblyCompoundPowerFlow(_3387.AbstractAssemblyCompoundPowerFlow):
    '''SpecialisedAssemblyCompoundPowerFlow
