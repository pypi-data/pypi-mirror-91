...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3478, _3479, _3403
...
class SpiralBevelGearSetCompoundPowerFlow(_3403.BevelGearSetCompoundPowerFlow):
    '''SpiralBevelGearSetCompoundPowerFlow
    ...
    @property
    def spiral_bevel_gears_compound_power_flow(self) -> 'List[_3478.SpiralBevelGearCompoundPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsCompoundPowerFlow, constructor.new(_3478.SpiralBevelGearCompoundPowerFlow))
        return value

    @property
    def spiral_bevel_meshes_compound_power_flow(self) -> 'List[_3479.SpiralBevelGearMeshCompoundPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesCompoundPowerFlow, constructor.new(_3479.SpiralBevelGearMeshCompoundPowerFlow))
        return value

    @property
    def load_case_analyses_ready(self) -> 'List[_3358.SpiralBevelGearSetPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3358.SpiralBevelGearSetPowerFlow))
        return value

    @property
    def assembly_power_flow_load_cases(self) -> 'List[_3358.SpiralBevelGearSetPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyPowerFlowLoadCases, constructor.new(_3358.SpiralBevelGearSetPowerFlow))
        return value
