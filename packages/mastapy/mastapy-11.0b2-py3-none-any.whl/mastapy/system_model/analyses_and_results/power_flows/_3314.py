...
from mastapy.system_model.analyses_and_results.power_flows import _3374, _3322
...
class GearMeshPowerFlow(_3322.InterMountableComponentConnectionPowerFlow):
    '''GearMeshPowerFlow
    ...
    @property
    def tooth_passing_harmonics(self) -> 'List[_3374.ToothPassingHarmonic]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ToothPassingHarmonics, constructor.new(_3374.ToothPassingHarmonic))
        return value
