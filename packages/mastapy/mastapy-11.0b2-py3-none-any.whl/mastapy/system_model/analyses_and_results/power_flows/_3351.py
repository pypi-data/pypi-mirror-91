...
from mastapy.system_model.analyses_and_results.power_flows import _3344, _3267
...
class RootAssemblyPowerFlow(_3267.AssemblyPowerFlow):
    '''RootAssemblyPowerFlow
    ...
    @property
    def power_flow_inputs(self) -> '_3344.PowerFlow':
        ...
        return constructor.new(_3344.PowerFlow)(self.wrapped.PowerFlowInputs) if self.wrapped.PowerFlowInputs else None
