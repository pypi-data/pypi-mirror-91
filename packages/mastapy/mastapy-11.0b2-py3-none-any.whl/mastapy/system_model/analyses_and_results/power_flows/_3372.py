...
from mastapy.system_model.analyses_and_results.power_flows import _3370, _3355
...
class SynchroniserPowerFlow(_3355.SpecialisedAssemblyPowerFlow):
    '''SynchroniserPowerFlow
    ...
    @property
    def cones(self) -> 'List[_3370.SynchroniserHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_3370.SynchroniserHalfPowerFlow))
        return value
