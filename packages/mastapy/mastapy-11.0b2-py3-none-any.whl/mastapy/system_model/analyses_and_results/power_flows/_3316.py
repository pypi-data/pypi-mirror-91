...
from mastapy.system_model.analyses_and_results.power_flows import _3314, _3315, _3355
...
class GearSetPowerFlow(_3355.SpecialisedAssemblyPowerFlow):
    '''GearSetPowerFlow
    ...
    @property
    def meshes_power_flow(self) -> 'List[_3314.GearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesPowerFlow, constructor.new(_3314.GearMeshPowerFlow))
        return value

    @property
    def gears_power_flow(self) -> 'List[_3315.GearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsPowerFlow, constructor.new(_3315.GearPowerFlow))
        return value
