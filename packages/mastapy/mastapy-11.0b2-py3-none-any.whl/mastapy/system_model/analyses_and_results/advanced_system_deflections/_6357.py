...
class MassDiscAdvancedSystemDeflection(_6404.VirtualComponentAdvancedSystemDeflection):
    '''MassDiscAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2331.MassDiscSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2331.MassDiscSystemDeflection))
        return value
