...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6356, _6378
...
class GearSetAdvancedSystemDeflection(_6378.SpecialisedAssemblyAdvancedSystemDeflection):
    '''GearSetAdvancedSystemDeflection
    ...
    @property
    def use_ltca_in_advanced_system_deflection(self) -> '_6356.UseLtcaInAsdOption':
        ...
        return constructor.new(_6356.UseLtcaInAsdOption)(value) if value else None

    @use_ltca_in_advanced_system_deflection.setter
    def use_ltca_in_advanced_system_deflection(self, value: '_6356.UseLtcaInAsdOption'):
