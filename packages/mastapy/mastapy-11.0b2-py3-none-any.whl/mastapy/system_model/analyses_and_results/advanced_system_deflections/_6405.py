...
class WormGearAdvancedSystemDeflection(_6338.GearAdvancedSystemDeflection):
    '''WormGearAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2387.WormGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2387.WormGearSystemDeflection))
        return value
