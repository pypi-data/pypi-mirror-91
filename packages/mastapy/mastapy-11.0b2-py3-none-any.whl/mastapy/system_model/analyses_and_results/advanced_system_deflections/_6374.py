...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6284, _6290
...
class RootAssemblyAdvancedSystemDeflection(_6290.AssemblyAdvancedSystemDeflection):
    '''RootAssemblyAdvancedSystemDeflection
    ...
    @property
    def advanced_system_deflection_inputs(self) -> '_6284.AdvancedSystemDeflection':
        ...
        return constructor.new(_6284.AdvancedSystemDeflection)(self.wrapped.AdvancedSystemDeflectionInputs) if self.wrapped.AdvancedSystemDeflectionInputs else None
