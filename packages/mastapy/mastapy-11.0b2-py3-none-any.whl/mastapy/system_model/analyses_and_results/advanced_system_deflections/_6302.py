...
class BoltAdvancedSystemDeflection(_6308.ComponentAdvancedSystemDeflection):
    '''BoltAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2269.BoltSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2269.BoltSystemDeflection))
        return value
