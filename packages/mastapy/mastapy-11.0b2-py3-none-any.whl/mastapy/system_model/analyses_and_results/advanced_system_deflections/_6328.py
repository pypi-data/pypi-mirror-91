...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6327, _6339
...
class CylindricalGearMeshAdvancedSystemDeflection(_6339.GearMeshAdvancedSystemDeflection):
    '''CylindricalGearMeshAdvancedSystemDeflection
    ...
    @property
    def contact_chart_max_pressure_gear_a(self) -> '_6555.SMTBitmap':
        ...
        return constructor.new(_6555.SMTBitmap)(self.wrapped.ContactChartMaxPressureGearA) if self.wrapped.ContactChartMaxPressureGearA else None
    ...
    @property
    def contact_chart_max_pressure_gear_b(self) -> '_6555.SMTBitmap':
        ...
        return constructor.new(_6555.SMTBitmap)(self.wrapped.ContactChartMaxPressureGearB) if self.wrapped.ContactChartMaxPressureGearB else None
    ...
    @property
    def contact_chart_gap_to_loaded_flank_gear_a(self) -> '_6555.SMTBitmap':
        ...
        return constructor.new(_6555.SMTBitmap)(self.wrapped.ContactChartGapToLoadedFlankGearA) if self.wrapped.ContactChartGapToLoadedFlankGearA else None
    ...
    @property
    def contact_chart_gap_to_loaded_flank_gear_b(self) -> '_6555.SMTBitmap':
        ...
        return constructor.new(_6555.SMTBitmap)(self.wrapped.ContactChartGapToLoadedFlankGearB) if self.wrapped.ContactChartGapToLoadedFlankGearB else None
    ...
    @property
    def contact_chart_gap_to_unloaded_flank_gear_a(self) -> '_6555.SMTBitmap':
        ...
        return constructor.new(_6555.SMTBitmap)(self.wrapped.ContactChartGapToUnloadedFlankGearA) if self.wrapped.ContactChartGapToUnloadedFlankGearA else None
    ...
    @property
    def contact_chart_gap_to_unloaded_flank_gear_b(self) -> '_6555.SMTBitmap':
        ...
        return constructor.new(_6555.SMTBitmap)(self.wrapped.ContactChartGapToUnloadedFlankGearB) if self.wrapped.ContactChartGapToUnloadedFlankGearB else None
    ...
    @property
    def transmission_error_fourier_series_for_first_tooth_passing_period(self) -> '_1086.FourierSeries':
        ...
        return constructor.new(_1086.FourierSeries)(self.wrapped.TransmissionErrorFourierSeriesForFirstToothPassingPeriod) if self.wrapped.TransmissionErrorFourierSeriesForFirstToothPassingPeriod else None
    ...
    @property
    def cylindrical_gear_mesh_system_deflection_results(self) -> 'List[_2295.CylindricalGearMeshSystemDeflectionTimestep]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearMeshSystemDeflectionResults, constructor.new(_2295.CylindricalGearMeshSystemDeflectionTimestep))
        return value
    ...
    @property
    def cylindrical_gear_advanced_analyses(self) -> 'List[_6327.CylindricalGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearAdvancedAnalyses, constructor.new(_6327.CylindricalGearAdvancedSystemDeflection))
        return value
