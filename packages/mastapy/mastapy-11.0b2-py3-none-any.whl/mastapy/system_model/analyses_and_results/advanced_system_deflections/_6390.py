...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6388, _6389, _6301
...
class StraightBevelGearSetAdvancedSystemDeflection(_6301.BevelGearSetAdvancedSystemDeflection):
    '''StraightBevelGearSetAdvancedSystemDeflection
    ...
    @property
    def straight_bevel_gears_advanced_system_deflection(self) -> 'List[_6388.StraightBevelGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsAdvancedSystemDeflection, constructor.new(_6388.StraightBevelGearAdvancedSystemDeflection))
        return value

    @property
    def straight_bevel_meshes_advanced_system_deflection(self) -> 'List[_6389.StraightBevelGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesAdvancedSystemDeflection, constructor.new(_6389.StraightBevelGearMeshAdvancedSystemDeflection))
        return value
