...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6342, _6343, _6289
...
class HypoidGearSetAdvancedSystemDeflection(_6289.AGMAGleasonConicalGearSetAdvancedSystemDeflection):
    '''HypoidGearSetAdvancedSystemDeflection
    ...
    @property
    def hypoid_gears_advanced_system_deflection(self) -> 'List[_6342.HypoidGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsAdvancedSystemDeflection, constructor.new(_6342.HypoidGearAdvancedSystemDeflection))
        return value

    @property
    def hypoid_meshes_advanced_system_deflection(self) -> 'List[_6343.HypoidGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesAdvancedSystemDeflection, constructor.new(_6343.HypoidGearMeshAdvancedSystemDeflection))
        return value
