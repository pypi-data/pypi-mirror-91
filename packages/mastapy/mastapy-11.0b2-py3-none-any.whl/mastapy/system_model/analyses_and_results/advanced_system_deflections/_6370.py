...
class PulleyAdvancedSystemDeflection(_6323.CouplingHalfAdvancedSystemDeflection):
    '''PulleyAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2345.PulleySystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2345.PulleySystemDeflection))
        return value
