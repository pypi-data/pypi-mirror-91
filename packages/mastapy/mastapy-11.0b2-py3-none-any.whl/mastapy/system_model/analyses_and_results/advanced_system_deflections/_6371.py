...
class RollingRingAdvancedSystemDeflection(_6323.CouplingHalfAdvancedSystemDeflection):
    '''RollingRingAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2348.RollingRingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2348.RollingRingSystemDeflection))
        return value
