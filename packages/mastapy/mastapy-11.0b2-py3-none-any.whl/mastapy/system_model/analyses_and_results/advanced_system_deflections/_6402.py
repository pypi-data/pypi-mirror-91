...
class UnbalancedMassAdvancedSystemDeflection(_6404.VirtualComponentAdvancedSystemDeflection):
    '''UnbalancedMassAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2383.UnbalancedMassSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2383.UnbalancedMassSystemDeflection))
        return value
