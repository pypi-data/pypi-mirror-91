...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5135, _5040
...
class TorqueConverterConnectionMultibodyDynamicsAnalysis(_5040.CouplingConnectionMultibodyDynamicsAnalysis):
    '''TorqueConverterConnectionMultibodyDynamicsAnalysis
    ...
    @property
    def locking_status(self) -> '_5135.TorqueConverterStatus':
        ...
        return constructor.new(_5135.TorqueConverterStatus)(value) if value else None
