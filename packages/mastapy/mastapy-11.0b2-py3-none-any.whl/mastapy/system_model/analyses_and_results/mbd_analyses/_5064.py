...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5063, _5061, _5112
...
class GearSetMultibodyDynamicsAnalysis(_5112.SpecialisedAssemblyMultibodyDynamicsAnalysis):
    '''GearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5063.GearMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_5063.GearMultibodyDynamicsAnalysis))
        return value

    @property
    def meshes(self) -> 'List[_5061.GearMeshMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_5061.GearMeshMultibodyDynamicsAnalysis))
        return value
