...
class GuideDxfModelCompoundMultibodyDynamicsAnalysis(_5177.ComponentCompoundMultibodyDynamicsAnalysis):
    '''GuideDxfModelCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5065.GuideDxfModelMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5065.GuideDxfModelMultibodyDynamicsAnalysis))
        return value

    @property
    def component_multibody_dynamics_analysis_load_cases(self) -> 'List[_5065.GuideDxfModelMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentMultibodyDynamicsAnalysisLoadCases, constructor.new(_5065.GuideDxfModelMultibodyDynamicsAnalysis))
        return value
