...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5214, _5215, _5158
...
class HypoidGearSetCompoundMultibodyDynamicsAnalysis(_5158.AGMAGleasonConicalGearSetCompoundMultibodyDynamicsAnalysis):
    '''HypoidGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def hypoid_gears_compound_multibody_dynamics_analysis(self) -> 'List[_5214.HypoidGearCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def hypoid_meshes_compound_multibody_dynamics_analysis(self) -> 'List[_5215.HypoidGearMeshCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5068.HypoidGearSetMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5068.HypoidGearSetMultibodyDynamicsAnalysis))
        return value

    @property
    def assembly_multibody_dynamics_analysis_load_cases(self) -> 'List[_5068.HypoidGearSetMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyMultibodyDynamicsAnalysisLoadCases, constructor.new(_5068.HypoidGearSetMultibodyDynamicsAnalysis))
        return value
