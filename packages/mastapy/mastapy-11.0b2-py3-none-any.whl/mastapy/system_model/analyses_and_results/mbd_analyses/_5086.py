...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5072, _5111, _5106
...
class MBDRunUpAnalysisOptions(_7133.AbstractAnalysisOptions['_6570.TimeSeriesLoadCase']):
    '''MBDRunUpAnalysisOptions
    ...
    @property
    def input_velocity_processing_type(self) -> '_5072.InputVelocityForRunUpProcessingType':
        ...
        return constructor.new(_5072.InputVelocityForRunUpProcessingType)(value) if value else None

    @input_velocity_processing_type.setter
    def input_velocity_processing_type(self, value: '_5072.InputVelocityForRunUpProcessingType'):
    ...
    @property
    def shape_of_initial_acceleration_period(self) -> '_5111.ShapeOfInitialAccelerationPeriodForRunUp':
        ...
        return constructor.new(_5111.ShapeOfInitialAccelerationPeriodForRunUp)(value) if value else None

    @shape_of_initial_acceleration_period.setter
    def shape_of_initial_acceleration_period(self, value: '_5111.ShapeOfInitialAccelerationPeriodForRunUp'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ShapeOfInitialAccelerationPeriod = value

    @property
    def run_up_driving_mode(self) -> '_5106.RunUpDrivingMode':
        ...
        return constructor.new(_5106.RunUpDrivingMode)(value) if value else None

    @run_up_driving_mode.setter
    def run_up_driving_mode(self, value: '_5106.RunUpDrivingMode'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
