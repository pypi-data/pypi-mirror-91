...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5148, _5150
...
class ShaftHubConnectionMultibodyDynamicsAnalysis(_5039.ConnectorMultibodyDynamicsAnalysis):
    '''ShaftHubConnectionMultibodyDynamicsAnalysis
    ...
    @property
    def peak_dynamic_force_angular(self) -> '_5150.DynamicTorqueVector3DResult':
        ...
        return constructor.new(_5150.DynamicTorqueVector3DResult)(self.wrapped.PeakDynamicForceAngular) if self.wrapped.PeakDynamicForceAngular else None
