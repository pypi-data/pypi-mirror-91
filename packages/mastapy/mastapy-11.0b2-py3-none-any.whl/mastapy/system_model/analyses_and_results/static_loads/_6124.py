...
class ConceptCouplingLoadCase(_6137.CouplingLoadCase):
    '''ConceptCouplingLoadCase
    ...
    @property
    def speed_ratio_specification_method(self) -> '_1834.ConceptCouplingSpeedRatioSpecificationMethod':
        ...
        return constructor.new(_1834.ConceptCouplingSpeedRatioSpecificationMethod)(value) if value else None

    @speed_ratio_specification_method.setter
    def speed_ratio_specification_method(self, value: '_1834.ConceptCouplingSpeedRatioSpecificationMethod'):
    ...
    @property
    def speed_ratio_pid_control(self) -> '_1142.PIDControlSettings':
        ...
        return constructor.new(_1142.PIDControlSettings)(self.wrapped.SpeedRatioPIDControl) if self.wrapped.SpeedRatioPIDControl else None
