...
from mastapy.system_model.analyses_and_results.static_loads import _6171, _6176
...
class GearSetHarmonicLoadData(_6176.HarmonicLoadDataBase):
    '''GearSetHarmonicLoadData
    ...
    @property
    def gear_mesh_te_order_type(self) -> '_6171.GearMeshTEOrderType':
        ...
        return constructor.new(_6171.GearMeshTEOrderType)(value) if value else None

    @gear_mesh_te_order_type.setter
    def gear_mesh_te_order_type(self, value: '_6171.GearMeshTEOrderType'):
