...
from mastapy.system_model.analyses_and_results.static_loads import _6131, _6173
...
class ConicalGearSetLoadCase(_6173.GearSetLoadCase):
    '''ConicalGearSetLoadCase
    ...
    def get_harmonic_load_data_for_import(self) -> '_6131.ConicalGearSetHarmonicLoadData':
