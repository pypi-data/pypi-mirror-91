...
from mastapy.system_model.analyses_and_results.static_loads import _6140, _6106
...
class CVTLoadCase(_6106.BeltDriveLoadCase):
    '''CVTLoadCase
    ...
    @property
    def pulleys(self) -> 'List[_6140.CVTPulleyLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_6140.CVTPulleyLoadCase))
        return value
