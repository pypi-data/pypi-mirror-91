...
from mastapy.system_model.analyses_and_results.static_loads import _6182, _6178, _6159
...
class HarmonicLoadDataImportFromMotorPackages(_6178.HarmonicLoadDataImportBase['T'], Generic[T]):
    '''HarmonicLoadDataImportFromMotorPackages
