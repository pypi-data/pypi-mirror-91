...
from mastapy.system_model.analyses_and_results.static_loads import _6235, _6236, _6114
...
class StraightBevelDiffGearSetLoadCase(_6114.BevelGearSetLoadCase):
    '''StraightBevelDiffGearSetLoadCase
    ...
    @property
    def straight_bevel_diff_gears_load_case(self) -> 'List[_6235.StraightBevelDiffGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsLoadCase, constructor.new(_6235.StraightBevelDiffGearLoadCase))
        return value

    @property
    def straight_bevel_diff_meshes_load_case(self) -> 'List[_6236.StraightBevelDiffGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesLoadCase, constructor.new(_6236.StraightBevelDiffGearMeshLoadCase))
        return value
