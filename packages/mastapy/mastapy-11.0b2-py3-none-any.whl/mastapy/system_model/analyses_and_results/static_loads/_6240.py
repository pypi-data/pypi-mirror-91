...
from mastapy.system_model.analyses_and_results.static_loads import _6238, _6239, _6114
...
class StraightBevelGearSetLoadCase(_6114.BevelGearSetLoadCase):
    '''StraightBevelGearSetLoadCase
    ...
    @property
    def straight_bevel_gears_load_case(self) -> 'List[_6238.StraightBevelGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsLoadCase, constructor.new(_6238.StraightBevelGearLoadCase))
        return value

    @property
    def straight_bevel_meshes_load_case(self) -> 'List[_6239.StraightBevelGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesLoadCase, constructor.new(_6239.StraightBevelGearMeshLoadCase))
        return value
