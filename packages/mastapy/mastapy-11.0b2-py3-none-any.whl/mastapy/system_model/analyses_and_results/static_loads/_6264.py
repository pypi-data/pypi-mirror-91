...
from mastapy.system_model.analyses_and_results.static_loads import _6262, _6263, _6114
...
class ZerolBevelGearSetLoadCase(_6114.BevelGearSetLoadCase):
    '''ZerolBevelGearSetLoadCase
    ...
    @property
    def zerol_bevel_gears_load_case(self) -> 'List[_6262.ZerolBevelGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsLoadCase, constructor.new(_6262.ZerolBevelGearLoadCase))
        return value

    @property
    def zerol_bevel_meshes_load_case(self) -> 'List[_6263.ZerolBevelGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesLoadCase, constructor.new(_6263.ZerolBevelGearMeshLoadCase))
        return value
