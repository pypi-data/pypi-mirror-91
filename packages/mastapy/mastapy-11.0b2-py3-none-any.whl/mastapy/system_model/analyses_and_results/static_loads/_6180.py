...
from mastapy.system_model.analyses_and_results.static_loads import _6148, _6179, _6160
...
class HarmonicLoadDataJMAGImport(_6179.HarmonicLoadDataImportFromMotorPackages['_6160.ElectricMachineHarmonicLoadJMAGImportOptions']):
    '''HarmonicLoadDataJMAGImport
    ...
    @property
    def electric_machine_data_per_speed(self) -> 'List[_6148.DataFromJMAGPerSpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElectricMachineDataPerSpeed, constructor.new(_6148.DataFromJMAGPerSpeed))
        return value
