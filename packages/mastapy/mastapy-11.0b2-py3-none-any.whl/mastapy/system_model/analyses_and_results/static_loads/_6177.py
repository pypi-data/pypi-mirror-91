...
from mastapy.system_model.analyses_and_results.static_loads import _6202, _6178, _6158
...
class HarmonicLoadDataExcelImport(_6178.HarmonicLoadDataImportBase['_6158.ElectricMachineHarmonicLoadExcelImportOptions']):
    '''HarmonicLoadDataExcelImport
    ...
    @property
    def speeds(self) -> 'List[_6202.NamedSpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Speeds, constructor.new(_6202.NamedSpeed))
        return value
