...
from mastapy.system_model import _1844, _1845, _1846
from mastapy.system_model.analyses_and_results.mbd_analyses import _5144
from mastapy.system_model.analyses_and_results.static_loads import _6254, _6153, _6258
from mastapy.system_model.imported_fes import _1965
from mastapy.system_model.part_model import _2056
from mastapy.math_utility.control import _1142
from mastapy.nodal_analysis.varying_input_components import _1418
...
class PowerLoadLoadCase(_6258.VirtualComponentLoadCase):
    '''PowerLoadLoadCase
    ...
    @property
    def drag_torque_specification_method(self) -> '_1844.PowerLoadDragTorqueSpecificationMethod':
        ...
        return constructor.new(_1844.PowerLoadDragTorqueSpecificationMethod)(value) if value else None

    @drag_torque_specification_method.setter
    def drag_torque_specification_method(self, value: '_1844.PowerLoadDragTorqueSpecificationMethod'):
    ...
    @property
    def wheel_slip_model(self) -> '_5144.WheelSlipType':
        ...
        return constructor.new(_5144.WheelSlipType)(value) if value else None

    @wheel_slip_model.setter
    def wheel_slip_model(self, value: '_5144.WheelSlipType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def target_speed_input_type(self) -> '_1846.PowerLoadPIDControlSpeedInputType':
        ...
        return constructor.new(_1846.PowerLoadPIDControlSpeedInputType)(value) if value else None

    @target_speed_input_type.setter
    def target_speed_input_type(self, value: '_1846.PowerLoadPIDControlSpeedInputType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def engine_idle_speed_control_pid_settings(self) -> '_1142.PIDControlSettings':
        ...
        return constructor.new(_1142.PIDControlSettings)(self.wrapped.EngineIdleSpeedControlPIDSettings) if self.wrapped.EngineIdleSpeedControlPIDSettings else None

    @property
    def coefficient_of_friction_with_ground(self) -> '_1418.NonDimensionalInputComponent':
        ...
        return constructor.new(_1418.NonDimensionalInputComponent)(self.wrapped.CoefficientOfFrictionWithGround) if self.wrapped.CoefficientOfFrictionWithGround else None

    @property
    def pid_control_settings(self) -> '_1142.PIDControlSettings':
        ...
        return constructor.new(_1142.PIDControlSettings)(self.wrapped.PIDControlSettings) if self.wrapped.PIDControlSettings else None

    def get_harmonic_load_data_for_import(self) -> '_6153.ElectricMachineHarmonicLoadData':
