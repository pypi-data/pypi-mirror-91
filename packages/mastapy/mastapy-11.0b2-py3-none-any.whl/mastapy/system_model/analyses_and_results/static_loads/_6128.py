...
from mastapy.system_model.analyses_and_results.static_loads import _6129, _6168
...
class ConicalGearLoadCase(_6168.GearLoadCase):
    '''ConicalGearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6129.ConicalGearManufactureError':
        ...
        return constructor.new(_6129.ConicalGearManufactureError)(self.wrapped.GearManufactureErrors) if self.wrapped.GearManufactureErrors else None
