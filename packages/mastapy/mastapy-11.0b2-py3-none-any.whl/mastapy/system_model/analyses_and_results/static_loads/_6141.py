...
from mastapy.system_model.analyses_and_results.static_loads import _6142, _6168
...
class CylindricalGearLoadCase(_6168.GearLoadCase):
    '''CylindricalGearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6142.CylindricalGearManufactureError':
        ...
        return constructor.new(_6142.CylindricalGearManufactureError)(self.wrapped.GearManufactureErrors) if self.wrapped.GearManufactureErrors else None
