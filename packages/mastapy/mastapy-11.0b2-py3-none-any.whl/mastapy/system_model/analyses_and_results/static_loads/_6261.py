...
from mastapy.system_model.analyses_and_results.static_loads import _6259, _6260, _6173
...
class WormGearSetLoadCase(_6173.GearSetLoadCase):
    '''WormGearSetLoadCase
    ...
    @property
    def worm_gears_load_case(self) -> 'List[_6259.WormGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsLoadCase, constructor.new(_6259.WormGearLoadCase))
        return value

    @property
    def worm_meshes_load_case(self) -> 'List[_6260.WormGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesLoadCase, constructor.new(_6260.WormGearMeshLoadCase))
        return value
