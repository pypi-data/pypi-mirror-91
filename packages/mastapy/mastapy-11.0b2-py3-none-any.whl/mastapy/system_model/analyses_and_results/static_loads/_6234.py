...
from mastapy.system_model.analyses_and_results import _2250
...
class StaticLoadCase(_6095.LoadCase):
    '''StaticLoadCase
    ...
    @property
    def te_set_up_for_dynamic_analyses_options(self) -> '_2250.TESetUpForDynamicAnalysisOptions':
        ...
        return constructor.new(_2250.TESetUpForDynamicAnalysisOptions)(self.wrapped.TESetUpForDynamicAnalysesOptions) if self.wrapped.TESetUpForDynamicAnalysesOptions else None

    @property
    def gear_whine_harmonic_excitation_analysis_options(self) -> '_5372.GearWhineAnalysisOptions':
        ...
        return constructor.new(_5372.GearWhineAnalysisOptions)(self.wrapped.GearWhineHarmonicExcitationAnalysisOptions) if self.wrapped.GearWhineHarmonicExcitationAnalysisOptions else None
