...
from mastapy.nodal_analysis.varying_input_components import _1416, _1417
from mastapy.system_model.analyses_and_results.static_loads import _6214, _6258
...
class PointLoadLoadCase(_6258.VirtualComponentLoadCase):
    '''PointLoadLoadCase
    ...
    @property
    def force_x(self) -> '_1416.ForceInputComponent':
        ...
        return constructor.new(_1416.ForceInputComponent)(self.wrapped.ForceX) if self.wrapped.ForceX else None

    @property
    def force_y(self) -> '_1416.ForceInputComponent':
        ...
        return constructor.new(_1416.ForceInputComponent)(self.wrapped.ForceY) if self.wrapped.ForceY else None

    @property
    def axial_load(self) -> '_1416.ForceInputComponent':
        ...
        return constructor.new(_1416.ForceInputComponent)(self.wrapped.AxialLoad) if self.wrapped.AxialLoad else None

    @property
    def moment_x(self) -> '_1417.MomentInputComponent':
        ...
        return constructor.new(_1417.MomentInputComponent)(self.wrapped.MomentX) if self.wrapped.MomentX else None

    @property
    def moment_y(self) -> '_1417.MomentInputComponent':
        ...
        return constructor.new(_1417.MomentInputComponent)(self.wrapped.MomentY) if self.wrapped.MomentY else None

    @property
    def moment_z(self) -> '_1417.MomentInputComponent':
        ...
        return constructor.new(_1417.MomentInputComponent)(self.wrapped.MomentZ) if self.wrapped.MomentZ else None

    def get_harmonic_load_data_for_import(self) -> '_6214.PointLoadHarmonicLoadData':
