...
from mastapy.system_model.analyses_and_results.static_loads import _6153, _6159
...
T = TypeVar('T', bound='_6159.ElectricMachineHarmonicLoadImportOptionsBase')


class ElectricMachineHarmonicLoadDataFromMotorPackages(_6153.ElectricMachineHarmonicLoadData, Generic[T]):
    '''ElectricMachineHarmonicLoadDataFromMotorPackages
