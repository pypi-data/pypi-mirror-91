...
from mastapy.system_model.analyses_and_results.static_loads import _6211, _6201
...
class PlanetCarrierLoadCase(_6201.MountableComponentLoadCase):
    '''PlanetCarrierLoadCase
    ...
    @property
    def planet_manufacture_errors(self) -> 'List[_6211.PlanetarySocketManufactureError]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetManufactureErrors, constructor.new(_6211.PlanetarySocketManufactureError))
        return value
