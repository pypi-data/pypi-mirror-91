...
class GearLoadCase(_6201.MountableComponentLoadCase):
    '''GearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6169.GearManufactureError':
        ...
        if _6169.GearManufactureError.TYPE not in self.wrapped.GearManufactureErrors.__class__.__mro__:
    ...
    @property
    def gear_manufacture_errors_of_type_conical_gear_manufacture_error(self) -> '_6129.ConicalGearManufactureError':
        ...
        if _6129.ConicalGearManufactureError.TYPE not in self.wrapped.GearManufactureErrors.__class__.__mro__:
    ...
    @property
    def gear_manufacture_errors_of_type_cylindrical_gear_manufacture_error(self) -> '_6142.CylindricalGearManufactureError':
        ...
        if _6142.CylindricalGearManufactureError.TYPE not in self.wrapped.GearManufactureErrors.__class__.__mro__:
