...
from mastapy.nodal_analysis.varying_input_components import _1416, _1415, _1420
from mastapy.math_utility.control import _1142
from mastapy.system_model.analyses_and_results.static_loads import _6234, _6145, _6103
...
class RootAssemblyLoadCase(_6103.AssemblyLoadCase):
    '''RootAssemblyLoadCase
    ...
    @property
    def brake_force_input_values(self) -> '_1416.ForceInputComponent':
        ...
        return constructor.new(_1416.ForceInputComponent)(self.wrapped.BrakeForceInputValues) if self.wrapped.BrakeForceInputValues else None

    @property
    def road_incline_input_values(self) -> '_1415.AngleInputComponent':
        ...
        return constructor.new(_1415.AngleInputComponent)(self.wrapped.RoadInclineInputValues) if self.wrapped.RoadInclineInputValues else None

    @property
    def drive_cycle_pid_control_settings(self) -> '_1142.PIDControlSettings':
        ...
        return constructor.new(_1142.PIDControlSettings)(self.wrapped.DriveCyclePIDControlSettings) if self.wrapped.DriveCyclePIDControlSettings else None

    @property
    def target_vehicle_speed(self) -> '_1420.VelocityInputComponent':
        ...
        return constructor.new(_1420.VelocityInputComponent)(self.wrapped.TargetVehicleSpeed) if self.wrapped.TargetVehicleSpeed else None
    ...
    @property
    def supercharger_rotor_sets(self) -> 'List[_6145.CylindricalGearSetLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SuperchargerRotorSets, constructor.new(_6145.CylindricalGearSetLoadCase))
        return value
