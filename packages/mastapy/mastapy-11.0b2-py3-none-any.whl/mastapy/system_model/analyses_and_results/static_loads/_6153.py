...
from mastapy.system_model.analyses_and_results.static_loads import _6253, _6182, _6227
...
class ElectricMachineHarmonicLoadData(_6227.SpeedDependentHarmonicLoadData):
    '''ElectricMachineHarmonicLoadData
    ...
    @property
    def force_distribution(self) -> '_6555.SMTBitmap':
        ...
        return constructor.new(_6555.SMTBitmap)(self.wrapped.ForceDistribution) if self.wrapped.ForceDistribution else None
