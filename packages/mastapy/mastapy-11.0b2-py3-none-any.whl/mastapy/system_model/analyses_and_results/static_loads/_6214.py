...
from mastapy.math_utility import _1078, _1086
...
class PointLoadHarmonicLoadData(_6227.SpeedDependentHarmonicLoadData):
    '''PointLoadHarmonicLoadData
    ...
    @property
    def degree_of_freedom(self) -> '_1078.DegreesOfFreedom':
        ...
        return constructor.new(_1078.DegreesOfFreedom)(value) if value else None

    @degree_of_freedom.setter
    def degree_of_freedom(self, value: '_1078.DegreesOfFreedom'):
