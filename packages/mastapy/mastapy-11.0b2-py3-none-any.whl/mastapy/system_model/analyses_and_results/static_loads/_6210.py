...
class PlanetaryGearSetLoadCase(_6145.CylindricalGearSetLoadCase):
    '''PlanetaryGearSetLoadCase
    ...
    @property
    def include_gear_blank_elastic_distortion(self) -> '_1154.LoadCaseOverrideOption':
    ...
    def include_gear_blank_elastic_distortion(self, value: '_1154.LoadCaseOverrideOption'):
