...
from mastapy.system_model.analyses_and_results.static_loads import _6264, _6265, _6116
...
class ZerolBevelGearSetLoadCase(_6116.BevelGearSetLoadCase):
    '''ZerolBevelGearSetLoadCase
    ...
    @property
    def zerol_bevel_gears_load_case(self) -> 'List[_6264.ZerolBevelGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsLoadCase, constructor.new(_6264.ZerolBevelGearLoadCase))
        return value

    @property
    def zerol_bevel_meshes_load_case(self) -> 'List[_6265.ZerolBevelGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesLoadCase, constructor.new(_6265.ZerolBevelGearMeshLoadCase))
        return value
