...
from mastapy.system_model.analyses_and_results.static_loads import _6183, _6184, _6101
...
class HypoidGearSetLoadCase(_6101.AGMAGleasonConicalGearSetLoadCase):
    '''HypoidGearSetLoadCase
    ...
    @property
    def hypoid_gears_load_case(self) -> 'List[_6183.HypoidGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsLoadCase, constructor.new(_6183.HypoidGearLoadCase))
        return value

    @property
    def hypoid_meshes_load_case(self) -> 'List[_6184.HypoidGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesLoadCase, constructor.new(_6184.HypoidGearMeshLoadCase))
        return value
