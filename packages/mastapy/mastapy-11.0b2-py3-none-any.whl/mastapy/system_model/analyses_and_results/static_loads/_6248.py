...
class TimeSeriesLoadCase(_6095.LoadCase):
    '''TimeSeriesLoadCase
    ...
    @property
    def driva_analysis_options(self) -> '_5091.MBDAnalysisOptions':
        ...
        return constructor.new(_5091.MBDAnalysisOptions)(self.wrapped.DRIVAAnalysisOptions) if self.wrapped.DRIVAAnalysisOptions else None
