...
from mastapy.system_model.imported_fes import _1952, _1976
...
class ImportedFEComponentLoadCase(_6097.AbstractShaftOrHousingLoadCase):
    '''ImportedFEComponentLoadCase
    ...
    @property
    def angle_source(self) -> '_1952.AngleSource':
        ...
        return constructor.new(_1952.AngleSource)(value) if value else None
