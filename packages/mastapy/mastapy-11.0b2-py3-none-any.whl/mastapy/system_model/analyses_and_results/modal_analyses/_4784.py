...
from mastapy.system_model.analyses_and_results.modal_analyses import _4783, _4782, _4724
...
class HypoidGearSetModalAnalysis(_4724.AGMAGleasonConicalGearSetModalAnalysis):
    ...
    @property
    def hypoid_gears_modal_analysis(self) -> 'List[_4783.HypoidGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsModalAnalysis, constructor.new(_4783.HypoidGearModalAnalysis))
        return value

    @property
    def hypoid_meshes_modal_analysis(self) -> 'List[_4782.HypoidGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesModalAnalysis, constructor.new(_4782.HypoidGearMeshModalAnalysis))
        return value
