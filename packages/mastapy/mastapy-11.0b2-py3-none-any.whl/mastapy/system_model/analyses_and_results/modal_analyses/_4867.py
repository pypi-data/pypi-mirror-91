...
class VirtualComponentModalAnalysis(_4822.MountableComponentModalAnalysis):
    '''VirtualComponentModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2384.VirtualComponentSystemDeflection':
