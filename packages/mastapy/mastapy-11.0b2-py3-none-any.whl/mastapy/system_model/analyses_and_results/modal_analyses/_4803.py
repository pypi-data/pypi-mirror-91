...
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4870, _4867, _4869
...
class PartModalAnalysis(_7145.PartStaticLoadAnalysisCase):
    '''PartModalAnalysis
    ...
    @property
    def results_for_modes(self) -> 'List[_4870.SingleModeResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ResultsForModes, constructor.new(_4870.SingleModeResults))
        return value

    @property
    def shaft_excitation_details(self) -> 'List[_4867.RigidlyConnectedDesignEntityGroupModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftExcitationDetails, constructor.new(_4867.RigidlyConnectedDesignEntityGroupModalAnalysis))
        return value

    @property
    def gear_mesh_excitation_details(self) -> 'List[_4867.RigidlyConnectedDesignEntityGroupModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshExcitationDetails, constructor.new(_4867.RigidlyConnectedDesignEntityGroupModalAnalysis))
        return value
