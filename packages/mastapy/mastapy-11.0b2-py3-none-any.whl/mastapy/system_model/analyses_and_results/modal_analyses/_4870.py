...
TMeasurement = TypeVar('TMeasurement', bound='_1167.MeasurementBase')


class WhineWaterfallReferenceValues(_4871.WhineWaterfallReferenceValuesBase, Generic[TMeasurement]):
    '''WhineWaterfallReferenceValues
