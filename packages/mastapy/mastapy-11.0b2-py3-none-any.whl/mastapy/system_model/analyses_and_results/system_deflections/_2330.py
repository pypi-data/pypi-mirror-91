...
class AGMAGleasonConicalGearSetSystemDeflection(_2360.ConicalGearSetSystemDeflection):
    '''AGMAGleasonConicalGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3669.AGMAGleasonConicalGearSetPowerFlow':
