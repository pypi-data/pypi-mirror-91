...
class ExternalCADModelSystemDeflection(_2274.ComponentSystemDeflection):
    '''ExternalCADModelSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3309.ExternalCADModelPowerFlow':
        ...
        return constructor.new(_3309.ExternalCADModelPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
