...
class ClutchConnectionSystemDeflection(_2288.CouplingConnectionSystemDeflection):
    '''ClutchConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3281.ClutchConnectionPowerFlow':
        ...
        return constructor.new(_3281.ClutchConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
