...
class ClutchConnectionSystemDeflection(_2364.CouplingConnectionSystemDeflection):
    '''ClutchConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3684.ClutchConnectionPowerFlow':
        ...
        return constructor.new(_3684.ClutchConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
