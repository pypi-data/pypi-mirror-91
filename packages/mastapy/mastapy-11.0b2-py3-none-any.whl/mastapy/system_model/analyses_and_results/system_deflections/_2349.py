...
from mastapy.system_model.analyses_and_results.power_flows import _3687, _3707
...
class CoaxialConnectionSystemDeflection(_2438.ShaftToMountableComponentConnectionSystemDeflection):
    '''CoaxialConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3687.CoaxialConnectionPowerFlow':
