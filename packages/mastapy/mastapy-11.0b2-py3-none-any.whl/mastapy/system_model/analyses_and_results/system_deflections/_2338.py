...
from mastapy.system_model.analyses_and_results.power_flows import _3675, _3677, _3678
...
class BevelDifferentialGearSystemDeflection(_2343.BevelGearSystemDeflection):
    '''BevelDifferentialGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3675.BevelDifferentialGearPowerFlow':
