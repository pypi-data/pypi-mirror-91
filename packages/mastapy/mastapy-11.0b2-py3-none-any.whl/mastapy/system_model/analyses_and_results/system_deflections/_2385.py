...
class ExternalCADModelSystemDeflection(_2350.ComponentSystemDeflection):
    '''ExternalCADModelSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3716.ExternalCADModelPowerFlow':
        ...
        return constructor.new(_3716.ExternalCADModelPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
