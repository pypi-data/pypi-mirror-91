...
class KlingelnbergCycloPalloidConicalGearSetSystemDeflection(_2284.ConicalGearSetSystemDeflection):
    '''KlingelnbergCycloPalloidConicalGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3325.KlingelnbergCycloPalloidConicalGearSetPowerFlow':
