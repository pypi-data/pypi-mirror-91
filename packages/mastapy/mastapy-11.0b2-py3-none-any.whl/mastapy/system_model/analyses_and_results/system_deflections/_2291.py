...
class CVTBeltConnectionSystemDeflection(_2258.BeltConnectionSystemDeflection):
    '''CVTBeltConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3300.CVTBeltConnectionPowerFlow':
        ...
        return constructor.new(_3300.CVTBeltConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
