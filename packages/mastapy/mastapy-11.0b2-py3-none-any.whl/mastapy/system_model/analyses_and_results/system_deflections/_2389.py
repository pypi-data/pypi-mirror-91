...
class FaceGearSystemDeflection(_2394.GearSystemDeflection):
    '''FaceGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3718.FaceGearPowerFlow':
        ...
        return constructor.new(_3718.FaceGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
