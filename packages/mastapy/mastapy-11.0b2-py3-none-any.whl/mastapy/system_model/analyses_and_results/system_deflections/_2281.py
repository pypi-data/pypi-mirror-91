...
class ConceptGearSystemDeflection(_2313.GearSystemDeflection):
    '''ConceptGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3290.ConceptGearPowerFlow':
        ...
        return constructor.new(_3290.ConceptGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
