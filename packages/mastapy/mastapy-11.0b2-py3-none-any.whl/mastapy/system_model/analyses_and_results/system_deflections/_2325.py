...
from mastapy.system_model.analyses_and_results.system_deflections import _2350, _2418
from mastapy.system_model.analyses_and_results.power_flows import (
    _3663, _3669, _3670, _3673,
    _3676, _3681, _3682, _3686,
    _3691, _3694, _3697, _3702,
    _3704, _3706, _3713, _3719,
    _3721, _3724, _3728, _3732,
    _3735, _3738, _3746, _3748,
    _3757, _3760, _3764, _3767,
    _3770, _3773, _3776, _3781,
    _3785, _3792, _3795
)
...
class AbstractAssemblySystemDeflection(_2418.PartSystemDeflection):
    '''AbstractAssemblySystemDeflection
    ...
    @property
    def rigidly_connected_groups(self) -> 'List[_2481.RigidlyConnectedComponentGroupSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RigidlyConnectedGroups, constructor.new(_2481.RigidlyConnectedComponentGroupSystemDeflection))
        return value

    @property
    def components_with_unknown_mass_properties(self) -> 'List[_2350.ComponentSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentsWithUnknownMassProperties, constructor.new(_2350.ComponentSystemDeflection))
        return value

    @property
    def components_with_zero_mass_properties(self) -> 'List[_2350.ComponentSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentsWithZeroMassProperties, constructor.new(_2350.ComponentSystemDeflection))
        return value

    @property
    def power_flow_results(self) -> '_3663.AbstractAssemblyPowerFlow':
