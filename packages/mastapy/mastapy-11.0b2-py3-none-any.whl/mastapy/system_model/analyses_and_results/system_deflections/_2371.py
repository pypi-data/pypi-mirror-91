...
class CycloidalDiscCentralBearingConnectionSystemDeflection(_2349.CoaxialConnectionSystemDeflection):
    '''CycloidalDiscCentralBearingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3707.CycloidalDiscCentralBearingConnectionPowerFlow':
        ...
        return constructor.new(_3707.CycloidalDiscCentralBearingConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
