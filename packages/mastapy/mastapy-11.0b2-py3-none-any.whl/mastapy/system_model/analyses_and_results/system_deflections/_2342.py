...
class BevelGearSetSystemDeflection(_2330.AGMAGleasonConicalGearSetSystemDeflection):
    '''BevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3681.BevelGearSetPowerFlow':
