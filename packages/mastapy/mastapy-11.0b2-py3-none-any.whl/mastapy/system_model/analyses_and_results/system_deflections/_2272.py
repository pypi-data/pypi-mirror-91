...
from mastapy.system_model.analyses_and_results.system_deflections import _2270, _2290
...
class ClutchSystemDeflection(_2290.CouplingSystemDeflection):
    '''ClutchSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3283.ClutchPowerFlow':
        ...
        return constructor.new(_3283.ClutchPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
