...
class ClutchHalfSystemDeflection(_2289.CouplingHalfSystemDeflection):
    '''ClutchHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3282.ClutchHalfPowerFlow':
        ...
        return constructor.new(_3282.ClutchHalfPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
