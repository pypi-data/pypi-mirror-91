...
class CylindricalPlanetGearSystemDeflection(_2380.CylindricalGearSystemDeflection):
    '''CylindricalPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3714.CylindricalPlanetGearPowerFlow':
        ...
        return constructor.new(_3714.CylindricalPlanetGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
