...
from mastapy.system_model.analyses_and_results.power_flows import _3672, _3703
...
class BeltConnectionSystemDeflection(_2400.InterMountableComponentConnectionSystemDeflection):
    '''BeltConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3672.BeltConnectionPowerFlow':
