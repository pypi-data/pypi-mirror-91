...
class CycloidalDiscPlanetaryBearingConnectionSystemDeflection(_2328.AbstractShaftToMountableComponentConnectionSystemDeflection):
    '''CycloidalDiscPlanetaryBearingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3708.CycloidalDiscPlanetaryBearingConnectionPowerFlow':
        ...
        return constructor.new(_3708.CycloidalDiscPlanetaryBearingConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
