...
class CylindricalPlanetGearSystemDeflection(_2300.CylindricalGearSystemDeflection):
    '''CylindricalPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3307.CylindricalPlanetGearPowerFlow':
        ...
        return constructor.new(_3307.CylindricalPlanetGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
