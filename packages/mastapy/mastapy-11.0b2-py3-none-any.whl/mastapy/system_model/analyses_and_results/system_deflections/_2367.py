...
class CVTBeltConnectionSystemDeflection(_2334.BeltConnectionSystemDeflection):
    '''CVTBeltConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3703.CVTBeltConnectionPowerFlow':
        ...
        return constructor.new(_3703.CVTBeltConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
