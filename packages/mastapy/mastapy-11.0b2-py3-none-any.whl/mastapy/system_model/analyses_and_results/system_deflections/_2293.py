...
class CVTSystemDeflection(_2259.BeltDriveSystemDeflection):
    '''CVTSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3301.CVTPowerFlow':
        ...
        return constructor.new(_3301.CVTPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
