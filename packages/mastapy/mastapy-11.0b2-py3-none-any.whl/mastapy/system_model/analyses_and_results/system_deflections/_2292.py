...
class CVTPulleySystemDeflection(_2345.PulleySystemDeflection):
    '''CVTPulleySystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3302.CVTPulleyPowerFlow':
        ...
        return constructor.new(_3302.CVTPulleyPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def fixed_sheave_contact_results(self) -> 'List[_1134.NodeResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FixedSheaveContactResults, constructor.new(_1134.NodeResults))
        return value

    @property
    def moving_sheave_contact_results(self) -> 'List[_1134.NodeResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MovingSheaveContactResults, constructor.new(_1134.NodeResults))
        return value
