...
class CylindricalGearMeshSystemDeflection(_2311.GearMeshSystemDeflection):
    '''CylindricalGearMeshSystemDeflection
    ...
    @property
    def chart_of_effective_change_in_operating_centre_distance(self) -> '_6555.SMTBitmap':
        ...
        return constructor.new(_6555.SMTBitmap)(self.wrapped.ChartOfEffectiveChangeInOperatingCentreDistance) if self.wrapped.ChartOfEffectiveChangeInOperatingCentreDistance else None
    ...
    @property
    def power_flow_results(self) -> '_3304.CylindricalGearMeshPowerFlow':
        ...
        return constructor.new(_3304.CylindricalGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
    ...
    @property
    def gear_a(self) -> '_2300.CylindricalGearSystemDeflection':
    ...
    @property
    def gear_b(self) -> '_2300.CylindricalGearSystemDeflection':
    ...
    @property
    def misalignment_data(self) -> '_1382.CylindricalMisalignmentCalculator':
        ...
        return constructor.new(_1382.CylindricalMisalignmentCalculator)(self.wrapped.MisalignmentData) if self.wrapped.MisalignmentData else None

    @property
    def misalignment_data_left_flank(self) -> '_1382.CylindricalMisalignmentCalculator':
        ...
        return constructor.new(_1382.CylindricalMisalignmentCalculator)(self.wrapped.MisalignmentDataLeftFlank) if self.wrapped.MisalignmentDataLeftFlank else None

    @property
    def misalignment_data_right_flank(self) -> '_1382.CylindricalMisalignmentCalculator':
        ...
        return constructor.new(_1382.CylindricalMisalignmentCalculator)(self.wrapped.MisalignmentDataRightFlank) if self.wrapped.MisalignmentDataRightFlank else None
    ...
    @property
    def cylindrical_gears(self) -> 'List[_2300.CylindricalGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_2300.CylindricalGearSystemDeflection))
        return value

    @property
    def mesh_deflections_left_flank(self) -> 'List[_2394.MeshDeflectionResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshDeflectionsLeftFlank, constructor.new(_2394.MeshDeflectionResults))
        return value

    @property
    def mesh_deflections_right_flank(self) -> 'List[_2394.MeshDeflectionResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshDeflectionsRightFlank, constructor.new(_2394.MeshDeflectionResults))
        return value
