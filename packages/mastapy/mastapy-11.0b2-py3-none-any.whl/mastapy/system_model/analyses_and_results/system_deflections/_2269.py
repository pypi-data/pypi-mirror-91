...
class BoltSystemDeflection(_2274.ComponentSystemDeflection):
    '''BoltSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3280.BoltPowerFlow':
        ...
        return constructor.new(_3280.BoltPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
