...
class BoltSystemDeflection(_2350.ComponentSystemDeflection):
    '''BoltSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3683.BoltPowerFlow':
        ...
        return constructor.new(_3683.BoltPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
