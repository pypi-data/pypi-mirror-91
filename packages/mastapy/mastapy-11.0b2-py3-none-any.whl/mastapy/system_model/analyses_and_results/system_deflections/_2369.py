...
class CVTSystemDeflection(_2335.BeltDriveSystemDeflection):
    '''CVTSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3704.CVTPowerFlow':
        ...
        return constructor.new(_3704.CVTPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
