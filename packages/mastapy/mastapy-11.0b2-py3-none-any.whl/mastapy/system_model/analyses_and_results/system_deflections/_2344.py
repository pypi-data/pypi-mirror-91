...
class BoltedJointSystemDeflection(_2439.SpecialisedAssemblySystemDeflection):
    '''BoltedJointSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3682.BoltedJointPowerFlow':
        ...
        return constructor.new(_3682.BoltedJointPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
