...
class SingleAnalysis:
    ...
    def perform_analysis_with_progress(self, task_progress: '_7153.TaskProgress'):
        ''' 'PerformAnalysis' is the original name of this method.
    ...
    def results_for_design_entity_analysis(self, design_entity_analysis: '_2295.DesignEntityAnalysis') -> '_2295.DesignEntityAnalysis':
        ''' 'ResultsFor' is the original name of this method.
