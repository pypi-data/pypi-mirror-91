...
class DesignEntityAnalysis(_0.APIBase):
    ...
    @property
    def component_design(self) -> '_1835.DesignEntity':
        ...
        if _1835.DesignEntity.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    @property
    def component_design_of_type_connection(self) -> '_1876.Connection':
    ...
    @property
    def component_design_of_type_part(self) -> '_2052.Part':
