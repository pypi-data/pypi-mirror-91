...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5908, _5909, _5940
...
class ConceptGearSetDynamicAnalysis(_5940.GearSetDynamicAnalysis):
    '''ConceptGearSetDynamicAnalysis
    ...
    @property
    def concept_gears_dynamic_analysis(self) -> 'List[_5908.ConceptGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsDynamicAnalysis, constructor.new(_5908.ConceptGearDynamicAnalysis))
        return value

    @property
    def concept_meshes_dynamic_analysis(self) -> 'List[_5909.ConceptGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesDynamicAnalysis, constructor.new(_5909.ConceptGearMeshDynamicAnalysis))
        return value
