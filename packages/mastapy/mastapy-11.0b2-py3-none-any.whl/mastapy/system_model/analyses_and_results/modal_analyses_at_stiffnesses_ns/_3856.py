...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _3805, _3772
...
class RootAssemblyModalAnalysesAtStiffnesses(_3772.AssemblyModalAnalysesAtStiffnesses):
    '''RootAssemblyModalAnalysesAtStiffnesses
    ...
    @property
    def modal_analyses_at_stiffnesses_inputs(self) -> '_3805.CriticalSpeedAnalysis':
        ...
        return constructor.new(_3805.CriticalSpeedAnalysis)(self.wrapped.ModalAnalysesAtStiffnessesInputs) if self.wrapped.ModalAnalysesAtStiffnessesInputs else None
