...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _3810, _3809, _3821
...
class CylindricalGearSetModalAnalysesAtStiffnesses(_3821.GearSetModalAnalysesAtStiffnesses):
    '''CylindricalGearSetModalAnalysesAtStiffnesses
    ...
    @property
    def cylindrical_gears_modal_analyses_at_stiffnesses(self) -> 'List[_3810.CylindricalGearModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsModalAnalysesAtStiffnesses, constructor.new(_3810.CylindricalGearModalAnalysesAtStiffnesses))
        return value

    @property
    def cylindrical_meshes_modal_analyses_at_stiffnesses(self) -> 'List[_3809.CylindricalGearMeshModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesModalAnalysesAtStiffnesses, constructor.new(_3809.CylindricalGearMeshModalAnalysesAtStiffnesses))
        return value
