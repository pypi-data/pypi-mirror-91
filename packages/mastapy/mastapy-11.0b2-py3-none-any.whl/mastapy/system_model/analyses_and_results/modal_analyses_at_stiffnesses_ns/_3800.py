...
class ConnectionModalAnalysesAtStiffnesses(_6538.ConnectionStaticLoadAnalysisCase):
    '''ConnectionModalAnalysesAtStiffnesses
    ...
    @property
    def modal_analyses_at_stiffnesses(self) -> '_3805.CriticalSpeedAnalysis':
        ...
        return constructor.new(_3805.CriticalSpeedAnalysis)(self.wrapped.ModalAnalysesAtStiffnesses) if self.wrapped.ModalAnalysesAtStiffnesses else None
