...
class ZerolBevelGearMeshCompoundSingleMeshWhineAnalysis(_5596.BevelGearMeshCompoundSingleMeshWhineAnalysis):
    '''ZerolBevelGearMeshCompoundSingleMeshWhineAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5578.ZerolBevelGearMeshSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5578.ZerolBevelGearMeshSingleMeshWhineAnalysis))
        return value

    @property
    def connection_single_mesh_whine_analysis_load_cases(self) -> 'List[_5578.ZerolBevelGearMeshSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSingleMeshWhineAnalysisLoadCases, constructor.new(_5578.ZerolBevelGearMeshSingleMeshWhineAnalysis))
        return value
