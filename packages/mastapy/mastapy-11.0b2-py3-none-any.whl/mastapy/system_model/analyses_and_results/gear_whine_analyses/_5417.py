...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5415, _5416, _5315
...
class SpiralBevelGearSetGearWhineAnalysis(_5315.BevelGearSetGearWhineAnalysis):
    '''SpiralBevelGearSetGearWhineAnalysis
    ...
    @property
    def gears_gear_whine_analysis(self) -> 'List[_5415.SpiralBevelGearGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsGearWhineAnalysis, constructor.new(_5415.SpiralBevelGearGearWhineAnalysis))
        return value

    @property
    def spiral_bevel_gears_gear_whine_analysis(self) -> 'List[_5415.SpiralBevelGearGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsGearWhineAnalysis, constructor.new(_5415.SpiralBevelGearGearWhineAnalysis))
        return value

    @property
    def meshes_gear_whine_analysis(self) -> 'List[_5416.SpiralBevelGearMeshGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesGearWhineAnalysis, constructor.new(_5416.SpiralBevelGearMeshGearWhineAnalysis))
        return value

    @property
    def spiral_bevel_meshes_gear_whine_analysis(self) -> 'List[_5416.SpiralBevelGearMeshGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesGearWhineAnalysis, constructor.new(_5416.SpiralBevelGearMeshGearWhineAnalysis))
        return value
