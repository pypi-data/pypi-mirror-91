...
class WormGearMeshGearWhineAnalysis(_5366.GearMeshGearWhineAnalysis):
    '''WormGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2385.WormGearMeshSystemDeflection':
        ...
        return constructor.new(_2385.WormGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
