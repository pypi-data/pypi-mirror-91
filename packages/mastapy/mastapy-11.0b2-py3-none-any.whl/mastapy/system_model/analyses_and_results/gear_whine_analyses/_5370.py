...
class GearWhineAnalysis(_6534.CompoundAnalysisCase):
    '''GearWhineAnalysis
    ...
    @property
    def single_mesh_whine_analyses(self) -> 'List[_5549.SingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SingleMeshWhineAnalyses, constructor.new(_5549.SingleMeshWhineAnalysis))
        return value
