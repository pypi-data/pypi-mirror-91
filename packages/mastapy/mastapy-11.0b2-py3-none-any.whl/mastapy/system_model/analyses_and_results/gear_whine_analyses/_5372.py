...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.whine_analyses_results import _5450
from mastapy.system_model.analyses_and_results.modal_analyses import _4821
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5414, _5363
...
class GearWhineAnalysisOptions(_0.APIBase):
    ...
    @property
    def excitation_selection(self) -> '_5450.ExcitationSourceSelectionGroup':
        ...
        return constructor.new(_5450.ExcitationSourceSelectionGroup)(self.wrapped.ExcitationSelection) if self.wrapped.ExcitationSelection else None

    @property
    def modal_analysis_options(self) -> '_4821.ModalAnalysisOptions':
        ...
        return constructor.new(_4821.ModalAnalysisOptions)(self.wrapped.ModalAnalysisOptions) if self.wrapped.ModalAnalysisOptions else None
