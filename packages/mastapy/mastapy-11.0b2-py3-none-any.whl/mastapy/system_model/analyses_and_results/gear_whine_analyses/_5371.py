...
class GearWhineAnalysisFEExportOptions(_0.APIBase):
    ...
    @property
    def analysis_options(self) -> '_5372.GearWhineAnalysisOptions':
        ...
        return constructor.new(_5372.GearWhineAnalysisOptions)(self.wrapped.AnalysisOptions) if self.wrapped.AnalysisOptions else None
