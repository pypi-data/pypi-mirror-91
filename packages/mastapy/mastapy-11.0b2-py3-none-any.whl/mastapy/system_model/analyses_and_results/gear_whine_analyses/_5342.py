...
class CylindricalGearMeshGearWhineAnalysis(_5366.GearMeshGearWhineAnalysis):
    '''CylindricalGearMeshGearWhineAnalysis
    ...
    @property
    def advanced_system_deflection_results(self) -> '_6328.CylindricalGearMeshAdvancedSystemDeflection':
        ...
        return constructor.new(_6328.CylindricalGearMeshAdvancedSystemDeflection)(self.wrapped.AdvancedSystemDeflectionResults) if self.wrapped.AdvancedSystemDeflectionResults else None
