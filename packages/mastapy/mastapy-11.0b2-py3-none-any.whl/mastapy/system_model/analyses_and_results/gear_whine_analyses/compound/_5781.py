...
class KlingelnbergCycloPalloidSpiralBevelGearCompoundGearWhineAnalysis(_5775.KlingelnbergCycloPalloidConicalGearCompoundGearWhineAnalysis):
    '''KlingelnbergCycloPalloidSpiralBevelGearCompoundGearWhineAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5387.KlingelnbergCycloPalloidSpiralBevelGearGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5387.KlingelnbergCycloPalloidSpiralBevelGearGearWhineAnalysis))
        return value

    @property
    def component_gear_whine_analysis_load_cases(self) -> 'List[_5387.KlingelnbergCycloPalloidSpiralBevelGearGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentGearWhineAnalysisLoadCases, constructor.new(_5387.KlingelnbergCycloPalloidSpiralBevelGearGearWhineAnalysis))
        return value
