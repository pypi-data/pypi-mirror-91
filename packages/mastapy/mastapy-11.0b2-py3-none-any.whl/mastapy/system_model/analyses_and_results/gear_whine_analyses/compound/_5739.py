...
class ConceptCouplingCompoundGearWhineAnalysis(_5750.CouplingCompoundGearWhineAnalysis):
    '''ConceptCouplingCompoundGearWhineAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5325.ConceptCouplingGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5325.ConceptCouplingGearWhineAnalysis))
        return value

    @property
    def assembly_gear_whine_analysis_load_cases(self) -> 'List[_5325.ConceptCouplingGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyGearWhineAnalysisLoadCases, constructor.new(_5325.ConceptCouplingGearWhineAnalysis))
        return value
