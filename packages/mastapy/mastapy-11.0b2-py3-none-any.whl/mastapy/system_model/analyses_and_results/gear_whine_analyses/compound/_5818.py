...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _5812
...
class StraightBevelPlanetGearCompoundGearWhineAnalysis(_5812.StraightBevelDiffGearCompoundGearWhineAnalysis):
    '''StraightBevelPlanetGearCompoundGearWhineAnalysis
