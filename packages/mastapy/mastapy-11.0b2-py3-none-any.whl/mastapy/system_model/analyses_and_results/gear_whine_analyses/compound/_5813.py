...
class StraightBevelDiffGearMeshCompoundGearWhineAnalysis(_5730.BevelGearMeshCompoundGearWhineAnalysis):
    '''StraightBevelDiffGearMeshCompoundGearWhineAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5422.StraightBevelDiffGearMeshGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5422.StraightBevelDiffGearMeshGearWhineAnalysis))
        return value

    @property
    def connection_gear_whine_analysis_load_cases(self) -> 'List[_5422.StraightBevelDiffGearMeshGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionGearWhineAnalysisLoadCases, constructor.new(_5422.StraightBevelDiffGearMeshGearWhineAnalysis))
        return value
