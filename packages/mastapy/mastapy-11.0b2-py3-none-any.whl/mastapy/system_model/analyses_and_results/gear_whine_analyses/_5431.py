...
from mastapy.system_model.analyses_and_results.system_deflections import _2371, _2370, _2372
...
class SynchroniserPartGearWhineAnalysis(_5337.CouplingHalfGearWhineAnalysis):
    '''SynchroniserPartGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2371.SynchroniserPartSystemDeflection':
