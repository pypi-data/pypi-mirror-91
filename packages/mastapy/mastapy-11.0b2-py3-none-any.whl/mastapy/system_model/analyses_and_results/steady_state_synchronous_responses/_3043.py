...
class ConnectionSteadyStateSynchronousResponse(_6538.ConnectionStaticLoadAnalysisCase):
    '''ConnectionSteadyStateSynchronousResponse
    ...
    @property
    def steady_state_synchronous_response(self) -> '_3108.SteadyStateSynchronousResponse':
        ...
        return constructor.new(_3108.SteadyStateSynchronousResponse)(self.wrapped.SteadyStateSynchronousResponse) if self.wrapped.SteadyStateSynchronousResponse else None
