...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _4040, _4039, _4066
...
class ConceptGearSetModalAnalysesAtSpeeds(_4066.GearSetModalAnalysesAtSpeeds):
    '''ConceptGearSetModalAnalysesAtSpeeds
    ...
    @property
    def concept_gears_modal_analyses_at_speeds(self) -> 'List[_4040.ConceptGearModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsModalAnalysesAtSpeeds, constructor.new(_4040.ConceptGearModalAnalysesAtSpeeds))
        return value

    @property
    def concept_meshes_modal_analyses_at_speeds(self) -> 'List[_4039.ConceptGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesModalAnalysesAtSpeeds, constructor.new(_4039.ConceptGearMeshModalAnalysesAtSpeeds))
        return value
