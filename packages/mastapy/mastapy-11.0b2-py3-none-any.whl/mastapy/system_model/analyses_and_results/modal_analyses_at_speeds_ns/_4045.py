...
class ConnectionModalAnalysesAtSpeeds(_6538.ConnectionStaticLoadAnalysisCase):
    '''ConnectionModalAnalysesAtSpeeds
    ...
    @property
    def modal_analyses_at_speeds(self) -> '_4112.StabilityAnalysis':
        ...
        return constructor.new(_4112.StabilityAnalysis)(self.wrapped.ModalAnalysesAtSpeeds) if self.wrapped.ModalAnalysesAtSpeeds else None
