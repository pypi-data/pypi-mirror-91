...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _4054, _4053, _4066
...
class CylindricalGearSetModalAnalysesAtSpeeds(_4066.GearSetModalAnalysesAtSpeeds):
    '''CylindricalGearSetModalAnalysesAtSpeeds
    ...
    @property
    def cylindrical_gears_modal_analyses_at_speeds(self) -> 'List[_4054.CylindricalGearModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsModalAnalysesAtSpeeds, constructor.new(_4054.CylindricalGearModalAnalysesAtSpeeds))
        return value

    @property
    def cylindrical_meshes_modal_analyses_at_speeds(self) -> 'List[_4053.CylindricalGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesModalAnalysesAtSpeeds, constructor.new(_4053.CylindricalGearMeshModalAnalysesAtSpeeds))
        return value
