...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _4121
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns.compound import _4244
...
class SynchroniserHalfCompoundModalAnalysesAtSpeeds(_4244.SynchroniserPartCompoundModalAnalysesAtSpeeds):
    '''SynchroniserHalfCompoundModalAnalysesAtSpeeds
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4121.SynchroniserHalfModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4121.SynchroniserHalfModalAnalysesAtSpeeds))
        return value

    @property
    def component_modal_analyses_at_speeds_load_cases(self) -> 'List[_4121.SynchroniserHalfModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysesAtSpeedsLoadCases, constructor.new(_4121.SynchroniserHalfModalAnalysesAtSpeeds))
        return value
