...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _4107, _4106, _4028
...
class SpiralBevelGearSetModalAnalysesAtSpeeds(_4028.BevelGearSetModalAnalysesAtSpeeds):
    '''SpiralBevelGearSetModalAnalysesAtSpeeds
    ...
    @property
    def spiral_bevel_gears_modal_analyses_at_speeds(self) -> 'List[_4107.SpiralBevelGearModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsModalAnalysesAtSpeeds, constructor.new(_4107.SpiralBevelGearModalAnalysesAtSpeeds))
        return value

    @property
    def spiral_bevel_meshes_modal_analyses_at_speeds(self) -> 'List[_4106.SpiralBevelGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesModalAnalysesAtSpeeds, constructor.new(_4106.SpiralBevelGearMeshModalAnalysesAtSpeeds))
        return value
