...
class ShaftToMountableComponentConnectionCompoundModalAnalysisAtAStiffness(_4334.AbstractShaftToMountableComponentConnectionCompoundModalAnalysisAtAStiffness):
    '''ShaftToMountableComponentConnectionCompoundModalAnalysisAtAStiffness
