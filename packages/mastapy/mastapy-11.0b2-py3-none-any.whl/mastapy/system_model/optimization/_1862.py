...
from mastapy.system_model.optimization import _1863, _1861
...
TStep = TypeVar('TStep', bound='_1861.OptimizationStep')


class OptimizationStrategy(_1863.OptimizationStrategyBase, Generic[TStep]):
    '''OptimizationStrategy
