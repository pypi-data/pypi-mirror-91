...
from mastapy.system_model import _1841, _1838
from mastapy._internal import constructor, conversion
from mastapy.system_model.part_model import _2056, _2055
...
class DutyCycleImporter(_0.APIBase):
    ...
    @property
    def duty_cycles_to_import(self) -> 'List[_1841.IncludeDutyCycleOption]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DutyCyclesToImport, constructor.new(_1841.IncludeDutyCycleOption))
        return value

    @property
    def power_load_destinations(self) -> 'List[_1838.DutyCycleImporterDesignEntityMatch[_2056.PowerLoad]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PowerLoadDestinations, constructor.new(_1838.DutyCycleImporterDesignEntityMatch)[_2056.PowerLoad])
        return value

    @property
    def point_load_destinations(self) -> 'List[_1838.DutyCycleImporterDesignEntityMatch[_2055.PointLoad]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PointLoadDestinations, constructor.new(_1838.DutyCycleImporterDesignEntityMatch)[_2055.PointLoad])
        return value
