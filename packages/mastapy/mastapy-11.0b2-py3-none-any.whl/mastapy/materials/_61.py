...
class GeneralTransmissionProperties(_0.APIBase):
    ...
    @property
    def transmission_application(self) -> '_90.TransmissionApplications':
        ...
        return constructor.new(_90.TransmissionApplications)(value) if value else None

    @transmission_application.setter
    def transmission_application(self, value: '_90.TransmissionApplications'):
    ...
    @property
    def bearing_iso762006_static_safety_factor_limit(self) -> '_64.ISO76StaticSafetyFactorLimits':
        ...
        return constructor.new(_64.ISO76StaticSafetyFactorLimits)(value) if value else None

    @bearing_iso762006_static_safety_factor_limit.setter
    def bearing_iso762006_static_safety_factor_limit(self, value: '_64.ISO76StaticSafetyFactorLimits'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def wind_turbine_standard(self) -> '_93.WindTurbineStandards':
        ...
        return constructor.new(_93.WindTurbineStandards)(value) if value else None

    @wind_turbine_standard.setter
    def wind_turbine_standard(self, value: '_93.WindTurbineStandards'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def driving_machine_characteristics(self) -> '_94.WorkingCharacteristics':
        ...
        return constructor.new(_94.WorkingCharacteristics)(value) if value else None

    @driving_machine_characteristics.setter
    def driving_machine_characteristics(self, value: '_94.WorkingCharacteristics'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.DrivingMachineCharacteristics = value

    @property
    def driven_machine_characteristics(self) -> '_94.WorkingCharacteristics':
    ...
    def driven_machine_characteristics(self, value: '_94.WorkingCharacteristics'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @gearing_type.setter
    def gearing_type(self, value: '_60.GearingTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def vehicle_dynamics(self) -> '_92.VehicleDynamicsProperties':
        ...
        return constructor.new(_92.VehicleDynamicsProperties)(self.wrapped.VehicleDynamics) if self.wrapped.VehicleDynamics else None
