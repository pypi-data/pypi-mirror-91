...
class SoundPressureEnclosure(_0.APIBase):
    ...
    @property
    def enclosure_type(self) -> '_87.SoundPressureEnclosureType':
        ...
        return constructor.new(_87.SoundPressureEnclosureType)(value) if value else None

    @enclosure_type.setter
    def enclosure_type(self, value: '_87.SoundPressureEnclosureType'):
