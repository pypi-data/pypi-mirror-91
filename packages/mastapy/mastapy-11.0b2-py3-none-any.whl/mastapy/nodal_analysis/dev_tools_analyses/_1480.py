...
class FEModel(_0.APIBase):
    ...
    @property
    def rigid_element_properties(self) -> 'List[_1506.ElementPropertiesRigid]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RigidElementProperties, constructor.new(_1506.ElementPropertiesRigid))
        return value

    @property
    def solid_element_properties(self) -> 'List[_1508.ElementPropertiesSolid]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SolidElementProperties, constructor.new(_1508.ElementPropertiesSolid))
        return value

    @property
    def shell_element_properties(self) -> 'List[_1507.ElementPropertiesShell]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShellElementProperties, constructor.new(_1507.ElementPropertiesShell))
        return value

    @property
    def beam_element_properties(self) -> 'List[_1503.ElementPropertiesBeam]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BeamElementProperties, constructor.new(_1503.ElementPropertiesBeam))
        return value

    @property
    def spring_dashpot_element_properties(self) -> 'List[_1509.ElementPropertiesSpringDashpot]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpringDashpotElementProperties, constructor.new(_1509.ElementPropertiesSpringDashpot))
        return value

    @property
    def mass_element_properties(self) -> 'List[_1505.ElementPropertiesMass]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MassElementProperties, constructor.new(_1505.ElementPropertiesMass))
        return value

    @property
    def interface_element_properties(self) -> 'List[_1504.ElementPropertiesInterface]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InterfaceElementProperties, constructor.new(_1504.ElementPropertiesInterface))
        return value

    @property
    def other_element_properties(self) -> 'List[_1502.ElementPropertiesBase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.OtherElementProperties, constructor.new(_1502.ElementPropertiesBase))
        return value

    @property
    def materials(self) -> 'List[_1511.MaterialPropertiesReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Materials, constructor.new(_1511.MaterialPropertiesReporting))
        return value

    @property
    def coordinate_systems(self) -> 'List[_1498.CoordinateSystemReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CoordinateSystems, constructor.new(_1498.CoordinateSystemReporting))
        return value

    @property
    def contact_pairs(self) -> 'List[_1497.ContactPairReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ContactPairs, constructor.new(_1497.ContactPairReporting))
        return value
    ...
    def get_all_element_details(self) -> '_1501.ElementDetailsForFEModel':
    ...
    def get_all_node_details(self) -> '_1512.NodeDetailsForFEModel':
