...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _1514, _1502
...
class ElementPropertiesRigid(_1502.ElementPropertiesBase):
    '''ElementPropertiesRigid
    ...
    @property
    def degrees_of_freedom_list(self) -> 'List[_1514.RigidElementNodeDegreesOfFreedom]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DegreesOfFreedomList, constructor.new(_1514.RigidElementNodeDegreesOfFreedom))
        return value
