...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _1502
...
class ElementPropertiesMass(_1502.ElementPropertiesBase):
    '''ElementPropertiesMass
    ...
    @property
    def inertia(self) -> '_1090.InertiaTensor':
        ...
        return constructor.new(_1090.InertiaTensor)(self.wrapped.Inertia) if self.wrapped.Inertia else None
