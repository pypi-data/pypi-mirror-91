...
from mastapy.nodal_analysis.dev_tools_analyses import _1493
...
class EigenvalueOptions(_0.APIBase):
    ...
    @property
    def mass_matrix_type(self) -> '_1493.MassMatrixType':
        ...
        return constructor.new(_1493.MassMatrixType)(value) if value else None

    @mass_matrix_type.setter
    def mass_matrix_type(self, value: '_1493.MassMatrixType'):
