...
from mastapy.nodal_analysis.states import _1447, _1446
...
class RealCMSResults(_1524.CMSResults):
    '''RealCMSResults
    ...
    @property
    def node_displacements(self) -> '_1447.NodeVectorState':
        ...
        if _1447.NodeVectorState.TYPE not in self.wrapped.NodeDisplacements.__class__.__mro__:
