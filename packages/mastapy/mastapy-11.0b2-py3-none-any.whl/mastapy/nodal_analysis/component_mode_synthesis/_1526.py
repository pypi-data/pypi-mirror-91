...
from mastapy.nodal_analysis.states import _1445, _1444
...
class RealCMSResults(_1522.CMSResults):
    '''RealCMSResults
    ...
    @property
    def node_displacements(self) -> '_1445.NodeVectorState':
        ...
        if _1445.NodeVectorState.TYPE not in self.wrapped.NodeDisplacements.__class__.__mro__:
