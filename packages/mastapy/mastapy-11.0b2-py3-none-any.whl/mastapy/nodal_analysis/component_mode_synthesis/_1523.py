...
from mastapy.nodal_analysis.component_mode_synthesis import _1521, _1518
...
class FullFEModel(_0.APIBase):
    ...
    @property
    def fe_model(self) -> '_1480.FEModel':
        ...
        return constructor.new(_1480.FEModel)(self.wrapped.FEModel) if self.wrapped.FEModel else None

    @property
    def reduction_options(self) -> '_1521.CMSOptions':
        ...
        return constructor.new(_1521.CMSOptions)(self.wrapped.ReductionOptions) if self.wrapped.ReductionOptions else None

    @property
    def element_face_groups(self) -> 'List[_1518.CMSElementFaceGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElementFaceGroups, constructor.new(_1518.CMSElementFaceGroup))
        return value
