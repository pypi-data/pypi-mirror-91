...
class CMSOptions(_0.APIBase):
    ...
    @property
    def precision_when_saving_expansion_vectors(self) -> '_1077.DataPrecision':
        ...
        return constructor.new(_1077.DataPrecision)(value) if value else None

    @precision_when_saving_expansion_vectors.setter
    def precision_when_saving_expansion_vectors(self, value: '_1077.DataPrecision'):
    ...
    @property
    def internal_mode_options(self) -> '_1475.EigenvalueOptions':
        ...
        return constructor.new(_1475.EigenvalueOptions)(self.wrapped.InternalModeOptions) if self.wrapped.InternalModeOptions else None
