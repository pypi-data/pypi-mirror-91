...
class TransientSolver(_1426.DynamicSolver):
    '''TransientSolver
    ...
    @property
    def solver_status(self) -> '_1412.TransientSolverStatus':
        ...
        return constructor.new(_1412.TransientSolverStatus)(value) if value else None

    @solver_status.setter
    def solver_status(self, value: '_1412.TransientSolverStatus'):
