...
class TransientSolver(_1424.DynamicSolver):
    '''TransientSolver
    ...
    @property
    def solver_status(self) -> '_1410.TransientSolverStatus':
        ...
        return constructor.new(_1410.TransientSolverStatus)(value) if value else None

    @solver_status.setter
    def solver_status(self, value: '_1410.TransientSolverStatus'):
