...
from mastapy.nodal_analysis import _1403, _1404
...
class AnalysisSettings(_1156.PerMachineSettings):
    '''AnalysisSettings
    ...
    @property
    def rating_type_for_bearing_reliability(self) -> '_1403.RatingTypeForBearingReliability':
        ...
        return constructor.new(_1403.RatingTypeForBearingReliability)(value) if value else None

    @rating_type_for_bearing_reliability.setter
    def rating_type_for_bearing_reliability(self, value: '_1403.RatingTypeForBearingReliability'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.RatingTypeForBearingReliability = value

    @property
    def rating_type_for_shaft_reliability(self) -> '_1404.RatingTypeForShaftReliability':
        ...
        return constructor.new(_1404.RatingTypeForShaftReliability)(value) if value else None

    @rating_type_for_shaft_reliability.setter
    def rating_type_for_shaft_reliability(self, value: '_1404.RatingTypeForShaftReliability'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
