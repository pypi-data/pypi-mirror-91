...
class SurfaceToSurfaceContactStiffnessEntity(_1446.ArbitraryNodalComponent):
    '''SurfaceToSurfaceContactStiffnessEntity
    ...
    @property
    def contact(self) -> '_1109.SurfaceToSurfaceContact':
        ...
        return constructor.new(_1109.SurfaceToSurfaceContact)(self.wrapped.Contact) if self.wrapped.Contact else None
