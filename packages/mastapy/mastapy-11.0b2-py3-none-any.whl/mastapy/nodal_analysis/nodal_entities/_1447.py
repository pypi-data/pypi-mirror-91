...
class Bar(_1462.NodalComponent):
    '''Bar
    ...
    @property
    def bar_geometry(self) -> '_1378.BarGeometry':
        ...
        return constructor.new(_1378.BarGeometry)(self.wrapped.BarGeometry) if self.wrapped.BarGeometry else None
