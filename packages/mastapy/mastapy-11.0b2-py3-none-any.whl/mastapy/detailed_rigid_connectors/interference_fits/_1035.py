...
from mastapy.bearings.tolerances import _1581, _1568, _1574
...
class InterferenceFitHalfDesign(_977.DetailedRigidConnectorHalfDesign):
    ...
    @property
    def tolerance(self) -> '_1581.SupportTolerance':
        ...
        if _1581.SupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
    ...
    @property
    def tolerance_of_type_inner_support_tolerance(self) -> '_1568.InnerSupportTolerance':
        ...
        if _1568.InnerSupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
    ...
    @property
    def tolerance_of_type_outer_support_tolerance(self) -> '_1574.OuterSupportTolerance':
        ...
        if _1574.OuterSupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
