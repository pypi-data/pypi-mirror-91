...
from mastapy.detailed_rigid_connectors.interference_fits import _1033, _1032, _1037
...
class InterferenceFitDesign(_976.DetailedRigidConnectorDesign):
    '''InterferenceFitDesign
    ...
    @property
    def calculation_method(self) -> '_1033.CalculationMethods':
        ...
        return constructor.new(_1033.CalculationMethods)(value) if value else None

    @calculation_method.setter
    def calculation_method(self, value: '_1033.CalculationMethods'):
    ...
    @property
    def assembly_method(self) -> '_1032.AssemblyMethods':
        ...
        return constructor.new(_1032.AssemblyMethods)(value) if value else None

    @assembly_method.setter
    def assembly_method(self, value: '_1032.AssemblyMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
