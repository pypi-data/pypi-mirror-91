...
class InterferenceFitHalfDesign(_973.DetailedRigidConnectorHalfDesign):
    '''InterferenceFitHalfDesign
    ...
    @property
    def stress_region(self) -> '_1032.StressRegions':
        ...
        return constructor.new(_1032.StressRegions)(value) if value else None
    ...
    def tolerance(self) -> '_1560.SupportTolerance':
        ...
        if _1560.SupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
