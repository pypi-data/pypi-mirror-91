...
from mastapy.detailed_rigid_connectors.splines import _984, _1009
...
class SAESplineJointDesign(_1009.StandardSplineJointDesign):
    '''SAESplineJointDesign
    ...
    @property
    def fit_type(self) -> '_984.FitTypes':
        '''FitTypes: 'FitType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.FitType)
        return constructor.new(_984.FitTypes)(value) if value else None

    @fit_type.setter
    def fit_type(self, value: '_984.FitTypes'):
