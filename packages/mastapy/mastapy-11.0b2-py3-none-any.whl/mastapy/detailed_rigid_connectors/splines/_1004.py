...
from mastapy.detailed_rigid_connectors.splines import (
    _983, _994, _1006, _998,
    _995, _1002, _1003, _978,
    _981, _985, _988, _996,
    _1008
)
...
class SplineJointDesign(_976.DetailedRigidConnectorDesign):
    '''SplineJointDesign
    ...
    @property
    def torque_cycles(self) -> '_998.SAETorqueCycles':
        ...
        return constructor.new(_998.SAETorqueCycles)(value) if value else None

    @torque_cycles.setter
    def torque_cycles(self, value: '_998.SAETorqueCycles'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TorqueCycles = value

    @property
    def fatigue_life_factor_type(self) -> '_995.SAEFatigueLifeFactorTypes':
        ...
        return constructor.new(_995.SAEFatigueLifeFactorTypes)(value) if value else None

    @fatigue_life_factor_type.setter
    def fatigue_life_factor_type(self, value: '_995.SAEFatigueLifeFactorTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FatigueLifeFactorType = value

    @property
    def spline_fixture_type(self) -> '_1002.SplineFixtureTypes':
        ...
        return constructor.new(_1002.SplineFixtureTypes)(value) if value else None

    @spline_fixture_type.setter
    def spline_fixture_type(self, value: '_1002.SplineFixtureTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def external_half(self) -> '_1003.SplineHalfDesign':
        ...
        if _1003.SplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
    ...
    @property
    def external_half_of_type_custom_spline_half_design(self) -> '_978.CustomSplineHalfDesign':
        ...
        if _978.CustomSplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
    ...
    @property
    def external_half_of_type_din5480_spline_half_design(self) -> '_981.DIN5480SplineHalfDesign':
        ...
        if _981.DIN5480SplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
    ...
    @property
    def external_half_of_type_gbt3478_spline_half_design(self) -> '_985.GBT3478SplineHalfDesign':
        ...
        if _985.GBT3478SplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
    ...
    @property
    def external_half_of_type_iso4156_spline_half_design(self) -> '_988.ISO4156SplineHalfDesign':
        ...
        if _988.ISO4156SplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
    ...
    @property
    def external_half_of_type_sae_spline_half_design(self) -> '_996.SAESplineHalfDesign':
        ...
        if _996.SAESplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
    ...
    @property
    def external_half_of_type_standard_spline_half_design(self) -> '_1008.StandardSplineHalfDesign':
        ...
        if _1008.StandardSplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
    ...
    @property
    def internal_half(self) -> '_1003.SplineHalfDesign':
        ...
        if _1003.SplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
    ...
    @property
    def internal_half_of_type_custom_spline_half_design(self) -> '_978.CustomSplineHalfDesign':
        ...
        if _978.CustomSplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
    ...
    @property
    def internal_half_of_type_din5480_spline_half_design(self) -> '_981.DIN5480SplineHalfDesign':
        ...
        if _981.DIN5480SplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
    ...
    @property
    def internal_half_of_type_gbt3478_spline_half_design(self) -> '_985.GBT3478SplineHalfDesign':
        ...
        if _985.GBT3478SplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
    ...
    @property
    def internal_half_of_type_iso4156_spline_half_design(self) -> '_988.ISO4156SplineHalfDesign':
        ...
        if _988.ISO4156SplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
    ...
    @property
    def internal_half_of_type_sae_spline_half_design(self) -> '_996.SAESplineHalfDesign':
        ...
        if _996.SAESplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
    ...
    @property
    def internal_half_of_type_standard_spline_half_design(self) -> '_1008.StandardSplineHalfDesign':
        ...
        if _1008.StandardSplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
