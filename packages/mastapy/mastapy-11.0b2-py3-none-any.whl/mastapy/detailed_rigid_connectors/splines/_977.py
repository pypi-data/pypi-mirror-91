...
from mastapy.detailed_rigid_connectors.splines import _987, _996, _1004
...
class DIN5480SplineHalfDesign(_1004.StandardSplineHalfDesign):
    '''DIN5480SplineHalfDesign
    ...
    @property
    def manufacturing_type(self) -> '_987.ManufacturingTypes':
        ...
        return constructor.new(_987.ManufacturingTypes)(value) if value else None

    @manufacturing_type.setter
    def manufacturing_type(self, value: '_987.ManufacturingTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ManufacturingType = value

    @property
    def finishing_method(self) -> '_996.FinishingMethods':
        ...
        return constructor.new(_996.FinishingMethods)(value) if value else None

    @finishing_method.setter
    def finishing_method(self, value: '_996.FinishingMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
