...
from mastapy.detailed_rigid_connectors.splines import _991, _1000, _1008
...
class DIN5480SplineHalfDesign(_1008.StandardSplineHalfDesign):
    '''DIN5480SplineHalfDesign
    ...
    @property
    def manufacturing_type(self) -> '_991.ManufacturingTypes':
        ...
        return constructor.new(_991.ManufacturingTypes)(value) if value else None

    @manufacturing_type.setter
    def manufacturing_type(self, value: '_991.ManufacturingTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ManufacturingType = value

    @property
    def finishing_method(self) -> '_1000.FinishingMethods':
        ...
        return constructor.new(_1000.FinishingMethods)(value) if value else None

    @finishing_method.setter
    def finishing_method(self, value: '_1000.FinishingMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
