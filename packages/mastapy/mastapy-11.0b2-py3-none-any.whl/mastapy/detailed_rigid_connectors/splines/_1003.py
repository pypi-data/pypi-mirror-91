...
class SplineHalfDesign(_977.DetailedRigidConnectorHalfDesign):
    '''SplineHalfDesign
    ...
    @property
    def heat_treatment(self) -> '_987.HeatTreatmentTypes':
        ...
        return constructor.new(_987.HeatTreatmentTypes)(value) if value else None

    @heat_treatment.setter
    def heat_treatment(self, value: '_987.HeatTreatmentTypes'):
    ...
    @property
    def fit_and_tolerance(self) -> '_1010.FitAndTolerance':
        ...
        return constructor.new(_1010.FitAndTolerance)(self.wrapped.FitAndTolerance) if self.wrapped.FitAndTolerance else None
