...
from mastapy.detailed_rigid_connectors.keyed_joints import _1029, _1027
...
class KeyedJointDesign(_1034.InterferenceFitDesign):
    '''KeyedJointDesign
