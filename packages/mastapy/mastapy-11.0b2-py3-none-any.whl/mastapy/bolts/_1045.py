...
from mastapy.bolts import _1060, _1041
...
class BoltMaterial(_1041.BoltedJointMaterial):
    '''BoltMaterial
    ...
    @property
    def strength_grade(self) -> '_1060.StrengthGrades':
        ...
        return constructor.new(_1060.StrengthGrades)(value) if value else None

    @strength_grade.setter
    def strength_grade(self, value: '_1060.StrengthGrades'):
