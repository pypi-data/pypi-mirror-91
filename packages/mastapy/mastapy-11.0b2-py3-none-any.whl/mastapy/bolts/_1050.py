...
from mastapy.bolts import _1041, _1045
...
class ClampedSection(_0.APIBase):
    ...
    @property
    def material(self) -> '_1041.BoltedJointMaterial':
        ...
        if _1041.BoltedJointMaterial.TYPE not in self.wrapped.Material.__class__.__mro__:
