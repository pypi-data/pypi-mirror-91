...
from mastapy.math_utility import _1533, _1525
...
class ShaftDamageResults(_0.APIBase):
    ...
    @property
    def displacement_linear(self) -> 'List[_1533.Vector4D]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DisplacementLinear, constructor.new(_1533.Vector4D))
        return value

    @property
    def displacement_angular(self) -> 'List[_1533.Vector4D]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DisplacementAngular, constructor.new(_1533.Vector4D))
        return value
    ...
    @property
    def force_linear(self) -> 'List[_1533.Vector4D]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForceLinear, constructor.new(_1533.Vector4D))
        return value

    @property
    def force_angular(self) -> 'List[_1533.Vector4D]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForceAngular, constructor.new(_1533.Vector4D))
        return value
    ...
    @property
    def cyclic_degrees_of_utilisation(self) -> 'List[_1525.RealVector]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CyclicDegreesOfUtilisation, constructor.new(_1525.RealVector))
        return value
