...
class ISO14179SettingsPerBearingType(_1258.IndependentReportablePropertiesBase['ISO14179SettingsPerBearingType']):
    '''ISO14179SettingsPerBearingType
    ...
    @property
    def rolling_bearing_type(self) -> '_1596.RollingBearingType':
        ...
        return constructor.new(_1596.RollingBearingType)(value) if value else None
