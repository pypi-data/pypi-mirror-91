...
from mastapy.bearings.bearing_results.rolling import _1701, _1692
...
class LoadedDeepGrooveBallBearingRow(_1692.LoadedBallBearingRow):
    '''LoadedDeepGrooveBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1701.LoadedDeepGrooveBallBearingResults':
        ...
        return constructor.new(_1701.LoadedDeepGrooveBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
