...
from mastapy.bearings.bearing_results.rolling import _1761, _1718
...
class LoadedNonBarrelRollerBearingResults(_1718.LoadedRollerBearingResults):
    '''LoadedNonBarrelRollerBearingResults
    ...
    @property
    def smt_rib_stress(self) -> '_1761.SMTRibStressResults':
        ...
        return constructor.new(_1761.SMTRibStressResults)(self.wrapped.SMTRibStress) if self.wrapped.SMTRibStress else None
