...
from mastapy.bearings.bearing_results.rolling import (
    _1691, _1672, _1675, _1701,
    _1706, _1725, _1741, _1744,
    _1690, _1723
)
...
class LoadedBallBearingRow(_1723.LoadedRollingBearingRow):
    '''LoadedBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1691.LoadedBallBearingResults':
    ...
    @property
    def race_results(self) -> 'List[_1690.LoadedBallBearingRaceResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RaceResults, constructor.new(_1690.LoadedBallBearingRaceResults))
        return value
