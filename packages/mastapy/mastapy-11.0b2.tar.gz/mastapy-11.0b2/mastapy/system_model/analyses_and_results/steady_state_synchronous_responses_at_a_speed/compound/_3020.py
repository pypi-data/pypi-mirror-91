...
class BevelDifferentialSunGearCompoundSteadyStateSynchronousResponseAtASpeed(_3016.BevelDifferentialGearCompoundSteadyStateSynchronousResponseAtASpeed):
    '''BevelDifferentialSunGearCompoundSteadyStateSynchronousResponseAtASpeed
