...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _2271, _5886
...
class RootAssemblyDynamicAnalysis(_5886.AssemblyDynamicAnalysis):
    '''RootAssemblyDynamicAnalysis
    ...
    @property
    def dynamic_analysis_inputs(self) -> '_2271.DynamicAnalysis':
        ...
        if _2271.DynamicAnalysis.TYPE not in self.wrapped.DynamicAnalysisInputs.__class__.__mro__:
