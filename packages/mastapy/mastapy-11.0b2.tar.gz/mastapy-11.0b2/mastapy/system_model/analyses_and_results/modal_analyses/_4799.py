...
class ModalAnalysisOptions(_0.APIBase):
    ...
    @property
    def frequency_response_options_for_reports(self) -> '_4777.FrequencyResponseAnalysisOptions':
        ...
        return constructor.new(_4777.FrequencyResponseAnalysisOptions)(self.wrapped.FrequencyResponseOptionsForReports) if self.wrapped.FrequencyResponseOptionsForReports else None
