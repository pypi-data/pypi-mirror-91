...
from mastapy.system_model.analyses_and_results.modal_analyses import _2279, _4725
...
class RootAssemblyModalAnalysis(_4725.AssemblyModalAnalysis):
    ...
    @property
    def modal_analysis_inputs(self) -> '_2279.ModalAnalysis':
        ...
        if _2279.ModalAnalysis.TYPE not in self.wrapped.ModalAnalysisInputs.__class__.__mro__:
