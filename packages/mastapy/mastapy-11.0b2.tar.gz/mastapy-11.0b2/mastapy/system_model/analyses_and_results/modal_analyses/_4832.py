...
from mastapy.system_model.analyses_and_results.modal_analyses import _4831, _4830, _4736
...
class StraightBevelDiffGearSetModalAnalysis(_4736.BevelGearSetModalAnalysis):
    ...
    @property
    def straight_bevel_diff_gears_modal_analysis(self) -> 'List[_4831.StraightBevelDiffGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsModalAnalysis, constructor.new(_4831.StraightBevelDiffGearModalAnalysis))
        return value

    @property
    def straight_bevel_diff_meshes_modal_analysis(self) -> 'List[_4830.StraightBevelDiffGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesModalAnalysis, constructor.new(_4830.StraightBevelDiffGearMeshModalAnalysis))
        return value
