...
class CouplingConnectionSystemDeflection(_2400.InterMountableComponentConnectionSystemDeflection):
    '''CouplingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3700.CouplingConnectionPowerFlow':
