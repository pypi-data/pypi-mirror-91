...
class BevelDifferentialSunGearSystemDeflection(_2338.BevelDifferentialGearSystemDeflection):
    '''BevelDifferentialSunGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3678.BevelDifferentialSunGearPowerFlow':
        ...
        return constructor.new(_3678.BevelDifferentialSunGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
