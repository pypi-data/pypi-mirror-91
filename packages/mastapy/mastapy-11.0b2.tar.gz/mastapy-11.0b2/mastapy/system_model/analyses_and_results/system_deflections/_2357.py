...
class ConceptGearSystemDeflection(_2394.GearSystemDeflection):
    '''ConceptGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3693.ConceptGearPowerFlow':
        ...
        return constructor.new(_3693.ConceptGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
