...
class GuideDxfModelSystemDeflection(_2350.ComponentSystemDeflection):
    '''GuideDxfModelSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3725.GuideDxfModelPowerFlow':
        ...
        return constructor.new(_3725.GuideDxfModelPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
