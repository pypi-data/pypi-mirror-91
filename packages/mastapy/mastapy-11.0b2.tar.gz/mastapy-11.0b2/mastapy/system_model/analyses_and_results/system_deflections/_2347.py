...
class ClutchHalfSystemDeflection(_2365.CouplingHalfSystemDeflection):
    '''ClutchHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3685.ClutchHalfPowerFlow':
        ...
        return constructor.new(_3685.ClutchHalfPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
