...
from mastapy.math_utility.measured_vectors import _1563, _1559
...
class FEPartSystemDeflection(_2326.AbstractShaftOrHousingSystemDeflection):
    '''FEPartSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3720.FEPartPowerFlow':
        ...
        return constructor.new(_3720.FEPartPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
    ...
    @property
    def applied_internal_forces_in_world_coordinate_system(self) -> 'List[_1563.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AppliedInternalForcesInWorldCoordinateSystem, constructor.new(_1563.VectorWithLinearAndAngularComponents))
        return value

    @property
    def node_results_in_shaft_coordinate_system(self) -> 'List[_1559.ForceAndDisplacementResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodeResultsInShaftCoordinateSystem, constructor.new(_1559.ForceAndDisplacementResults))
        return value

    @property
    def export(self) -> '_2059.SystemDeflectionFEExportOptions':
        ...
        return constructor.new(_2059.SystemDeflectionFEExportOptions)(self.wrapped.Export) if self.wrapped.Export else None
