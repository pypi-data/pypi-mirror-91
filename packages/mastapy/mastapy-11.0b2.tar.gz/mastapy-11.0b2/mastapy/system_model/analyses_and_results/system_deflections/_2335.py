...
from mastapy.system_model.analyses_and_results.power_flows import _3673, _3704
from mastapy.system_model.analyses_and_results.system_deflections import _2334, _2439
...
class BeltDriveSystemDeflection(_2439.SpecialisedAssemblySystemDeflection):
    '''BeltDriveSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3673.BeltDrivePowerFlow':
    ...
    @property
    def belts(self) -> 'List[_2334.BeltConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Belts, constructor.new(_2334.BeltConnectionSystemDeflection))
        return value
