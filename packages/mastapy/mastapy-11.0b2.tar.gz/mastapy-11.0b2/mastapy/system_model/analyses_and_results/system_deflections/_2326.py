...
class AbstractShaftOrHousingSystemDeflection(_2350.ComponentSystemDeflection):
    '''AbstractShaftOrHousingSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3664.AbstractShaftOrHousingPowerFlow':
