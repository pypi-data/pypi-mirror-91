...
from mastapy.system_model.analyses_and_results.power_flows import _3712, _3714
...
class CylindricalGearSystemDeflection(_2394.GearSystemDeflection):
    '''CylindricalGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3712.CylindricalGearPowerFlow':
