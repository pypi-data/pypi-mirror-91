...
class BevelDifferentialGearMeshSystemDeflection(_2341.BevelGearMeshSystemDeflection):
    '''BevelDifferentialGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3674.BevelDifferentialGearMeshPowerFlow':
        ...
        return constructor.new(_3674.BevelDifferentialGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
