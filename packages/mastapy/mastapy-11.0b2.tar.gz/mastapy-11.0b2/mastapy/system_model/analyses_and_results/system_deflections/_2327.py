...
from mastapy.system_model.analyses_and_results.power_flows import _3665, _3709, _3762
...
class AbstractShaftSystemDeflection(_2326.AbstractShaftOrHousingSystemDeflection):
    '''AbstractShaftSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3665.AbstractShaftPowerFlow':
