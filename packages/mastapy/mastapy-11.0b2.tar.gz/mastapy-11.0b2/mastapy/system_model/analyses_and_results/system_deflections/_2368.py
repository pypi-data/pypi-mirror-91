...
class CVTPulleySystemDeflection(_2426.PulleySystemDeflection):
    '''CVTPulleySystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3705.CVTPulleyPowerFlow':
        ...
        return constructor.new(_3705.CVTPulleyPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def fixed_sheave_contact_results(self) -> 'List[_1561.NodeResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FixedSheaveContactResults, constructor.new(_1561.NodeResults))
        return value

    @property
    def moving_sheave_contact_results(self) -> 'List[_1561.NodeResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MovingSheaveContactResults, constructor.new(_1561.NodeResults))
        return value
