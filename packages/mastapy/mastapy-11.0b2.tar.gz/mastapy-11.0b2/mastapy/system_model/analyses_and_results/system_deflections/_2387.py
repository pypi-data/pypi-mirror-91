...
class FaceGearMeshSystemDeflection(_2392.GearMeshSystemDeflection):
    '''FaceGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3717.FaceGearMeshPowerFlow':
        ...
        return constructor.new(_3717.FaceGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
