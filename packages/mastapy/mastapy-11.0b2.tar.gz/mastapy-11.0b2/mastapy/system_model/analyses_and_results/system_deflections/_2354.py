...
class ConceptCouplingSystemDeflection(_2366.CouplingSystemDeflection):
    '''ConceptCouplingSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3691.ConceptCouplingPowerFlow':
        ...
        return constructor.new(_3691.ConceptCouplingPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
