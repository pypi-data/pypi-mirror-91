...
class BevelGearMeshSystemDeflection(_2329.AGMAGleasonConicalGearMeshSystemDeflection):
    '''BevelGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3679.BevelGearMeshPowerFlow':
