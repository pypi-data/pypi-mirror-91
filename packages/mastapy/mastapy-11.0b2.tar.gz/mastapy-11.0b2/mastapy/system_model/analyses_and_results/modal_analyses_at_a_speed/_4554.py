...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _2280, _4467
...
class RootAssemblyModalAnalysisAtASpeed(_4467.AssemblyModalAnalysisAtASpeed):
    '''RootAssemblyModalAnalysisAtASpeed
    ...
    @property
    def modal_analysis_at_a_speed_inputs(self) -> '_2280.ModalAnalysisAtASpeed':
        ...
        return constructor.new(_2280.ModalAnalysisAtASpeed)(self.wrapped.ModalAnalysisAtASpeedInputs) if self.wrapped.ModalAnalysisAtASpeedInputs else None
