...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4584, _4583, _4520
...
class WormGearSetModalAnalysisAtASpeed(_4520.GearSetModalAnalysisAtASpeed):
    '''WormGearSetModalAnalysisAtASpeed
    ...
    @property
    def worm_gears_modal_analysis_at_a_speed(self) -> 'List[_4584.WormGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsModalAnalysisAtASpeed, constructor.new(_4584.WormGearModalAnalysisAtASpeed))
        return value

    @property
    def worm_meshes_modal_analysis_at_a_speed(self) -> 'List[_4583.WormGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesModalAnalysisAtASpeed, constructor.new(_4583.WormGearMeshModalAnalysisAtASpeed))
        return value
