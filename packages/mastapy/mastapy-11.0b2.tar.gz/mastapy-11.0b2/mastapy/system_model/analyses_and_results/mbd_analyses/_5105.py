...
from mastapy.system_model.analyses_and_results.mbd_analyses import _2283, _5008
...
class RootAssemblyMultibodyDynamicsAnalysis(_5008.AssemblyMultibodyDynamicsAnalysis):
    '''RootAssemblyMultibodyDynamicsAnalysis
    ...
    @property
    def multibody_dynamics_analysis_inputs(self) -> '_2283.MultibodyDynamicsAnalysis':
        ...
        return constructor.new(_2283.MultibodyDynamicsAnalysis)(self.wrapped.MultibodyDynamicsAnalysisInputs) if self.wrapped.MultibodyDynamicsAnalysisInputs else None
