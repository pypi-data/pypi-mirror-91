...
class ConceptGearCompoundMultibodyDynamicsAnalysis(_5210.GearCompoundMultibodyDynamicsAnalysis):
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5033.ConceptGearMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5033.ConceptGearMultibodyDynamicsAnalysis))
        return value

    @property
    def component_multibody_dynamics_analysis_load_cases(self) -> 'List[_5033.ConceptGearMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentMultibodyDynamicsAnalysisLoadCases, constructor.new(_5033.ConceptGearMultibodyDynamicsAnalysis))
        return value
