...
from quant_vnpy.db.orm import BacktestStrategyStats
...
def update_backtest_strategy_stats_by_xls(file_path):
    ...
    is_available = True
    for item in ["strategy_class_name", "id_name", 'symbols', "cross_limit_method", "backtest_status"]:
    ...
    BacktestStrategyStats.update_backtest_status(df.to_dict(orient='record'))
