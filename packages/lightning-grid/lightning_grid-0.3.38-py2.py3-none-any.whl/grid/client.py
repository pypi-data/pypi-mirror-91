...
"""
    ...
    def list_datastores(self):
        ...
        table_cols = ["Credential Id", 'Name', 'Version', 'Size', 'Created']
        table = BaseObservable.create_table(columns=table_cols)
    ...
    def add_ssh_public_key(self, key: str):
        return self.execute_gql("""
            mutation (
                $publicKey: String!
            ) {
              addSSHPublicKey(publicKey: $publicKey) {
                message
                success
                id
              }
    ...
    def list_public_ssh_keys(self, after: int,
        ...
        result = self.execute_gql(
            ...
            query (
                ...
                getPublicSSHKeys(limit: $limit, after:$after) {
                    id
                    publicKey
              }
            }
