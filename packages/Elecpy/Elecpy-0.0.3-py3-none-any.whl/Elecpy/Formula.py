...
def disp_formula(pcanv, formula_list):
    ...
    :param pcanv:
    :param formula_list: 公式列表, [{'类别': 导线, '参数': {[顶点列表]}}]
    :return:
    """
...
if __name__ == '__main__':
    ...
    bcanvas = ScrollCanvas(pframe=root, row=0, column=0, cav_width=2000, cav_height=1000, grid=None).canvas
