...
from common.variables import RESPONSE, ERROR, USER, ACCOUNT_NAME, TIME, ACTION, PRESENCE, CODING
from common.utils import get_report, send_report
...
class TestSocket:
    ...
    def send(self, message_to_send):
        ...
        также сохраняет что должно было отправлено в сокет.
        ...
        # кодирует сообщение
        self.encoded_message = json_test_message.encode(CODING)
    ...
    def recv(self, max_len):
        ...
        """
        json_test_message = json.dumps(self.test_dict)
        return json_test_message.encode(CODING)
...
class Tests(unittest.TestCase):
    ...
    def test_send_report(self):
        ...
        send_report(test_socket, self.test_dict_send)
        ...
        with self.assertRaises(Exception):
            send_report(test_socket, test_socket)
    ...
    def test_get_report(self):
        ...
        self.assertEqual(get_report(test_sock_ok), self.test_dict_recv_ok)
        # тест корректной расшифровки ошибочного словаря
        self.assertEqual(get_report(test_sock_err), self.test_dict_recv_err)
