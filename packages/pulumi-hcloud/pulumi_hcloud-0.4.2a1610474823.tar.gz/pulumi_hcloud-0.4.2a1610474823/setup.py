...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'hcloud', '0.4.2-alpha.1610474823+6cff28cb'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource hcloud 0.4.2-alpha.1610474823+6cff28cb`
                """)
            else:
                raise
