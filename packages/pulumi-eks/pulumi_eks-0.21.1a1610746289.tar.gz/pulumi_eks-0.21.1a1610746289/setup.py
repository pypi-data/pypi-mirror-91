...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'eks', '0.21.1-alpha.1610746289+ddb6c9c1'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource eks 0.21.1-alpha.1610746289+ddb6c9c1`
                """)
            else:
                raise
