...
class InsplorionTestCases(unittest.TestCase):
    ...
    class InsplorionDataExample:
        ...
        intensity = [
            1- (np.array([368.56, 460.23, 403.37])-bright_ref)/(bright_ref-dark_ref),
            1-(np.array([367.69, 455.12, 419.51])-bright_ref)/(bright_ref-dark_ref),
            1-(np.array([361.73, 450.99, 418.43])-bright_ref)/(bright_ref-dark_ref)
                     ]
