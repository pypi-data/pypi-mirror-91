...
from pdcopyist.src.cusFuns.core.DecoratorFuns import CusFunsWrapper, HandleWrapper
...
class FunsPool(object):
    ...
    def get_all_desc(self):
        def _to_dict(fm: CusFunc):
            return {
                'function_name': fm.fun_name,
                'uid': fm.uid
            }

        models = (cf for cf in self._mapping.values())
