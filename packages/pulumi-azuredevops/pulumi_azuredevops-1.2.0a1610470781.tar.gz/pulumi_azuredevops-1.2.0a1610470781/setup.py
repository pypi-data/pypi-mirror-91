...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azuredevops', '1.2.0-alpha.1610470781+c2c31d05'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azuredevops 1.2.0-alpha.1610470781+c2c31d05`
                """)
            else:
                raise
