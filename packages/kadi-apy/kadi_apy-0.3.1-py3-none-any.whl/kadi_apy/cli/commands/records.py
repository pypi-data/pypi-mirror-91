...
@option(
    "pattern",
    char="p",
    description="Pattern for selection certains files, e.g. '*.txt'. "
...
def get_file(record, file_name, file_id, filepath, force):
    """Download one file or all files from a record."""

    record.get_file(filepath, force, file_name, file_id)
...
@id_identifier_options(class_type=CLIRecord, init=True)
@option(
    "file", char="f", required=True, description="The ID or identifier of the file."
)
@option("name", char="n", description="The new name of the file.")
@option("mimetype", char="m", description="The new MIME type of the file.")
def edit_file(record, file, name, mimetype):
    """Edit the metadata of a file of a record."""

    record.edit_file(file, name, mimetype)
...
def delete_file(record, file):
    """Delete a file of a record."""

    record.delete_file(file)
