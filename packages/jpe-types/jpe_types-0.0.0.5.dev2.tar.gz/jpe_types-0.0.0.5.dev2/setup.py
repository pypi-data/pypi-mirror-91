...
path = join(dirname(__file__), "jpe_types/utils/Optimizations")

def generate_cython():
    os.system(f"{sys.executable} jpe_types/utils/Optimizations/build.py build_ext --build-lib jpe_types/utils/Optimizations")
