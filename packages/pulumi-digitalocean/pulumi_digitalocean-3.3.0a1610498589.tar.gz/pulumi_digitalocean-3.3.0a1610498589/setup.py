...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'digitalocean', '3.3.0-alpha.1610498589+6cd46b18'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource digitalocean 3.3.0-alpha.1610498589+6cd46b18`
                """)
            else:
                raise
