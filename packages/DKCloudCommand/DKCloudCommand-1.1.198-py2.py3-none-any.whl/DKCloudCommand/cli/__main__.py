...
def handle_exception(e):
    ...
    if "CERTIFICATE_VERIFY_FAILED" in message:
        ceritificate_message = (
            'There is a problem with the SSL Certificate. To solve it, please run: "pip3 install --upgrade certifi"'
        )
        message = ceritificate_message + os.linesep + "Further details: " + os.linesep + message
