...
class Mber:
	...
	def get_brate(self) -> float or bool:
		...
		Specifies the upper BER limit for BR (..:BRATe) and EDR (..:EDRate) BER search measurements. \n
			:return: limit: numeric | ON | OFF Range: 0 % to 100 %, Unit: % Additional parameters: OFF | ON (disables | enables the limit using the previous/default value)
		"""
	...
	def set_brate(self, limit: float or bool) -> None:
		...
		Specifies the upper BER limit for BR (..:BRATe) and EDR (..:EDRate) BER search measurements. \n
			:param limit: numeric | ON | OFF Range: 0 % to 100 %, Unit: % Additional parameters: OFF | ON (disables | enables the limit using the previous/default value)
		"""
