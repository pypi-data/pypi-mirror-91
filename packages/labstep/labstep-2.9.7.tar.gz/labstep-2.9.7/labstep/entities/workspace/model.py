...
class Workspace(Entity):
    ...
    def getMembers(self, count=100, search_query=None, extraParams={}):
        ...
        params = {"group_id": self.id, "search_query_user": search_query, **extraParams}
    ...
    def getSharelink(self):
        ...
        if self.share_link is None:
            ...
            return shareLinkRepository.newSharelink(
                self.__user__, fields={"group_id": self.id}
            )
    ...
    def newCollection(self, name, type="experiment"):
        ...
        return collectionRepository.newCollection(
            self.__user__, name=name, type=type, extraParams={"group_id": self.id}
        )
