...
**service_account_id** | **str** | Service account user id GUID used to deploy the application | [optional] [readonly] 
**service_account_required** | **bool** | If service_account_enabled is set to true, a service account will be created. If service_account enabled is set to false, no service account will be created.  | [optional] [default to False]
