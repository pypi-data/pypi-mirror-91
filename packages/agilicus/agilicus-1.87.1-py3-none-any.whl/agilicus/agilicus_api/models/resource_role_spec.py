...
class ResourceRoleSpec(object):
    ...
    def __init__(self, resource_type=None, name=None, description=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this ResourceRoleSpec.  # noqa: E501

        A short descriptive name used to identify the role. Unique per resource_type.   # noqa: E501

        :return: The name of this ResourceRoleSpec.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ResourceRoleSpec.

        A short descriptive name used to identify the role. Unique per resource_type.   # noqa: E501

        :param name: The name of this ResourceRoleSpec.  # noqa: E501
        :type: str
        """
