...
class PluginManager:
    ...
    @classmethod
    def router(cls) -> "DefaultRouter" or None:
        ...
        if not cls._default_router:
            ...
            for module in module_list:
                router = getattr(module, "router", None)  # type: DefaultRouter
                if router:
                    #     logger.info(
    ...
    def urlpatterns() -> list:
        ...
        for module in module_list:
            ...
            namespace = getattr(module, "namespace", module.__name__)
            if getattr(module, "urlpatterns", None):
                urlpatterns += [
                    path(namespace + "/", include(module, namespace=namespace))
                ]
