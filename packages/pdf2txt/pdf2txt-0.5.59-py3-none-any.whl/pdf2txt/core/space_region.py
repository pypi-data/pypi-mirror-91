...
class SpaceRegionExtractor:
    ...
    def prepare_image(self, page, crop_bottom=400):
        ...
        for gt in page.graphs+page.tables:
            cv2.rectangle(image, (int(gt.left/page.pdf_width_scaler), int(gt.top/page.pdf_height_scaler)), (int(gt.right/page.pdf_width_scaler),int(gt.bottom/page.pdf_height_scaler)), (0,25,25), 2)
    ...
    def extract_regions_from_image(self, page, algoithm='adaptive', threshold=230):
        ...
        regions = self.regions_from_spaces(img_blur, page, vertical_separator_width=10, horizental_separator_width=10, method='pixels')
    ...
    def get_gaps_by_largest(self, arr):
        labels, num_label = ndimage.label(arr <=4*255)
