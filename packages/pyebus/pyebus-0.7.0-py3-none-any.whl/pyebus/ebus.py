...
class Ebus:
    ...
    def __repr__(self):
        return repr_(
            ...
            kwargs=(
                ...
                ("scanwaitinterval", self.scanwaitinterval, 5),
                ("scanwaits", self.scanwaits, 5),
            ),
        )
    ...
    async def wait_scancompleted(self):
        ...
        while True:
            ...
            cnts.append(cnt)
            if len(cnts) < 4 or all(cnt == cnts[0] for cnt in cnts[1:]):
    ...
    async def load_msgdefs(self):
        ...
        """
        await self.load_msgdefcodes()
        self.decode_msgdefcodes()

    async def load_msgdefcodes(self):
    ...
    async def write(self, msgdef, value, ttl=0):
        """Write Message."""
