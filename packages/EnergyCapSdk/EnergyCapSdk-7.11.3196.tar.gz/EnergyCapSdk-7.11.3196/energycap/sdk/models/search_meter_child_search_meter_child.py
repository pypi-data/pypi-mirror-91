...
class SearchMeterChildSearchMeterChild(Model):
    ...
    :ivar previous_serial_number: The previous serial number of the meter
    :vartype previous_serial_number: str
    """

    _validation = {
        'meter_code': {'required': True, 'max_length': 32, 'min_length': 0},
        'meter_info': {'required': True, 'max_length': 50, 'min_length': 0},
        'previous_serial_number': {'readonly': True},
    }
    ...
    def __init__(self, meter_code, meter_info, meter_id=None, accounts=None, commodity=None, meter_type=None, postal_code=None, city=None, state=None, country=None, line1=None, line2=None, line3=None, bill_entry_note=None, include_in_energy_star=None, properties=None, parent_path=None, active=None, is_calculated_meter=None, is_split_parent_meter=None, is_split_child_meter=None):
        ...
        self.previous_serial_number = None
