...
class ChannelEdit(Model):
    ...
    :param interval_minutes: The channel's interval. The interval is measured
     ...
     2147483647</span> <span class='property-internal'>Required
     (defined)</span>
    :type interval_minutes: int
    :param hidden: Indicates if the channel is hidden <span
     class='property-internal'>Required (defined)</span>
    :type hidden: bool
    :param total_sum: The total sum of the channel <span
     class='property-internal'>Required (defined)</span>
    :type total_sum: bool
    :param auto_summarize: Indicates if the channels reading is auto
     ...
     observation method must be Trip. <span class='property-internal'>Required
     (defined)</span>
    ...
    :param multiplier: The channel multiplier. If no value is provided, a
     ...
     place. <span class='property-internal'>Required (defined)</span>
