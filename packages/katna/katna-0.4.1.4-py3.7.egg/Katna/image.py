...
class Image(object):
    ...
    def _get_crop_specs(
        ...
        while True:
            #print("crop_height, crop_width", crop_height, crop_width)
            #print("image_height//16, image_width//4", image_height//4, image_width//4)
            if not((crop_height >= (image_height // 4)) and (crop_width >= (image_width // 4))):
                break
