...
class AuthManager:
    ...
    def __init__(self, credentials_path=None):
        if credentials_path is not None:
            ...
            self._credentials_path = os.path.expanduser('~/.config/geodesic/credentials')
    ...
    def refresh_token(self):
        ...
        try:
            ...
            raise ValueError("Unabled to get refresh token, delete file '{0}' and rerun authentication".format(pth))
    ...
    def id_token(self): 
        ...
        if self._id_token is not None and self._id_token_expire > datetime.datetime.utcnow() + datetime.timedelta(seconds=10):
        ...
        try:
            ...
            self._id_token_expire = datetime.datetime.utcnow() + datetime.timedelta(seconds=res['expires_in'])
    ...
    def _display_auth_instructions_with_print(self, auth_url):
        ...
        print('To authorize access needed by Geodesic, open the following '
