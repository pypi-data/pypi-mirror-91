...
def sheet(
    ...
    if analysis_name is not None and read_and_upgrade_analysis(analysis_name) is None:
        log(
            'mitosheet_sheet_call_failed', 
            {'error': f'There is no saved analysis with the name {analysis_name}.'}
        )
        raise ValueError(f'There is no saved analysis with the name {analysis_name}.')
    ...
    log(
        ...
        dict(
            **{
                ...
                'param_analysis_name': analysis_name
            },
            **{
