...
def convert_string_to_number(s, on_uncastable_arg_element: Union[Literal['error'], Tuple[Literal['default'], any]]):
    """
...
def to_number_series_from_string_series(string_series: pd.Series, on_uncastable_arg_element: Union[Literal['error'], Tuple[Literal['default'], any]]):
    """
...
def to_number_series(
        unknown_object,
        on_uncastable_arg_element:Union[Literal['error'], Tuple[Literal['default'], any]]='error'
    ):
