...
from transformers import  BertModel, BertTokenizer, AlbertTokenizer, BertTokenizerFast
import json
...
class BERT(nn.Module):
    ...
    def __init__(self, model_name_or_path: str, max_seq_length: int = 128, do_lower_case: bool = True):
        ...
        try:
            self.tokenizer = BertTokenizerFast.from_pretrained(model_name_or_path, do_lower_case=do_lower_case)
        except:
