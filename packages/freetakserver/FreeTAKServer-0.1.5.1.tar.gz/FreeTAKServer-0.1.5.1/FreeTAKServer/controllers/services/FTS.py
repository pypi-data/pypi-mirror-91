...
class FTS:
    ...
    def startup(self, CoTPort, CoTIP, DataPackagePort, DataPackageIP, SSLDataPackagePort, SSLDataPackageIP, RestAPIPort, RestAPIIP, SSLCoTPort, SSLCoTIP, AutoStart, firstStart = False):
        try:
            ...
            if AutoStart == 'False':
                ...
                StartupObject.FederationServerService.FederationServerServiceStatus = 'start'
...
if __name__ == "__main__":
    try:
        ...
        FTS().startup(args.CoTPort, args.CoTIP, args.DataPackagePort, args.DataPackageIP, args.SSLDataPackagePort, args.SSLDataPackageIP, args.RestAPIPort, args.RestAPIIP, args.SSLCoTPort, args.SSLCoTIP, args.AutoStart, True)
    except Exception as e:
        print(e)