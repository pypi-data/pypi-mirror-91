...
class MainConfig:
    ...
    version = 'FreeTAKServer-1.5 RC 1'

    MainPath = str(Path(fr'C:/Users/natha/PycharmProjects/InDev/FreeTAKServerParent/FreeTAKServer'))
    ...
    federationKeyPassword = str('your pass')
