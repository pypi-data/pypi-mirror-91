...
class CategoryMetadata():
    ...
    def print_models(self):
        ...
        for model_metadata in self.models:
            print(row_format.format(*[index, self.models[model_metadata].name, self.models[model_metadata].category, self.models[model_metadata].last_modified]))
            index += 1
    ...
    def print_datasets(self):
        ...
        for dataset_metadata in self.datasets:
            print(row_format.format(*[index, self.datasets[dataset_metadata].name, self.datasets[dataset_metadata].category, self.datasets[dataset_metadata].last_modified]))
            index += 1
