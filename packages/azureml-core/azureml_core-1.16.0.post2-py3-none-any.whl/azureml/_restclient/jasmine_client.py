...
class JasmineClient(ExperimentClient):
    ...
    def get_next_task_batch(self, parent_run_id, max_batch_size, local_run_get_next_task_batch_input):
        """
        ...
        dto = self._execute_with_experiment_arguments(
            self._client.jasmine.local_run_get_next_task_batch, parent_run_id,
