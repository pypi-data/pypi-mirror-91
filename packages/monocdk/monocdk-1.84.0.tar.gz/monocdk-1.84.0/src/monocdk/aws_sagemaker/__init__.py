...
class CfnDevice(
    ...
    def __init__(
        ...
        *,
        ...
        """
        props = CfnDeviceProps(device=device, tags=tags)
    ...
    @builtins.property # type: ignore
    @jsii.member(jsii_name="attrDeviceFleetName")
    def attr_device_fleet_name(self) -> builtins.str:
        """
        :cloudformationAttribute: DeviceFleetName
        """
        return jsii.get(self, "attrDeviceFleetName")
...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={"device": "device", "tags": "tags"},
)
