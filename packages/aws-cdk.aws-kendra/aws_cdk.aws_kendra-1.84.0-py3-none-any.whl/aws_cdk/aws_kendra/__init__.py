...
class CfnIndex(
    ...
    def __init__(
        ...
        *,
        ...
        user_token_configurations: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnIndex.UserTokenConfigurationListProperty"]] = None,
    ) -> None:
    ...
    def user_token_configurations(
        self,
    ) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnIndex.UserTokenConfigurationListProperty"]]:
    ...
    def user_token_configurations(
        self,
        value: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnIndex.UserTokenConfigurationListProperty"]],
    ) -> None:
    ...
    @jsii.data_type(
        jsii_type="@aws-cdk/aws-kendra.CfnIndex.UserTokenConfigurationListProperty",
        jsii_struct_bases=[],
        name_mapping={"user_token_configuration_list": "userTokenConfigurationList"},
    )
    class UserTokenConfigurationListProperty:
        def __init__(
            self,
            *,
            user_token_configuration_list: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnIndex.UserTokenConfigurationProperty"]]]] = None,
        ) -> None:
            """
            :param user_token_configuration_list: ``CfnIndex.UserTokenConfigurationListProperty.UserTokenConfigurationList``.
            ...
            if user_token_configuration_list is not None:
                self._values["user_token_configuration_list"] = user_token_configuration_list

        @builtins.property
        def user_token_configuration_list(
            self,
            ...
            """``CfnIndex.UserTokenConfigurationListProperty.UserTokenConfigurationList``.
            ...
            """
            result = self._values.get("user_token_configuration_list")
            return result
        ...
        def __repr__(self) -> str:
            return "UserTokenConfigurationListProperty(%s)" % ", ".join(
                k + "=" + repr(v) for k, v in self._values.items()
            )
