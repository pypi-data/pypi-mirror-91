...
class getDiffResultsHash_args(object):
    ...
    def write(self, oprot):
        ...
        if self.reportHashes is not None:
            ...
            for iter248 in self.reportHashes:
        ...
        if self.skipDetectionStatuses is not None:
            ...
            for iter249 in self.skipDetectionStatuses:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter327, viter328 in self.success.items():
                ...
                oprot.writeListBegin(TType.STRUCT, len(viter328))
...
class getLinesInSourceFileContents_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i334 in range(_size330):
                        _elem335 = LinesInFilesRequested()
                        _elem335.read(iprot)
                        self.linesInFilesRequested.append(_elem335)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.linesInFilesRequested is not None:
            ...
            for iter336 in self.linesInFilesRequested:
                iter336.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.encoding is not None:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter351, viter352 in self.success.items():
                ...
                oprot.writeMapBegin(TType.I64, TType.STRING, len(viter352))
...
class getCheckerMsgCounts_result(object):
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i403 in range(_size399):
                        _key404 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        _val405 = iprot.readI64()
                        self.success[_key404] = _val405
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter406, viter407 in self.success.items():
...
class getSourceComponents_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i504 in range(_size500):
                        ...
                        self.sourceComponentFilter.append(_elem505)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.sourceComponentFilter is not None:
            ...
            for iter506 in self.sourceComponentFilter:
...
class getMissingContentHashes_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i518 in range(_size514):
                        ...
                        self.fileHashes.append(_elem519)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.fileHashes is not None:
            ...
            for iter520 in self.fileHashes:
...
class massStoreRun_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i532 in range(_size528):
                        ...
                        self.trimPathPrefixes.append(_elem533)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
    ...
    def write(self, oprot):
        ...
        if self.trimPathPrefixes is not None:
            ...
            for iter534 in self.trimPathPrefixes:
