...
def ensure_tap_kwargs_refs(init_kwargs: Dict[str, Any], tap_widget: Any):
...
def register_package_images(*skip_modules: str):              # pragma: no cover
...
def register_package_sounds(*skip_modules: str):              # pragma: no cover
...
def update_tap_kwargs(widget: Any, popup_kwargs: Optional[Dict[str, Any]] = None, **tap_kwargs) -> Dict[str, Any]:
...
register_package_images('ae.inspector')   # register base image files of this portion
register_package_sounds('ae.inspector')   # register base sound files of this portion
