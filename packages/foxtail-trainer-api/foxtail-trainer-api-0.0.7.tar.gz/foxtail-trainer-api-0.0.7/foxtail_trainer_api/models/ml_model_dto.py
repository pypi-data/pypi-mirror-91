...
class MLModelDto(object):
    ...
    attribute_map = {
        ...
        'training_resoult_id': 'trainingResoultId'
    }

    def __init__(self, id=None, name=None, model_type=None, data_set_url=None, status=None, download_url=None, custom_model_hyperparameters=None, training_resoult_id=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._training_resoult_id = None
        ...
        if training_resoult_id is not None:
            self.training_resoult_id = training_resoult_id
    ...
    @property
    def training_resoult_id(self):
        """Gets the training_resoult_id of this MLModelDto.  # noqa: E501


        :return: The training_resoult_id of this MLModelDto.  # noqa: E501
        :rtype: str
        """
        return self._training_resoult_id

    @training_resoult_id.setter
    def training_resoult_id(self, training_resoult_id):
        """Sets the training_resoult_id of this MLModelDto.


        :param training_resoult_id: The training_resoult_id of this MLModelDto.  # noqa: E501
        :type: str
        """

        self._training_resoult_id = training_resoult_id
