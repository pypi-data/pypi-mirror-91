...
def shape_decode(shape: Any) -> str:
    """
...
def library_has_shape(filepath: str, module: str, function: str, classname="") -> bool:
    """
    Check if a library has a certain shape referring to specific code.
    :param filepath: The full path of the library.
...
def get_docstring_from_code(module: str, function: str, filepath: str, classname="") -> str:
    """
