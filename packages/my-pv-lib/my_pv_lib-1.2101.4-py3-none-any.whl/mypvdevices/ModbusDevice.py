...
class ModbusDevice:
    ...
    def addconnection(self, connection):
        # if not isinstance(connection, DcsConnection):
        #     msg="connection has to be a DcsConnection"
        #     raise TypeError(msg)
    ...
    def getregistervalue(self, registerId):
        with self.__lock__:
            try:
                ...
                logging.warning("[Device] ID " + str(self.__serial__) + " register not found. Regiser Id: " + str(registerId))
                value = None
        return value
