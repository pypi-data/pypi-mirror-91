...
if __name__ == "__main__":
    ...
    cryptoKey = "ABABABABABABABABABABABABABABABAB"
    server = "my-pv.live"
    ...
    if( avgVal1 != None and avgVal2 != None and avgVal3 != None and avgVal4 != None and avgVal4 == avgVal1 and sumVal4 > sumVal2):
    ...
    device = ModbusRtuDevice(serial, 1)
    device.writeregister(123,22)    #Todo
