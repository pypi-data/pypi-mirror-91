...
def _process(prefix, file_path):
    ...
    with open("%s%s" % (prefix, file_path.name), "w", encoding="utf-8") as f:
...
def process(overwrite, file_paths):
    """
