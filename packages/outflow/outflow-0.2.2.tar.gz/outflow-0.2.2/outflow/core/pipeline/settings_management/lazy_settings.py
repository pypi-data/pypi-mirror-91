...
class LazySettings(LazyObject):
    """
    A lazy proxy for either global Outflow settings or a custom settings object.
    The user can manually configure settings prior to using them. Otherwise,
    Outflow uses the settings module pointed to by OUTFLOW_SETTINGS_MODULE.
    """
    ...
    def configure(self, initial_settings=None, **options):
        """
        ...
        holder = UserSettingsHolder(initial_settings)
