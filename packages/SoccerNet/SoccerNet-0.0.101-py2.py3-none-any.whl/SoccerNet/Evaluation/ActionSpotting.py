...
def evaluate(SoccerNet_path, Predictions_path, split="test", framerate=2):
...
def label2vector(folder_path, num_classes=17, framerate=2):
    ...
    label_path = os.path.join(folder_path, "Labels-v2.json")
...
def predictions2json(predictions_half_1, predictions_half_2, output_path, game_info, framerate=2):
    ...
    output_file_path = os.path.join(output_path, game_info, "results_spotting.json")
...
def predictions2vector(folder_path, predictions_path, num_classes=17, framerate=2):
    ...
    predictions_path = os.path.join(predictions_path, "results_spotting.json")
