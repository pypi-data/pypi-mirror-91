...
install_purelib = '/'
install_platlib = '/LinkChecker-10.0.0.data/platlib'
install_lib = '/'
install_headers = '/LinkChecker-10.0.0.data/headers'
install_scripts = '/LinkChecker-10.0.0.data/scripts'
config_dir = '/LinkChecker-10.0.0.data/data/share/linkchecker'
install_data = '/LinkChecker-10.0.0.data/data'
name = 'LinkChecker'
version = '10.0.0'
...
platforms = ['UNKNOWN']
fullname = 'LinkChecker-10.0.0'
contact = 'LinkChecker Authors'
contact_email = 'UNKNOWN'
release_date = "15.1.2021"
portable = 0
