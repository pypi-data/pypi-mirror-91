...
def original_and_makeup_slices(filename,faceCropper,nb_tiles,makeup_type, makeup_color):
    ...
    if makeup_type == 0:
        mouth_original, m_o_shape, origine = fc.isolate_mouth("", preImg=pp[0],crop_lips=True)#.convert("RGB")
        mouth_target, m_t_shape,origine2 = fc.isolate_mouth("", preImg=pp[1],pre_shape=m_o_shape,crop_lips=True)
