...
class AgrupamentoCategorico(BaseEstimator, TransformerMixin):
    """
    Classe responsável por propor um agrupamento categórico em variáveis de muitas entradas
    O método fit_transform() é herdado dos objetos BaseEstimator e TransformerMixin
    ...
    Aplicação
    ---------
    cat_agrup = AgrupamentoCategorico(features=lista, n_cat=3)
