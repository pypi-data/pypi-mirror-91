...
self.assertEqual(unsplit("square-\nshouldered"), "square-shouldered\n")
    ...
    def test_unsplit_contains_uppercase(self):
        self.assertEqual(unsplit("He falls ilL.").fix(), "He falls ill.")
   ...
   def test_doesnt_collapse_hyphenated_numbers(self):
