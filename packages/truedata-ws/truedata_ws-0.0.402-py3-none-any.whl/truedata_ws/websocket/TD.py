...
class TD:
    ...
    def disconnect(self):
        if self.connect_live:
            ...
            print(f"{Fore.GREEN}Disconnected LIVE WebSocket Connection !{Style.RESET_ALL}")
        if self.connect_historical:
            ...
            print(f"{Fore.GREEN}Disconnected HISTORICAL WebSocket Connection !{Style.RESET_ALL}")
