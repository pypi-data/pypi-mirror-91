...
class StopInstance(Command):
    ...
    def take_action(self, parsed_args):
        uri = '/instances/%s/state-transitions' % parsed_args.instance
        self.app.session.post(uri, payload=dict(new_state="STOPPED"))
...
class SuspendInstance(Command):
    ...
    def take_action(self, parsed_args):
        uri = '/instances/%s/state-transitions' % parsed_args.instance
        self.app.session.post(uri, payload=dict(new_state="SUSPEND"))
...
class AttachInstanceVolume(Command):
...
class UpdateInstance(ShowOne):
    ...
    def take_action(self, parsed_args):
        ...
        data = self.app.session.put(uri, payload)
