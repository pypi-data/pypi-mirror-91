...
def readInternal(caseDir, m2mm=1):
...
def plotMeshTopology(ax,caseDir,ind_cell=None,index_intFace=None,**kwargs):
    caseDir=os.path.abspath(caseDir)
    # get mesh data
    x, y, z, cells_rect=readInternal(caseDir)
    ...
    for i in range(0,len(index_internalFaces)):
        ...
        ax.plot(x_tmp,y_tmp,'orange',label=label,**kwargs)
    ...
    for face in faces_own_to_cell:
        ...
        lf,=ax.plot(x_face,y_face, color='r',**kwargs)
