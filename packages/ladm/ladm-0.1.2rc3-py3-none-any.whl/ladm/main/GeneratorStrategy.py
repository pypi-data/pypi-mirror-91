...
from ladm.main.util.types import DependenciesOutput, DependenciesInput, SystemDependenciesOutput, \
    LanguageDependenciesOutput, ModelsDependenciesOutput, SystemDependenciesInput, LanguageDependenciesInput, \
    ModelsDependenciesInput
...
class ModelGeneratorStrategy(GeneratorStrategy):
    def generate(self, dependencies: ModelsDependenciesInput) -> ModelsDependenciesOutput:
        """
