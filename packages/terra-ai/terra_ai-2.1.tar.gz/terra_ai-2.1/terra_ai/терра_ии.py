...
from . import датасет, модель, сегментация, traide, ряды, генетика, прачечная, повышение_размерности, обнаружение, обработка_текста, сегментация_договоров, квартиры, home
...
def рассчитать_план_на_день(общее_число_ботов, количество_выживших, количество_эпох, коэфициент_мутаций):
  прачечная.рассчитать_план_на_день(общее_число_ботов, количество_выживших, количество_эпох, коэфициент_мутаций)
def план_на_день():
  прачечная.план_на_день()
def информация_о_мешке():
  прачечная.информация_о_мешке()
