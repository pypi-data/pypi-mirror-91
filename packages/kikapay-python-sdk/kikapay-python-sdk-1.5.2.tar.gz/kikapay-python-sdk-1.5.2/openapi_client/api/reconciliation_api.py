    ...
    def __init__(self, api_client=None):
        ...
        def __reconciliation_multi_use_link_payments(
            ...
            **kwargs
            ...
            >>> thread = api.reconciliation_multi_use_link_payments(async_req=True)
            >>> result = thread.get()
        ...
        def __reconciliation_payments(
            ...
            **kwargs
            ...
            >>> thread = api.reconciliation_payments(async_req=True)
            >>> result = thread.get()
        ...
        self.reconciliation_payments = Endpoint(
            settings={
                ...
                'operation_id': 'reconciliation_payments',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__reconciliation_payments
        )

        def __reconciliation_recurring_payment(
            self,
            ...
            **kwargs
            ...
            >>> thread = api.reconciliation_recurring_payment(reconciliation_payments, async_req=True)
            >>> result = thread.get()
        ...
        self.reconciliation_recurring_payment = Endpoint(
            settings={
                ...
                'operation_id': 'reconciliation_recurring_payment',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__reconciliation_recurring_payment
        )

        def __reconciliation_single_payment(
            self,
            ...
            **kwargs
            ...
            >>> thread = api.reconciliation_single_payment(reconciliation_single_payments, async_req=True)
            >>> result = thread.get()
        ...
        self.reconciliation_single_payment = Endpoint(
            settings={
                'response_type': (ReconciliationPayments200Response,),
                'auth': [
                    'bearerAuth'
                ...
                'operation_id': 'reconciliation_single_payment',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__reconciliation_single_payment
        )
