...
class Contract(KplerClient):

    """
    The ``Contract`` endpoint allows you to extract a list of SPAs, TUAs, LTAs, and Tenders for all LNG players, installations and zones.
    """
    ...
    def get_columns(self) -> DataFrame:
        ...
        Examples:
           >>>
            from kpler.sdk.resources.contract import Contract
            contract_client = Contract(config)
            contract_client.get_columns()

            .. csv-table::
                :header: "id","name","description","deprecated","type"

                "type","Type","Type of contract (SPA, LTA, TUA, Tender)","False","string"
    ...
    def get(
        ...
        Args:
            ...
            players: Optional[str] Represents the buyers/sellers on the contract
            types: Optional[List[Enum]] ``ContractTypes``
        ...
        Examples:
            ...
            from datetime import date
            from kpler.sdk.resources.contract import Contract
            from kpler.sdk import ContractTypes
            contract_client = Contract(config)
            contract_client.get(
                size=10,
