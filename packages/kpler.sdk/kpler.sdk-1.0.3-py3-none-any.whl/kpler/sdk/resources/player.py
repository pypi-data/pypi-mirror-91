...
class Player(KplerClient):
    """
    The ``Player`` endpoint allows to perform full-text search on players, in order to find names used in Kpler referential.
    """
    ...
    def search(self, q: str) -> DataFrame:
        ...
        Examples:
            >>>
            from kpler.sdk.resources.player import Player
            player_client=Player(config)
            player_client.search("somo")
