...
class FreightMetricSeries(KplerClient):

    """
    Get demand metrics like tonmiles & tondays as well as other metrics like average speed for laden fleet and average distance under this metric
    """
    ...
    def get(
        ...
        Args:
            ...
            metric: Optional[Enum] ``FreightMetricSeriesMetric``
            ...
            period: Optional[Enum] ``FreightMetricSeriesPeriod``
            split: Optional[Enum] ``FreightMetricSeriesSplit``
            unit: Optional[Enum] ``FreightMetricSeriesUnit``
        ...
        Examples:
            ...
            >>>
            from datetime import date
            from kpler.sdk.resources.freight_metric_series import FreightMetricSeries
            from kpler.sdk import FreightMetricSeriesMetric, FreightMetricSeriesSplit, FreightMetricSeriesUnit, FreightMetricSeriesPeriod
            freight_metric_series_client = FreightMetricSeries(config)
            freight_metric_series_client.get(
                metric=FreightMetricSeriesMetric.TonMiles,
                split=FreightMetricSeriesSplit.VesselTypeCpp,
                products=["gasoline", "DPP"],
                unit=FreightMetricSeriesUnit.KTNMI,
                period=FreightMetricSeriesPeriod.Monthly,
