...
class PortCall(KplerClient):
    """
    The ``PortCall`` query returns the cargo-by-cargo details for loadings/discharges taking place in a point of
    ...
    def get_columns(self) -> DataFrame:
        ...
        Examples:
            >>>
            from kpler.sdk.resources.port_call import PortCall
            port_calls_client = PortCall(config)
