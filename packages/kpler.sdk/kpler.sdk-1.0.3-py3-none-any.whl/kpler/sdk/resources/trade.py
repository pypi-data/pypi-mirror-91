...
class Trade(KplerClient):
    """
    The ``Trade`` query returns the volumes from one point of interest to another (installation/zone) on a cargo-by-cargo basis.
    """
    ...
    def get(
        ...
        Args:
            ...
            trade_status: Optional[List[Enum]] ``TradeStatus`` Return only trades of a particular status. By default value is scheduled.
