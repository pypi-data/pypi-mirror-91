...
class ShipToShip(KplerClient):
    """
    The ``ship-to-ship`` endpoint returns the ship-to-ship loadings/discharges in a given zone,with details on the
    ...
    def get_columns(self) -> DataFrame:
        ...
        Examples:
            >>>
            from kpler.sdk.resources.ship_to_ship import ShipToShip
            ship_to_ships_client = ShipToShip(config)
