...
class SlotTestCollection:
    ...
    def test_do_not_reset_values(self):
        step_slot = self.create_slot()
        total_errs_slot = self.create_slot()
        step_slot.name = 'steps'
        total_errs_slot.name = 'total_errors'
        step_slot.value = 3
        total_errs_slot.value = 3
        step_slot.reset()
        total_errs_slot.reset()
        assert step_slot.value == 3
        assert total_errs_slot.value == 3
