...
export RADICAL_BASE="<Mock id='139654623344336'>"
export RP_SESSION_ID="sid0"
export RP_PILOT_ID="pid0"
export RP_AGENT_ID="aid0"
export RP_SPAWNER_ID="<Mock id='139654623344192'>"
export RP_UNIT_ID="unit.000000"
export RP_UNIT_NAME="cu.0000"
export RP_GTOD="<Mock id='139654623344240'>"
export RP_TMP="<Mock id='139654623344576'>"
export RP_PILOT_SANDBOX="<Mock id='139654623344336'>"
export RP_PILOT_STAGING="<Mock id='139654623344336'>"
