                    ...
                    <div class="row">
                        <div class="col-sm-6 b-r" style="height:350px">
                            <form class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label text-danger">用例报错:</label>
                                    <div class="col-sm-5">
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <div class="input-group panel-heading"
                        ...
                        <select class="chosen-select form-control" data-placeholder="----------" style="width: 400px;"
                                name="filterModule" id="filterModule">
                            <option value="">----------</option>
                        </select>
                        <label style="color: snow;width: 20px"></label>
                        <label style="color: snow">测试类：</label>
                        <select class="chosen-select form-control" data-placeholder="----------" style="width: 200px;"
                        ...
                        <div style="width: 460px; float: right">
                            <label class="form-control">
                                ...
                                <span class="text-danger">报错: </span><span class="text-danger"
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $.each(resultData["testResult"], function (i, n) {
            if (moduleNames.indexOf(n["moduleName"]) == -1) {
                moduleNames.push(n["moduleName"]);
            }
        ...
        $.each(moduleNames, function (i, n) {
            $("#filterModule").append("<option value='" + n + "' hassubinfo='true'>" + n + "</option>");
        });
        ...
        function generateResult(moduleName, className, caseResult) {
            ...
            $.each(resultData["testResult"], function (i, n) {
                if ((moduleName === "" || n["moduleName"] === moduleName) && (className === "" || n["className"] === className) && (caseResult === "" || n["status"] === caseResult)) {
                    filterAll += 1;
                    var status = "";
                    if (n["status"] === '成功') {
                        filterOk += 1;
                        ...
                        filterError += 1;
                        status = "<td><span class='text-danger'>报错</span></td>";
        ...
        $("#error_case").hide();
        if (error_case_flag) {
            var moduleName = $("#filterModule").val();
            var className = $("#filterClass").val();
            var caseResult = "报错";
            $("#error_case").show();
            generateResult(moduleName, className, caseResult);
        }
                ...
                series: [
                    {
                        ...
                        data: [
                            ...
                            {value: resultData["testError"], name: '报错'},
