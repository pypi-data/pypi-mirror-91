...
def initWithSpecificIndividual(initial_individual, n):
    return [creator.Individual(initial_individual) for i in range(0, n)]
...
def setup_toolbox(aa_seq,
    ...
    toolbox.register("initial_population", initWithSpecificIndividual, initial_individual)
    return toolbox
