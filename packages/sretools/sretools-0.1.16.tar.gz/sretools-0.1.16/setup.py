...
setup(
    ...
    install_requires=["pexpect","texttable","wcwidth","pyyaml","jaydebeapi"],
    keywords=['sretool','sre','ssh','yssh','pssh','ltexpect','expect','incident','postmortem','json2html','json','html','yaml','jdbc'],
    entry_points={
        "console_scripts": [
