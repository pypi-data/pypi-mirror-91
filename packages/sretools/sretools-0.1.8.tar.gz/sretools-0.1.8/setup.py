...
setup(
    name="sretools",
    version="0.1.8",
    description="SRE toolbox for *nix",
    ...
    install_requires=["pexpect","texttable","wcwidth","pyyaml"],
    keywords=['sretool','sre','ssh','yssh','pssh','ltexpect','expect','incident','postmortem','json2html','json','html','yaml'],
    entry_points={
        "console_scripts": [
