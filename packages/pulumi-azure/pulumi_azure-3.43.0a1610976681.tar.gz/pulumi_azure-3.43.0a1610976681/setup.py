...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.43.0-alpha.1610976681+c8165bf3'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.43.0-alpha.1610976681+c8165bf3`
                """)
            else:
                raise
