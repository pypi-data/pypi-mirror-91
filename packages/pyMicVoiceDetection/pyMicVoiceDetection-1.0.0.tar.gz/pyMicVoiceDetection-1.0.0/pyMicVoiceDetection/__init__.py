...
def Record(filename,buf=None,dur=3):
    '''
...
def recordAsyn(filename,dur=25,TH=0.01,Samples=None):
    '''
...
def recordAsynSerial(dur=25,TH=0.01,label="",Samples=None):
    '''
    =================================
...
def recordAsynSerialAndPlot(dur=25,TH=0.01,label="",Samples=None,endPoints=None):
    '''
    =================================
