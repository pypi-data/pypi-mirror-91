...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gitlab', '3.5.0-alpha.1610498602+79fc63a5'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gitlab 3.5.0-alpha.1610498602+79fc63a5`
                """)
            else:
                raise
