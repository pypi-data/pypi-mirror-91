...
def main(dialog, *args):
    ...
    print "Setting renderer to Arnold..."
    rt.renderers.current = next(cls for cls in rt.RendererClass.classes if str(cls)=="Arnold")()
    ...
    # Annoyingly, settiung rendPickupFrames above is not enough. We have to
