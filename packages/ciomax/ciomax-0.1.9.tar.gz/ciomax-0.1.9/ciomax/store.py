...
DEFAULT_TASK_TEMPLATE = u'kick -nostdin -i  "<posix project>/ass/<timestamp>/<scenenamex>.<pad start 4>.ass" -dw -dp -v 5 -ds 4 -ss 4 -as 6 -of exr -o "<posix project>/renderoutput/<timestamp>/<scenenamex>.<pad start 4>.exr'

DEFAULT_TITLE = u"3dsmax ass export <upper scenenamex>"

DEFAULT_SCRIPT_COMMAND = u'"<conductor>/ciomax/scripts/export_ass.py" "<project>/ass/<timestamp>/<scenenamex>."'
...
class ConductorStore(object):
    ...
    def reset(self):
        ...
        self.set_assets()
        self.set_host_version(u"maya-io 2020.SP3")
        self.set_renderer_version(u"arnold 4.1.1.1")
