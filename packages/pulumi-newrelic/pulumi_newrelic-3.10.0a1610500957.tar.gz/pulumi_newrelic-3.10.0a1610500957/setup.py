...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'newrelic', '3.10.0-alpha.1610500957+0c70c8c9'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource newrelic 3.10.0-alpha.1610500957+0c70c8c9`
                """)
            else:
                raise
