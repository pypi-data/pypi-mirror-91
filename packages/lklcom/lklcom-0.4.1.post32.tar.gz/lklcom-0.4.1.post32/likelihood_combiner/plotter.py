...
def plot_thermal_relic(ax=None, **kwargs):
    ...
    ax.set_yscale('log')
    x.set_ylabel(r'$\langle\sigma v\rangle \, [cm^{3}/s]$')
    ...
    ax.plot(thermal_relic_mass,thermal_relic_sigmav,label=r'Thermal relic $\langle\sigma v\rangle$')
...
def plot_sigmavUL_from_hdf5(file, ax=None, **kwargs):
    """
