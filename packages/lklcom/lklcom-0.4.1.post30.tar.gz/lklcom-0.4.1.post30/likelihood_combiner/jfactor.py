...
class GeringerSameth(JFactor):
    ...
    def __init__(self,
        ...
        print(get_version())
        print(get_version_pypi())
        print(os.path.dirname(__file__))
        
        #if resource is None:
        #    print("likelihood-combiner.{}".format(get_version_pypi()))
        #    resource = pkgutil.get_data("likelihood-combiner.{}".format(get_version_pypi()), "resources/GeringerSameth/intJ_cf.txt")
        print(resource)
        resource= DATA_PATH + "GeringerSameth/intJ_cf.txt"
