...
class BenfordsLaw:
    ...
    def apply_chi_sq_test(self,
        ...
        :param alpha: Optional. Specifies the required value bssed on which the null hypothesis is
        rejected or not rejected. Default = 0.05
    ...
    def apply_benfords_law(self):
        """
        Apply all tests to passed dataset
