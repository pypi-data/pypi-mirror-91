...
from ._util._utils import _get_short_path_name, _is_prod_workspace, _can_visualize, trans_to_valid_file_name
...
class Pipeline(Component, Visible, WorkspaceTelemetryMixin):
    ...
    def _convert_component_kwargs(self, _index, _kwargs):
        ...
        matched_dict_list = self._definition._components_args_matched_dict_list
        updated_kwargs = {}
