...
class PipelineEndpointsOperations(object):
    ...
    def get_pipeline_endpoint_graph(
            self, subscription_id, resource_group_name, workspace_name, pipeline_endpoint_id, use_cache=False, include_run_setting_params=True, has_namespace_concept=True, custom_headers=None, raw=False, **operation_config):
        """
