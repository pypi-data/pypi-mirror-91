...
class PipelineDraftsOperations(object):
    ...
    def get_pipeline_draft(
            self, subscription_id, resource_group_name, workspace_name, draft_id, get_status=True, include_run_setting_params=True, has_namespace_concept=True, custom_headers=None, raw=False, **operation_config):
        """
