...
class ComputeRunSettingParameter(Model):
    ...
    def __init__(self, *, section_name: str=None, section_description: str=None, section_argument_name: str=None, name: str=None, label: str=None, parameter_type=None, is_optional: bool=None, default_value: str=None, lower_bound: str=None, upper_bound: str=None, description: str=None, run_setting_ui_hint=None, argument_name: str=None, **kwargs) -> None:
