...
class Input(TelemetryMixin):
    ...
    def _build_dataset(cls, dset: AbstractDataset, mode='mount'):
        ...
        name = _sanitize_python_variable_name(dset.name)
        if mode == 'mount':
...
class Output(TelemetryMixin):
    ...
    def configure(self, datastore=None, output_mode='mount', path_on_compute=None):
        """
        ...
        :type output_mode: str
        :param path_on_compute: Specify the local path of the output when using component/pipeline.run.
