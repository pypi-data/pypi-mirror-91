...
class Run(Visible, WorkspaceTelemetryMixin):
    ...
    def _get_yamlModuleDefinition(self):
        ...
        yaml_str = designerServiceCaller.get_module_yaml_by_id(module_id=self._properties['azureml.moduleid'])
    ...
    def _create_outputs(self):
        ...
        if output_ports:
            ...
            for port in output_ports:
                self._run_outputs.append(_Output(name=port['name'], _type=port['type'], run=self))
