...
class ExperimentPreparationPhase:
    ...
    def run(
    ...
    ) -> Tuple[Optional[OnnxConverter], Optional[FeatureSweepedStateContainer]]:
        """Run the setup phase."""
        onnx_cvt = ExperimentPreparationPhase._build_and_initialize_onnx_converter(
        ...
        return onnx_cvt, feature_sweeped_state_container
