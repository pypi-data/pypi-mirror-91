...
class _AdbAutomlExperiment:
    ...
    def setup_iteration(self, verifier, current_run, run_id):
        logger.info('Beginning setup iteration: {}.'.format(run_id))
        data_dict = featurization_entrypoint_util.get_input_datamodel_from_dataprep_json(
        ...
        onnx_cvt, feature_sweeped_state_container = ExperimentPreparationPhase.run(
            parent_run_id=self.parent_run_id,
            ...
            fit_iteration_parameters_dict=data_dict,
            remote=False,
        ...
        featurization_entrypoint_util.cache_onnx_init_metadata(cache_store, onnx_cvt, self.parent_run_id)
        ...
        with _AMLLogUploader(current_run, self.worker_id):
            try:
                ...
                if run_id.endswith("setup"):
                    ...
                    self.fit_iteration_core(verifier, current_run, pkg_ver,
                                            pipeline_dto, run_id, onnx_cvt)
