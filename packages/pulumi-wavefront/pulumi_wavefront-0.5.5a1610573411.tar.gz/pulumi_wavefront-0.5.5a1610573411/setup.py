...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'wavefront', '0.5.5-alpha.1610573411+7c57ecfb'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource wavefront 0.5.5-alpha.1610573411+7c57ecfb`
                """)
            else:
                raise
