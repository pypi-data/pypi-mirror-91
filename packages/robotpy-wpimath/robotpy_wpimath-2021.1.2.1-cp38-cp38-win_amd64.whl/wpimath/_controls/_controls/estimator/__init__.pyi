...
class DifferentialDrivePoseEstimator():
    ...
    """
    def __init__(self, gyroAngle: wpimath.geometry._geometry.Rotation2d, initialPose: wpimath.geometry._geometry.Pose2d, stateStdDevs: typing.List[float[5]], localMeasurementStdDevs: typing.List[float[3]], visionMeasurementStdDevs: typing.List[float[3]], nominalDt: seconds = 0.02) -> None: 
        """
    ...
    def resetPosition(self, pose: wpimath.geometry._geometry.Pose2d, gyroAngle: wpimath.geometry._geometry.Rotation2d) -> None: 
        ...
        """
    def setVisionMeasurementStdDevs(self, visionMeasurementStdDevs: typing.List[float[3]]) -> None: 
        """
...
class ExtendedKalmanFilter_1_1_1():
    ...
    def __init__(self, f: typing.Callable[[numpy.ndarray[numpy.float64, _Shape[1, 1]], numpy.ndarray[numpy.float64, _Shape[1, 1]]], numpy.ndarray[numpy.float64, _Shape[1, 1]]], h: typing.Callable[[numpy.ndarray[numpy.float64, _Shape[1, 1]], numpy.ndarray[numpy.float64, _Shape[1, 1]]], numpy.ndarray[numpy.float64, _Shape[1, 1]]], stateStdDevs: typing.List[float[1]], measurementStdDevs: typing.List[float[1]], dt: seconds) -> None: 
        """
...
class ExtendedKalmanFilter_2_1_1():
    ...
    @typing.overload
    def P(self, i: int, j: int) -> float: ...
    def __init__(self, f: typing.Callable[[numpy.ndarray[numpy.float64, _Shape[2, 1]], numpy.ndarray[numpy.float64, _Shape[1, 1]]], numpy.ndarray[numpy.float64, _Shape[2, 1]]], h: typing.Callable[[numpy.ndarray[numpy.float64, _Shape[2, 1]], numpy.ndarray[numpy.float64, _Shape[1, 1]]], numpy.ndarray[numpy.float64, _Shape[1, 1]]], stateStdDevs: typing.List[float[2]], measurementStdDevs: typing.List[float[1]], dt: seconds) -> None: 
        """
        Constructs an Extended Kalman filter.
...
class ExtendedKalmanFilter_2_2_2():
    ...
    @typing.overload
    def P(self, i: int, j: int) -> float: ...
    def __init__(self, f: typing.Callable[[numpy.ndarray[numpy.float64, _Shape[2, 1]], numpy.ndarray[numpy.float64, _Shape[2, 1]]], numpy.ndarray[numpy.float64, _Shape[2, 1]]], h: typing.Callable[[numpy.ndarray[numpy.float64, _Shape[2, 1]], numpy.ndarray[numpy.float64, _Shape[2, 1]]], numpy.ndarray[numpy.float64, _Shape[2, 1]]], stateStdDevs: typing.List[float[2]], measurementStdDevs: typing.List[float[2]], dt: seconds) -> None: 
        """
        Constructs an Extended Kalman filter.
...
class KalmanFilter_1_1_1():
    def __init__(self, plant: wpimath._controls._controls.system.LinearSystem_1_1_1, stateStdDevs: typing.List[float[1]], measurementStdDevs: typing.List[float[1]], dt: seconds) -> None: 
        """
...
class KalmanFilter_2_1_1():
    def __init__(self, plant: wpimath._controls._controls.system.LinearSystem_2_1_1, stateStdDevs: typing.List[float[2]], measurementStdDevs: typing.List[float[1]], dt: seconds) -> None: 
        """
        Constructs a state-space observer with the given plant.
...
class KalmanFilter_2_2_2():
    def __init__(self, plant: wpimath._controls._controls.system.LinearSystem_2_2_2, stateStdDevs: typing.List[float[2]], measurementStdDevs: typing.List[float[2]], dt: seconds) -> None: 
        """
        Constructs a state-space observer with the given plant.
...
class SwerveDrive3PoseEstimator():
    ...
    """
    def __init__(self, gyroAngle: wpimath.geometry._geometry.Rotation2d, initialPose: wpimath.geometry._geometry.Pose2d, kinematics: wpimath.kinematics._kinematics.SwerveDrive3Kinematics, stateStdDevs: typing.List[float[3]], localMeasurementStdDevs: typing.List[float[1]], visionMeasurementStdDevs: typing.List[float[3]], nominalDt: seconds = 0.02) -> None: 
        """
...
class SwerveDrive4PoseEstimator():
    ...
    """
    def __init__(self, gyroAngle: wpimath.geometry._geometry.Rotation2d, initialPose: wpimath.geometry._geometry.Pose2d, kinematics: wpimath.kinematics._kinematics.SwerveDrive4Kinematics, stateStdDevs: typing.List[float[3]], localMeasurementStdDevs: typing.List[float[1]], visionMeasurementStdDevs: typing.List[float[3]], nominalDt: seconds = 0.02) -> None: 
        """
        Constructs a SwerveDrivePoseEstimator.
...
class SwerveDrive6PoseEstimator():
    ...
    """
    def __init__(self, gyroAngle: wpimath.geometry._geometry.Rotation2d, initialPose: wpimath.geometry._geometry.Pose2d, kinematics: wpimath.kinematics._kinematics.SwerveDrive6Kinematics, stateStdDevs: typing.List[float[3]], localMeasurementStdDevs: typing.List[float[1]], visionMeasurementStdDevs: typing.List[float[3]], nominalDt: seconds = 0.02) -> None: 
        """
        Constructs a SwerveDrivePoseEstimator.
