...
class SwerveDrive3Kinematics():
    ...
    def toChassisSpeeds(self, moduleStates: typing.List[SwerveModuleState[3]]) -> ChassisSpeeds: 
        ...
        :returns: The resulting chassis speed.
        """
    def toSwerveModuleStates(self, chassisSpeeds: ChassisSpeeds, centerOfRotation: wpimath.geometry._geometry.Translation2d = Translation2d(x=0.000000, y=0.000000)) -> typing.List[SwerveModuleState[3]]: 
        """
...
class SwerveDrive4Kinematics():
    ...
    def toChassisSpeeds(self, moduleStates: typing.List[SwerveModuleState[4]]) -> ChassisSpeeds: 
        ...
        :returns: The resulting chassis speed.
        """
    def toSwerveModuleStates(self, chassisSpeeds: ChassisSpeeds, centerOfRotation: wpimath.geometry._geometry.Translation2d = Translation2d(x=0.000000, y=0.000000)) -> typing.List[SwerveModuleState[4]]: 
        """
        Performs inverse kinematics to return the module states from a desired
        chassis velocity. This method is often used to convert joystick values into
        module speeds and angles.
...
class SwerveDrive6Kinematics():
    ...
    def toChassisSpeeds(self, moduleStates: typing.List[SwerveModuleState[6]]) -> ChassisSpeeds: 
        ...
        :returns: The resulting chassis speed.
        """
    def toSwerveModuleStates(self, chassisSpeeds: ChassisSpeeds, centerOfRotation: wpimath.geometry._geometry.Translation2d = Translation2d(x=0.000000, y=0.000000)) -> typing.List[SwerveModuleState[6]]: 
        """
        Performs inverse kinematics to return the module states from a desired
        chassis velocity. This method is often used to convert joystick values into
        module speeds and angles.
