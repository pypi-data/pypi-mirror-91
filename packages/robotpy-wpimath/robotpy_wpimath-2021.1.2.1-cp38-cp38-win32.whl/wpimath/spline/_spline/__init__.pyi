...
class SplineHelper():
    ...
    def __init__(self) -> None: ...
    @staticmethod
    def cubicControlVectorsFromWaypoints(start: wpimath.geometry._geometry.Pose2d, interiorWaypoints: typing.List[wpimath.geometry._geometry.Translation2d], end: wpimath.geometry._geometry.Pose2d) -> typing.List[Spline3.ControlVector[2]]: 
        """
