...
"</strong> from the gyro.";
  ...
  cls_SwerveDrivePoseEstimator
      .def(py::init<const Rotation2d&, const Pose2d&, SwerveDriveKinematics<NumModules>&, const std::array<double, 3>&, const std::array<double, 1>&, const std::array<double, 3>&, units::second_t>(),
