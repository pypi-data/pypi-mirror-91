...
"https://file.tavsys.net/control/controls-engineering-in-frc.pdf.";
  ...
  cls_LinearQuadraticRegulatorImpl
      .def(py::init<const Eigen::Matrix<double, States, States>&, const Eigen::Matrix<double, States, Inputs>&, const std::array<double, States>&, const std::array<double, Inputs>&, units::second_t>(),
