...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'mongodbatlas', '1.4.0-alpha.1610636007+a18a3c4e'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource mongodbatlas 1.4.0-alpha.1610636007+a18a3c4e`
                """)
            else:
                raise
