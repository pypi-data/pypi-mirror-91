    ...
    def get_specific_dem_text(self):  # if admission_population in args
        ...
        # 1100
            ...
            if self.nation_of_citizenship_desc != "" and self.current_age != "":
                additional_dem_info = [
                    self.create_text(self.first_name,"dynamic", "first_name", "explanation"),
                    self.create_text("\'s nation of citizenship in ", "template", None, "explanation") if self.citizenship_desc[0] in ['a', 'e', 'u', 'i', 'o'] else self.create_text(" is a ", "template", None, "explanation"),
                    self.create_text(self.nation_of_citizenship_desc,"dynamic", "citizenship_desc", "explanation"),
                ...
                additional_dem_info = [
                    self.create_text(self.first_name,"dynamic", "first_name", "explanation"),
                    self.create_text(" is ", "template", None, "explanation") if self.citizenship_desc[0] in ['a', 'e', 'u', 'i', 'o'] else self.create_text(" is a ", "template", None, "explanation"),
                    self.create_text(self.p.number_to_words(self.current_age),"dynamic", "current_age", "explanation"),
                    self.create_text(" years old now. ", "template", None, "explanation"),
                ]
