...
class StudentStory:
    ...
    def get_specific_dem_text(self):  # if admission_population in args
        specific_dem_text = [self.create_text("", "template", None, "explanation")]
        if 'Yes' in [self.choices['Student population'], self.choices['Student population'], self.choices['Admissions population']]:
        ...
        # 0001
        if self.choices['Primary ethnicity'] == 'Yes' and all(item == 'No' for item in list(self.choices.values())[0:3]):
            ...
            # else:
            #     additional_dem_info = [self.create_text("", 'template', None, "explanation")]
        elif self.choices['Current age'] == 'Yes' and self.choices['Primary ethnicity'] == 'No' and all(item == 'No' for item in list(self.choices.values())[0:2]):  # 0010
            if self.current_age != "":
                additional_dem_info = [
            ...
            # else:
            #     additional_dem_info = [self.create_text("", 'template', None, "explanation")]
        elif self.choices['Citizenship type'] == 'No' and self.choices['Nation of citizenship'] == 'Yes' and all(item == 'No' for item in list(self.choices.values())[2:4]):  # 0100
            ...
            #     additional_dem_info = [self.create_text("", 'template', None, "explanation")]
        # 1000
        elif self.choices['Citizenship type'] == 'Yes' and all(item == 'No' for item in list(self.choices.values())[1:4]):
            ...
            # else:
            #     additional_dem_info = [self.create_text("", 'template', None, "explanation")]
        elif self.choices['Citizenship type'] == 'Yes' and self.choices['Primary ethnicity'] == 'Yes' and all(
    ...
    def get_specific_intro_text(self):  # if admission_population in args
        ...
        if self.choices['Primary ethnicity'] == 'Yes' and all(item == 'No' for item in list(self.choices.values())[0:3]):
            ...
            # else:
            #     additional_dem_info = [self.create_text("", 'template', None, "explanation")]
        elif self.choices['Current age'] == 'Yes' and self.choices['Primary ethnicity'] == 'No' and all(
            ...
            # else:
            #     additional_dem_info = [self.create_text("", 'template', None, "explanation")]
        elif self.choices['Citizenship type'] == 'No' and self.choices['Nation of citizenship'] == 'Yes' and all(
