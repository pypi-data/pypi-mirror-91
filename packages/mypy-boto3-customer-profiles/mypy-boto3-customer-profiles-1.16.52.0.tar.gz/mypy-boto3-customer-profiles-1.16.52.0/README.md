...
[boto3.CustomerProfiles 1.16.52](https://boto3.amazonaws.com/v1/documentation/api/1.16.52/reference/services/customer-profiles.html#CustomerProfiles) service
compatible with
