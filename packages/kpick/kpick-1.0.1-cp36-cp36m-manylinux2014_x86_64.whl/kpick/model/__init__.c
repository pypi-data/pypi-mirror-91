...
{
    "distutils": {
        "name": "kpick.model.__init__",
        "sources": [
            "kpick/model/__init__.py"
        ]
    },
    "module_name": "kpick.model.__init__"
}
END: Cython Metadata */
...
#define __PYX_HAVE__kpick__model____init__
#define __PYX_HAVE_API__kpick__model____init__
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from 'kpick.model.__init__' */
#define __Pyx_MODULE_NAME "kpick.model.__init__"
extern int __pyx_module_is_main_kpick__model____init__;
int __pyx_module_is_main_kpick__model____init__ = 0;

/* Implementation of 'kpick.model.__init__' */
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_kpick__model____init__) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  if (!CYTHON_PEP489_MULTI_PHASE_INIT) {
    if (unlikely(__Pyx_SetPackagePathFromImportLib("kpick", __pyx_n_u_model) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "kpick.model")) {
      if (unlikely(PyDict_SetItemString(modules, "kpick.model", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init kpick.model.__init__", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init kpick.model.__init__");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
